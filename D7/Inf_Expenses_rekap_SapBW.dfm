object Inf_Expenses_rekap_SapBWFrm: TInf_Expenses_rekap_SapBWFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Expenses_rekap_SapBWFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1BW_Expensetype: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Expensetype'
            Width = 211
          end
          object cxGrid3DBTableView1BW_Account: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Account'
            Width = 69
          end
          object cxGrid3DBTableView1BW_Branch: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Branch'
            Width = 141
          end
          object cxGrid3DBTableView1BW_Company: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Company'
            Width = 110
          end
          object cxGrid3DBTableView1BW_DocNo: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1BW_NoPolisi: TcxGridDBColumn
            DataBinding.FieldName = 'BW_NoPolisi'
            Width = 67
          end
          object cxGrid3DBTableView1BW_PersonName: TcxGridDBColumn
            DataBinding.FieldName = 'BW_PersonName'
            Width = 203
          end
          object cxGrid3DBTableView1BW_PersonType: TcxGridDBColumn
            DataBinding.FieldName = 'BW_PersonType'
            Width = 86
          end
          object cxGrid3DBTableView1BW_SiteCanvas: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT *  FROM [MARS].[dbo].[VExpenses_SAPBW] a '
    ...
    object Daily_DBBW_Expensetype: TStringField
      FieldName = 'BW_Expensetype'
      Size = 250
    end
    object Daily_DBBW_Account: TStringField
      FieldName = 'BW_Account'
      Size = 250
    end
    object Daily_DBBW_Branch: TStringField
      FieldName = 'BW_Branch'
      Size = 250
    end
    object Daily_DBBW_Company: TStringField
      FieldName = 'BW_Company'
      Size = 250
    end
    object Daily_DBBW_DocNo: TStringField
      FieldName = 'BW_DocNo'
      Size = 250
    end
    ...
    object Daily_DBBW_NoPolisi: TStringField
      FieldName = 'BW_NoPolisi'
      Size = 250
    end
    object Daily_DBBW_PersonName: TStringField
      FieldName = 'BW_PersonName'
      Size = 250
    end
    object Daily_DBBW_PersonType: TStringField
      FieldName = 'BW_PersonType'
      Size = 250
    end
    object Daily_DBBW_SiteCanvas: TStringField
