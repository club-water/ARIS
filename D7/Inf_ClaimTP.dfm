object Inf_ClaimTPFrm: TInf_ClaimTPFrm
  Left = 191
  Top = 74
  Width = 1024
  Height = 608
  Caption = 'Inf_ClaimTPFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          Styles.ContentEven = _DataModule.cxStyle3
          ...
          object cxGrid3DBTableView1REF_TMP: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1NOMINAL_KLAIM: TcxGridDBColumn
            DataBinding.FieldName = 'NOMINAL_KLAIM'
            Width = 114
          end
          object cxGrid3DBTableView1VALIDASI_TMP: TcxGridDBColumn
            DataBinding.FieldName = 'VALIDASI_TMP'
            Styles.Content = _DataModule.cxStyle9
            Width = 91
          end
          ...
          object cxGrid3DBTableView1HARGA_W_SO: TcxGridDBColumn
            DataBinding.FieldName = 'HARGA_W_SO'
            Styles.Content = _DataModule.cxStyle9
            Width = 100
          end
          object cxGrid3DBTableView1PERJANJIAN: TcxGridDBColumn
            DataBinding.FieldName = 'PERJANJIAN'
            Styles.Content = _DataModule.cxStyle9
            Width = 91
          end
          ...
          object cxGrid3DBTableView1PERHITUNGAN_TMP: TcxGridDBColumn
            DataBinding.FieldName = 'PERHITUNGAN_TMP'
            Styles.Content = _DataModule.cxStyle9
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.SUB_BRAND, a.MATERIAL, a.REF_IAP, a.REF_TMP, a.KETERANG' +
        'AN, a.STOCK_POINT, a.ORDER_DATE, a.INVOICE_NUMBER, '
      
        '       a.CUSTOMER, a.TYPE_OUTLET, a.SALES_QTY_BASED_UOM, a.SALES' +
        '_QTY_FRACTION, a.NOMINAL_KLAIM, a.VALIDASI_TMP, '
      
        '       a.TOLAKAN, a.EASAP, a.PILAR, a.GROUPING, a.HARGA_W_SO, a.' +
        'PERJANJIAN, a.DISCOUNT, a.PERHITUNGAN_TMP, a.SELISIH'
      'FROM VALIDASI_TP a'
    ...
    object Daily_DBREF_TMP: TStringField
      FieldName = 'REF_TMP'
      Size = 50
    end
    ...
    object Daily_DBSALES_QTY_BASED_UOM: TFloatField
      FieldName = 'SALES_QTY_BASED_UOM'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSALES_QTY_FRACTION: TFloatField
      FieldName = 'SALES_QTY_FRACTION'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNOMINAL_KLAIM: TFloatField
      FieldName = 'NOMINAL_KLAIM'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBVALIDASI_TMP: TFloatField
      FieldName = 'VALIDASI_TMP'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBGROUPING: TStringField
      FieldName = 'GROUPING'
    end
    object Daily_DBHARGA_W_SO: TFloatField
      FieldName = 'HARGA_W_SO'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBPERJANJIAN: TFloatField
      FieldName = 'PERJANJIAN'
    end
    object Daily_DBDISCOUNT: TFloatField
      FieldName = 'DISCOUNT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBPERHITUNGAN_TMP: TFloatField
      FieldName = 'PERHITUNGAN_TMP'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
  ...
  object PopupMenu3: TPopupMenu
    ...
    object Grid1: TMenuItem
      ...
      object AllView1: TMenuItem
        Caption = 'All View'
        OnClick = AllView1Click
      end
    end
  ...
  object Qgenerate: TUniQuery
    ...
    Connection = _DataModule.UniFirebird2017
    SQL.Strings = (
      'EXECUTE PROCEDURE GEN_VALIDASI_TP_temp')
    Left = 476
    Top = 245
  end
  ...
  object UniQuery1: TUniQuery
    ...
    object UniQuery1SALES_QTY_BASED_UOM: TFloatField
      FieldName = 'SALES_QTY_BASED_UOM'
    end
    object UniQuery1SALES_QTY_FRACTION: TFloatField
      FieldName = 'SALES_QTY_FRACTION'
    end
    object UniQuery1NOMINAL_KLAIM: TFloatField
      FieldName = 'NOMINAL_KLAIM'
    end
    object UniQuery1VALIDASI_TMP: TFloatField
      FieldName = 'VALIDASI_TMP'
    end
    ...
    object UniQuery1GROUPING: TStringField
      FieldName = 'GROUPING'
    end
    object UniQuery1HARGA_W_SO: TFloatField
      FieldName = 'HARGA_W_SO'
    end
    object UniQuery1PERJANJIAN: TFloatField
      FieldName = 'PERJANJIAN'
    end
    object UniQuery1DISCOUNT: TFloatField
      FieldName = 'DISCOUNT'
    end
    object UniQuery1PERHITUNGAN_TMP: TFloatField
      FieldName = 'PERHITUNGAN_TMP'
    end
  ...
  object Qtgl: TUniQuery
    DataTypeMap = <>
    Connection = _DataModule.UniFirebird2017
    SQL.Strings = (
      
        'select cast( dateadd((EXTRACT (yearday FROM current_date)*-1) da' +
        'y to current_date) as date) as tgl1'
      'from rdb$database')
    Left = 240
    Top = 390
    object QtglTGL1: TDateField
      FieldName = 'TGL1'
      ReadOnly = True
    end
  end
  object QImport3XLS1: TQImport3XLS
    ...
    Map.Strings = (
      'SUB_BRAND=[SHEET1]A-COLFINISH;'
      'MATERIAL=[SHEET1]B-COLFINISH;'
      'REF_IAP=[SHEET1]C-COLFINISH;'
      'REF_TMP=[SHEET1]D-COLFINISH;'
      'KETERANGAN=[SHEET1]E-COLFINISH;'
      'STOCK_POINT=[SHEET1]F-COLFINISH;'
      'ORDER_DATE=[SHEET1]G-COLFINISH;'
      'INVOICE_NUMBER=[SHEET1]H-COLFINISH;'
      'CUSTOMER=[SHEET1]I-COLFINISH;'
      'TYPE_OUTLET=[SHEET1]J-COLFINISH;'
      'SALES_QTY_BASED_UOM=[SHEET1]K-COLFINISH;'
      'SALES_QTY_FRACTION=[SHEET1]L-COLFINISH;'
      'NOMINAL_KLAIM=[SHEET1]M-COLFINISH;'
      'TOLAKAN=[SHEET1]N-COLFINISH;'
      'VALIDASI_TMP=[SHEET1]O-COLFINISH;'
      'EASAP=[SHEET1]P-COLFINISH;'
      'PILAR=[SHEET1]Q-COLFINISH;'
      'GROUPING=[SHEET1]R-COLFINISH;'
      'HARGA_W_SO=[SHEET1]S-COLFINISH;'
      'PERJANJIAN=[SHEET1]T-COLFINISH;'
      'DISCOUNT=[SHEET1]U-COLFINISH;'
      'PERHITUNGAN_TMP=[SHEET1]V-COLFINISH;'
      'SELISIH=[SHEET1]W-COLFINISH;')
    Formats.BooleanTrue.Strings = (
      'True')
    Formats.BooleanFalse.Strings = (
      'False')
    ...
    KeyColumns.Strings = (
      ...
      'STOCK_POINT'
      'INVOICE_NUMBER')
    FileName = 'D:\project claim IAP\project Accrued EASAP\claim TP\test.xls'
    SkipFirstRows = 1
    Left = 636
    Top = 173
  end
