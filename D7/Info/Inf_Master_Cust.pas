...
type
  TInf_Master_CustFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    ...
    Daily_DBshort_nama: TStringField;
    Daily_DBbill_to_nama: TStringField;
    Daily_DBcontact_person: TStringField;
    Daily_DBadress: TStringField;
    Daily_DBcust_group: TStringField;
    Daily_DBphone: TStringField;
    Daily_DBpost_code: TStringField;
    ...
    Daily_DBprint_fp: TStringField;
    Daily_DBSTOCKPOINTNAME: TStringField;
    Daily_DBjenis_customer: TStringField;
    cxGrid3DBTableView1nama: TcxGridDBColumn;
    cxGrid3DBTableView1short_nama: TcxGridDBColumn;
    cxGrid3DBTableView1bill_to_nama: TcxGridDBColumn;
    cxGrid3DBTableView1contact_person: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1post_code: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1print_fp: TcxGridDBColumn;
    ...
    Daily_DBkode_Depo: TIntegerField;
...
var
  Inf_Master_CustFrm: TInf_Master_CustFrm;
implementation
...
procedure TInf_Master_CustFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Master_CustFrm := nil;
end;

procedure TInf_Master_CustFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
...
cxGrid3DBTableView1.DataController.DataSource:=nil;
  ...
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Master_CustFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Master_CustFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Master_CustFrm.FormShow(Sender: TObject);
begin
...
procedure TInf_Master_CustFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Master_CustFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Master_CustFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Master_CustFrm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Master_CustFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Master_CustFrm.DataRaw1Click(Sender: TObject);
begin
