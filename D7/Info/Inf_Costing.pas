...
type
  TInf_CostingFrm = class(TForm)
    ...
    Daily_DBNO_POLISI: TStringField;
    ...
    Daily_DBkode_biaya: TStringField;
    Daily_DBnama_biaya: TStringField;
    Daily_DBnilai: TIntegerField;
    cxGrid3DBTableView1NO_POLISI: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1kode_biaya: TcxGridDBColumn;
    cxGrid3DBTableView1nama_biaya: TcxGridDBColumn;
    cxGrid3DBTableView1nilai: TcxGridDBColumn;
...
var
  Inf_CostingFrm: TInf_CostingFrm;
implementation
...
procedure TInf_CostingFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
...
procedure TInf_CostingFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin

  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_CostingFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_CostingFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_CostingFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_CostingFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_CostingFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_CostingFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_CostingFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
