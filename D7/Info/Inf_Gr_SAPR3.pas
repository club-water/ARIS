...
type
  TInf_Gr_SAPR3Frm = class(TForm)
    ...
    Daily_DBDelivery_Date: TDateTimeField;
    Daily_DBDelv_Completed: TStringField;
    Daily_DBGr_Document: TStringField;
    Daily_DBGR_Date: TDateTimeField;
    Daily_DBDescription: TStringField;
    Daily_DBPo_QTy: TFloatField;
    Daily_DBGr_Qty: TFloatField;
    Daily_DBOutstanding_PO: TFloatField;
    Daily_DBItem_Text: TStringField;
    ...
    cxGrid3DBTableView1Delv_Completed: TcxGridDBColumn;
    cxGrid3DBTableView1Gr_Document: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1Item_Text: TcxGridDBColumn;
...
var
  Inf_Gr_SAPR3Frm: TInf_Gr_SAPR3Frm;
implementation
...
procedure TInf_Gr_SAPR3Frm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
...
procedure TInf_Gr_SAPR3Frm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Gr_SAPR3Frm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Gr_SAPR3Frm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Gr_SAPR3Frm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Gr_SAPR3Frm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Gr_SAPR3Frm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Gr_SAPR3Frm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Gr_SAPR3Frm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Gr_SAPR3Frm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Gr_SAPR3Frm.DataRaw1Click(Sender: TObject);
begin
