object Inf_Sales_Detil_BWFrm: TInf_Sales_Detil_BWFrm
  Left = 71
  Top = 33
  Width = 1378
  Height = 744
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Kind = skSum
              FieldName = 'Discount'
              Column = cxGrid3DBTableView1Discount
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1TOP_Payment: TcxGridDBColumn
            DataBinding.FieldName = 'TOP_Payment'
            Width = 76
          end
          ...
          object cxGrid3DBTableView1sales_return_amount: TcxGridDBColumn
            DataBinding.FieldName = 'sales_return_amount'
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'select r.*,case when TOP_Payment  BETWEEN 0 AND 8 then '#39'Tunai'#39
      '            else '#39'Kredit'#39' '
      '        end as Jenis_Transaksi'
      ' from ('
      'SELECT A.*'
      '      ,(a.Gross_Value/a.Gross_Qty)*1.1 as harga'
      ''
      ...
      'where  a.Tanggal>=:0'
      '  and  a.Tanggal<=:1'
      ' -- and  c.price_level='#39'HOD'#39' '
      ' -- and a.Material_cd='#39'000000000000142983'#39
      ') r')
    FetchRows = 5000
    Left = 731
    Top = 270
    ...
    object Daily_DBnet_Sales_qty: TFloatField
      DisplayLabel = 'Net Sales Qty'
      FieldName = 'net_Sales_qty'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBnet_sales_value: TFloatField
      DisplayLabel = 'Net Sales Value'
      FieldName = 'net_sales_value'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBTOP_Payment: TIntegerField
      DisplayLabel = 'TOP Payment'
      FieldName = 'TOP_Payment'
      ReadOnly = True
    end
