object Comp_Expenses_rekap_marsVSR3Frm: TComp_Expenses_rekap_marsVSR3Frm
  Left = 180
  Top = 61
  Width = 1130
  Height = 610
  Caption = 'Comp_Expenses_rekap_marsVSR3Frm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1bw_StockPoint_kd: TcxGridDBColumn
            DataBinding.FieldName = 'bw_StockPoint_kd'
            Width = 118
          end
    ...
    object TabSheet1: TTabSheet
      ...
      object cxGrid4: TcxGrid
        ...
        object cxGridDBTableView3: TcxGridDBTableView
          ...
          Styles.ContentEven = _DataModule.cxStyle1
          Styles.ContentOdd = _DataModule.cxStyle3
          object cxGridDBTableView3BW_StockPoint_kd: TcxGridDBColumn
            DataBinding.FieldName = 'BW_StockPoint_kd'
            Width = 100
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'select t.* , case  WHEN ABS(selisih_mrs_sapbw) <> 0 THEN 1 '
      ...
      '  FROM [MARS].[dbo].[VExpenses_Mrs_rekap] a  Full  join'
        ...
        '  mars.dbo.VExpenses_sapBW_rekap D ON D.bw_StockPoint_kd=a.mrs_S' +
        'ALESPOINTCD'
      '           and d.bw_DocumentDate=a.mrs_TGL'
      '  where isnull(a.mrs_TGL,d.bw_DocumentDate)>=:0'
      '     and isnull(a.mrs_TGL,d.bw_DocumentDate)<=:1 '
      ' ) T')
    Left = 323
    Top = 166
    ParamData = <
    ...
    object Daily_DBbw_StockPoint_kd: TStringField
      FieldName = 'bw_StockPoint_kd'
      ReadOnly = True
      Size = 50
    end
  end
  ...
  object SAPBW: TUniQuery
    ...
    object SAPBWBW_StockPoint_kd: TStringField
      FieldName = 'BW_StockPoint_kd'
      Size = 50
    end
  end
