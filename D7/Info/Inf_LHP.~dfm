object Inf_LHPFrm: TInf_LHPFrm
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'ANTARDOKU'
              Column = cxGrid3DBTableView1ANTARDOKU
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'NILAIDOCU'
              Column = cxGrid3DBTableView1NILAIDOCU
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'TOTALLUNAS'
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'NILJAMINAN'
              Column = cxGrid3DBTableView1NILJAMINAN
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'BIAYABANK'
              Column = cxGrid3DBTableView1BIAYABANK
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'LUNASTUNAI'
              Column = cxGrid3DBTableView1LUNASTUNAI
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'LUNASGIRO'
              Column = cxGrid3DBTableView1LUNASGIRO
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Nilai_Amount'
              Column = cxGrid3DBTableView1Nilai_Amount
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1KETSUBUNIT: TcxGridDBColumn
            DataBinding.FieldName = 'KETSUBUNIT'
            Width = 114
          end
          object cxGrid3DBTableView1NOLHP: TcxGridDBColumn
            DataBinding.FieldName = 'NOLHP'
            Width = 121
          end
          object cxGrid3DBTableView1TGLDOCU: TcxGridDBColumn
            DataBinding.FieldName = 'TGLDOCU'
            Width = 88
          end
          object cxGrid3DBTableView1KDSLM: TcxGridDBColumn
            DataBinding.FieldName = 'KDSLM'
            Width = 58
          end
          ...
          object cxGrid3DBTableView1KETSATUS: TcxGridDBColumn
            DataBinding.FieldName = 'KETSATUS'
            Width = 83
          end
          ...
          object cxGrid3DBTableView1GRP_BY: TcxGridDBColumn
            DataBinding.FieldName = 'GRP_BY'
            Width = 107
          end
          object cxGrid3DBTableView1TGLDOCUDTL: TcxGridDBColumn
            DataBinding.FieldName = 'TGLDOCUDTL'
            Width = 104
          end
          object cxGrid3DBTableView1NODOKUMEN: TcxGridDBColumn
            DataBinding.FieldName = 'NODOKUMEN'
            Width = 153
          end
          object cxGrid3DBTableView1NOTAJUAL: TcxGridDBColumn
            DataBinding.FieldName = 'NOTAJUAL'
            Width = 109
          end
          object cxGrid3DBTableView1NILAIDOCU: TcxGridDBColumn
            DataBinding.FieldName = 'NILAIDOCU'
            Width = 95
          end
          object cxGrid3DBTableView1NILJAMINAN: TcxGridDBColumn
            DataBinding.FieldName = 'NILJAMINAN'
            Width = 88
          end
          object cxGrid3DBTableView1BIAYABANK: TcxGridDBColumn
            DataBinding.FieldName = 'BIAYABANK'
            Width = 112
          end
          object cxGrid3DBTableView1BIAYALAIN: TcxGridDBColumn
            DataBinding.FieldName = 'BIAYALAIN'
            Width = 96
          end
          object cxGrid3DBTableView1LUNASTUNAI: TcxGridDBColumn
            DataBinding.FieldName = 'LUNASTUNAI'
            Width = 103
          end
          object cxGrid3DBTableView1LUNASGIRO: TcxGridDBColumn
            DataBinding.FieldName = 'LUNASGIRO'
            Width = 95
          end
          object cxGrid3DBTableView1ANTARDOKU: TcxGridDBColumn
            DataBinding.FieldName = 'ANTARDOKU'
            Width = 95
          end
          object cxGrid3DBTableView1Nilai_Amount: TcxGridDBColumn
            DataBinding.FieldName = 'Nilai_Amount'
          end
          object cxGrid3DBTableView1TKRFAKTUR: TcxGridDBColumn
            DataBinding.FieldName = 'TKRFAKTUR'
            Width = 106
          end
          object cxGrid3DBTableView1FLG_KEMBALI: TcxGridDBColumn
            DataBinding.FieldName = 'FLG_KEMBALI'
            Width = 70
          end
          object cxGrid3DBTableView1NOREFERENSI: TcxGridDBColumn
            DataBinding.FieldName = 'NOREFERENSI'
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'EXEC'#9'TBREPORTING.[dbo].RPT_LHP_CLOSE :0,:1')
    Left = 491
    Top = 182
    ParamData = <
      item
    ...
    object Daily_DBNOLHP: TStringField
      FieldName = 'NOLHP'
      ReadOnly = True
      Size = 32
    end
    object Daily_DBTGLDOCU: TDateTimeField
      FieldName = 'TGLDOCU'
      ReadOnly = True
    end
    object Daily_DBKDSLM: TStringField
      FieldName = 'KDSLM'
      Required = True
      Size = 4
    end
    ...
    object Daily_DBKETSUBUNIT: TStringField
      FieldName = 'KETSUBUNIT'
      ReadOnly = True
      Required = True
      Size = 50
    end
    ...
    object Daily_DBKETSATUS: TStringField
      FieldName = 'KETSATUS'
      ReadOnly = True
      Size = 30
    end
    ...
    object Daily_DBGRP_BY: TStringField
      FieldName = 'GRP_BY'
      ReadOnly = True
      Required = True
      Size = 7
    end
    object Daily_DBTGLDOCUDTL: TDateTimeField
      FieldName = 'TGLDOCUDTL'
      ReadOnly = True
    end
    object Daily_DBNODOKUMEN: TStringField
      FieldName = 'NODOKUMEN'
      ReadOnly = True
      Size = 32
    end
    object Daily_DBNOTAJUAL: TStringField
      FieldName = 'NOTAJUAL'
      ReadOnly = True
      Size = 32
    end
    object Daily_DBNILAIDOCU: TFloatField
      FieldName = 'NILAIDOCU'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
      Precision = 11
    end
    object Daily_DBNILJAMINAN: TFloatField
      FieldName = 'NILJAMINAN'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
      Precision = 11
    end
    object Daily_DBBIAYABANK: TFloatField
      FieldName = 'BIAYABANK'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBBIAYALAIN: TFloatField
      FieldName = 'BIAYALAIN'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBLUNASTUNAI: TFloatField
      FieldName = 'LUNASTUNAI'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBLUNASGIRO: TFloatField
      FieldName = 'LUNASGIRO'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBANTARDOKU: TFloatField
      FieldName = 'ANTARDOKU'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBTKRFAKTUR: TStringField
      FieldName = 'TKRFAKTUR'
      ReadOnly = True
      Required = True
      Size = 26
    end
    object Daily_DBFLG_KEMBALI: TStringField
      FieldName = 'FLG_KEMBALI'
      ReadOnly = True
      Required = True
      Size = 1
    end
    object Daily_DBNOREFERENSI: TStringField
      FieldName = 'NOREFERENSI'
      ReadOnly = True
    end
    object Daily_DBNilai_Amount: TFloatField
      DisplayLabel = 'TOTAL'
      FieldName = 'Nilai_Amount'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
