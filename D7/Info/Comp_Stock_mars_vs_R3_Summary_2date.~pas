unit Comp_Stock_mars_vs_R3_Summary_2date;
...
type
  TComp_Stock_mars_vs_R3_Summary_2dateFRM = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBMrs_Stock_awal: TIntegerField;
    Daily_DBMrs_Stock_Prd: TIntegerField;
    Daily_DBSAP_Stock_awal: TIntegerField;
    Daily_DBSAP_Stock_prd: TIntegerField;
    ...
    Daily_DBselisih_mrs_sapr3_akhir: TIntegerField;
    Daily_DBselisih_mrs_sapr3_awal: TIntegerField;
    Daily_DBselisih_mrs_sapr3_prd: TIntegerField;
    ...
    cxGrid3DBTableView1Mrs_Stock_awal: TcxGridDBColumn;
    cxGrid3DBTableView1Mrs_Stock_Prd: TcxGridDBColumn;
    cxGrid3DBTableView1SAP_Stock_awal: TcxGridDBColumn;
    cxGrid3DBTableView1SAP_Stock_prd: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1selisih_mrs_sapr3_akhir: TcxGridDBColumn;
    cxGrid3DBTableView1selisih_mrs_sapr3_awal: TcxGridDBColumn;
    cxGrid3DBTableView1selisih_mrs_sapr3_prd: TcxGridDBColumn;
...
var
  Comp_Stock_mars_vs_R3_Summary_2dateFRM: TComp_Stock_mars_vs_R3_Summary_2dateFRM;
implementation
...
procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
  Comp_Stock_mars_vs_R3_Summary_2dateFRM := nil;
end;

procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.BitBtn1Click(Sender: TObject);
var AIndex: integer;
...
procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.Button3Click(Sender: TObject);
begin
  cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.Grid1Click(Sender: TObject);
begin
...
procedure TComp_Stock_mars_vs_R3_Summary_2dateFRM.DataRaw1Click(Sender: TObject);
begin
