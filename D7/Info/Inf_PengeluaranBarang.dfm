object Inf_PengeluaranBarangFrm: TInf_PengeluaranBarangFrm
  Left = 171
  Top = 67
  Width = 909
  Height = 575
  Caption = 'Inf_PengeluaranBarangFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1KODE_GUDANG: TcxGridDBColumn
            DataBinding.FieldName = 'KODE_GUDANG'
            Width = 81
          end
          object cxGrid3DBTableView1GUDANG: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1kode_supplier: TcxGridDBColumn
            DataBinding.FieldName = 'kode_supplier'
            Width = 46
          end
          object cxGrid3DBTableView1nama_supplier: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1KODE_PENANGGUNG_JAWAB: TcxGridDBColumn
            DataBinding.FieldName = 'KODE_PENANGGUNG_JAWAB'
            Visible = False
            Width = 47
          end
          object cxGrid3DBTableView1NAMA_PENANGGUNG_JAWAB: TcxGridDBColumn
            DataBinding.FieldName = 'NAMA_PENANGGUNG_JAWAB'
            Visible = False
            Width = 90
          end
          object cxGrid3DBTableView1NO_POL: TcxGridDBColumn
            DataBinding.FieldName = 'NO_POL'
            Width = 57
          end
          object cxGrid3DBTableView1ASSET: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    DataTypeMap = <>
    SQL.Strings = (
      'SELECT a.JENIS,a.KODE_GUDANG,h.gudang AS GUDANG,    '
      '       a.NO_TRANSAKSI,a.TGL_TRANSAKSI,'
      '       a.kode_supplier,f.NAMA as nama_supplier,f.ALAMAT_1, '
      
        '       a.KODE_PENANGGUNG_JAWAB,b.NAMA as NAMA_PENANGGUNG_JAWAB,a' +
        '.no_pol AS NO_POL,'
      
        '       e.NO_TRANSAKSI_aset AS ASSET,g.KODE_ITEM,g.NAMA_ITEM,e.QT' +
        'Y'
      'FROM PENGELUARAN_ASET_M AS a left outer join'
      
        '     TB_HRIS.dbo.M_KARYAWAN b on a.KODE_PENANGGUNG_JAWAB=b.NIK l' +
        'eft outer join'
      
        '     TB_HRIS.dbo.MST_DIVISI c on a.kode_gudang=c.divisi left out' +
        'er join'
      
        '     TB_HRIS.dbo.MST_BAGIAN d on a.KODE_BAGIAN=d.BAGIAN left out' +
        'er join'
      
        '     PENGELUARAN_ASET_D e on a.NO_TRANSAKSI=e.NO_TRANSAKSI left ' +
        'outer join'
      '     MST_SUPPLIER f on f.kode=a.kode_supplier left outer join'
      
        '     tb_aris.dbo.MST_ITEM g on g.KODE_ITEM=e.KODE_ITEM left oute' +
        'r join'
      
        '     mst_lokasi_gudang h on h.kode=a.kode_gudang and h.kode=a.ko' +
        'de'
      ''
    ...
    object Daily_DBKODE_GUDANG: TStringField
      DisplayLabel = 'KD GUDANG'
      FieldName = 'KODE_GUDANG'
      Size = 50
    end
    object Daily_DBGUDANG: TStringField
      FieldName = 'GUDANG'
      ReadOnly = True
      Size = 250
    end
    ...
    object Daily_DBkode_supplier: TStringField
      DisplayLabel = 'KD SUPPLIER'
      FieldName = 'kode_supplier'
      Size = 50
    end
    object Daily_DBnama_supplier: TStringField
    ...
    object Daily_DBKODE_PENANGGUNG_JAWAB: TStringField
      DisplayLabel = 'KD PENANGGUNG JAWAB'
      FieldName = 'KODE_PENANGGUNG_JAWAB'
      Size = 50
    end
    object Daily_DBNAMA_PENANGGUNG_JAWAB: TStringField
      DisplayLabel = 'NAMA PENANGGUNG JAWAB'
      FieldName = 'NAMA_PENANGGUNG_JAWAB'
      ReadOnly = True
      Size = 100
    end
    object Daily_DBNO_POL: TStringField
      DisplayLabel = 'NO POL'
      FieldName = 'NO_POL'
      Size = 50
    end
    object Daily_DBASSET: TStringField
      FieldName = 'ASSET'
      ReadOnly = True
      Size = 50
    end
