object Comp_Stock_mars_vs_R3_SummaryFRM: TComp_Stock_mars_vs_R3_SummaryFRM
  Left = 352
  Top = 100
  Width = 798
  Height = 558
  Caption = 'Comp_Stock_mars_vs_R3_SummaryFRM'
  Color = clBtnFace
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
        ...
        'select *,isnull(Mrs_Stock_Akhir,0)-isnull(SAP_Stock_Akhir,0) as ' +
        'selisih_mrs_sapr3'
      
        ' , case  WHEN abs(isnull(Mrs_Stock_Akhir,0)-isnull(SAP_Stock_Akh' +
        'ir,0)) <> 0 THEN 1 '
    ...
    object Daily_DBselisih_mrs_sapr3: TIntegerField
      FieldName = 'selisih_mrs_sapr3'
      ReadOnly = True
    end
