...
type
  TInf_Invoice_PajakFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    cxGrid3DBTableView1no_seri_pajak: TcxGridDBColumn;
    ...
    Daily_DBstockpoint_Kode: TIntegerField;
    cxGrid3DBTableView1stockpoint_Kode: TcxGridDBColumn;
...
var
  Inf_Invoice_PajakFrm: TInf_Invoice_PajakFrm;
implementation
...
procedure TInf_Invoice_PajakFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Invoice_PajakFrm := nil;
end;

procedure TInf_Invoice_PajakFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
  cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Invoice_PajakFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Invoice_PajakFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Invoice_PajakFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Invoice_PajakFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Invoice_PajakFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Invoice_PajakFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Invoice_PajakFrm.Button2Click(Sender: TObject);
begin
  cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Invoice_PajakFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Invoice_PajakFrm.DataRaw1Click(Sender: TObject);
begin
