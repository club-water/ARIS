object Comp_Stock_mars_vs_R3_Summary_2dateFRM: TComp_Stock_mars_vs_R3_Summary_2dateFRM
  Left = 352
  Top = 100
  Width = 798
  Height = 558
  Caption = 'Comp_Stock_mars_vs_R3_Summary_2dateFRM'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1MRS_Material_cd: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Material_cd'
            Styles.Content = _DataModule.cxStyle9
            Width = 90
          end
          object cxGrid3DBTableView1MRS_Material_Nama: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Material_Nama'
            Styles.Content = _DataModule.cxStyle9
            Width = 106
          end
          ...
          object cxGrid3DBTableView1R3_ITEMCD: TcxGridDBColumn
            DataBinding.FieldName = 'R3_ITEMCD'
            Styles.Content = _DataModule.cxStyle6
            Width = 66
          end
          object cxGrid3DBTableView1R3_Material_Nama: TcxGridDBColumn
            DataBinding.FieldName = 'R3_Material_Nama'
            Styles.Content = _DataModule.cxStyle6
            Width = 96
          end
          object cxGrid3DBTableView1Mrs_Stock_awal: TcxGridDBColumn
            DataBinding.FieldName = 'Mrs_Stock_awal'
            Styles.Content = _DataModule.cxStyle9
          end
          object cxGrid3DBTableView1SAP_Stock_awal: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_Stock_awal'
            Styles.Content = _DataModule.cxStyle6
          end
          object cxGrid3DBTableView1Mrs_Stock_Prd: TcxGridDBColumn
            DataBinding.FieldName = 'Mrs_Stock_Prd'
            Styles.Content = _DataModule.cxStyle9
          end
          object cxGrid3DBTableView1SAP_Stock_prd: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_Stock_prd'
            Styles.Content = _DataModule.cxStyle6
          end
          object cxGrid3DBTableView1mrs_stock_akhir: TcxGridDBColumn
            DataBinding.FieldName = 'mrs_stock_akhir'
            Styles.Content = _DataModule.cxStyle9
          end
          object cxGrid3DBTableView1sap_stock_akhir: TcxGridDBColumn
            DataBinding.FieldName = 'sap_stock_akhir'
            Styles.Content = _DataModule.cxStyle6
          end
          object cxGrid3DBTableView1selisih_mrs_sapr3_awal: TcxGridDBColumn
            DataBinding.FieldName = 'selisih_mrs_sapr3_awal'
            Styles.Content = _DataModule.cxStyle30
          end
          object cxGrid3DBTableView1selisih_mrs_sapr3_prd: TcxGridDBColumn
            DataBinding.FieldName = 'selisih_mrs_sapr3_prd'
            Styles.Content = _DataModule.cxStyle30
          end
          object cxGrid3DBTableView1selisih_mrs_sapr3_akhir: TcxGridDBColumn
            DataBinding.FieldName = 'selisih_mrs_sapr3_akhir'
            Styles.Content = _DataModule.cxStyle30
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
        ...
        'select w.*,isnull(Mrs_Stock_Akhir,0)-isnull(SAP_Stock_Akhir,0) a' +
        's selisih_mrs_sapr3_akhir'
      
        '      ,isnull(Mrs_Stock_awal,0)-isnull(SAP_Stock_awal,0) as seli' +
        'sih_mrs_sapr3_awal'
      
        '      ,isnull(Mrs_Stock_Prd,0)-isnull(SAP_Stock_prd,0) as selisi' +
        'h_mrs_sapr3_prd'
      
        '      ,case  WHEN abs(isnull(Mrs_Stock_Akhir,0)-isnull(SAP_Stock' +
        '_Akhir,0)) <> 0 THEN 1 '
      '         ELSE 0 end as Flag_Selisih'
      ' '
      ' from ('
      
        'select *,isnull(Mrs_Stock_awal,0)+isnull(Mrs_Stock_prd,0) as mrs' +
        '_stock_akhir'
      
        '        ,isnull(SAP_Stock_awal,0)+isnull(sap_Stock_prd,0) as sap' +
        '_stock_akhir'
      ''
      ''
      '  from    ('
      'SELECT a.kode_branch as MRS_kode_branch'
      '      ,a.nama_Branch as MRS_nama_Branch'
      '      ,a.stockPOint_cd as MRS_SALESPOINTCD '
      '      ,a.STOCKPOINTNAME as MRS_STOCKPOINTNAME'
      '      ,a.Material_cd as MRS_Material_cd'
      '      ,a.Material_Nama as MRS_Material_Nama'
      '      '
      '      ,d.SALESPOINTCD as R3_SALESPOINTCD'
      '      ,d.STOCKPOINTNAME as R3_STOCKPOINTNAME'
      '      ,d.PLANTCD as R3_Kode_Branch'
      '      ,d.nama_Branch as R3_nama_Branch'
      
        '      ,dbo.F_cari_Mars_Stock(a.stockPOint_cd,a.kode_branch,a.Mat' +
        'erial_cd,DATEADD(day,-1,:0)) as  Mrs_Stock_awal'
      
        '      ,dbo.F_cari_Mars_Stock_period(a.stockPOint_cd,a.kode_branc' +
        'h,a.Material_cd,:0,:1) as  Mrs_Stock_Prd'
      '      '
      
        '      ,MARS.DBO.F_cari_sap_Stock_1(d.SALESPOINTCD,d.PLANTCD,d.IT' +
        'EMCD,DATEADD(day,-1,:0)) as SAP_Stock_awal'
      
        '      ,MARS.DBO.F_cari_sap_Stock_1_period(d.SALESPOINTCD,d.PLANT' +
        'CD,d.ITEMCD,:0,:1) as SAP_Stock_prd'
      '      '
      '      '
      '      ,d.ITEMCD as R3_ITEMCD'
      '      ,d.Material_Nama as R3_Material_Nama'
      '    FROM MARS.dbo.VMars_Stock_saldo a  Full  join'
      '       mars.dbo.VYb25A_saldo D ON d.PLANTCD=a.kode_branch'
      '       and cast(D.SALESPOINTCD as int)=a.stockPOint_cd'
      '       and cast(d.ITEMCD as int)=a.Material_cd'
      '          ) t'
      
        '     where (isnull(Mrs_Stock_awal,0)<>0 or isnull(Mrs_Stock_prd,' +
        '0)<>0 or isnull(SAP_Stock_awal,0)<>0 or isnull(sap_Stock_prd,0)<' +
        '>0)'
      ' ) w')
    Left = 347
    Top = 166
    ...
    object Daily_DBMRS_Material_cd: TStringField
      FieldName = 'MRS_Material_cd'
      Size = 50
    end
    object Daily_DBMRS_Material_Nama: TStringField
      FieldName = 'MRS_Material_Nama'
      Size = 250
    end
    object Daily_DBR3_SALESPOINTCD: TStringField
    ...
    object Daily_DBMrs_Stock_awal: TIntegerField
      FieldName = 'Mrs_Stock_awal'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBMrs_Stock_Prd: TIntegerField
      FieldName = 'Mrs_Stock_Prd'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSAP_Stock_awal: TIntegerField
      FieldName = 'SAP_Stock_awal'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSAP_Stock_prd: TIntegerField
      FieldName = 'SAP_Stock_prd'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBR3_ITEMCD: TStringField
      FieldName = 'R3_ITEMCD'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBR3_Material_Nama: TStringField
      FieldName = 'R3_Material_Nama'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBmrs_stock_akhir: TIntegerField
      FieldName = 'mrs_stock_akhir'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBsap_stock_akhir: TIntegerField
      FieldName = 'sap_stock_akhir'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBselisih_mrs_sapr3_akhir: TIntegerField
      FieldName = 'selisih_mrs_sapr3_akhir'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBselisih_mrs_sapr3_awal: TIntegerField
      FieldName = 'selisih_mrs_sapr3_awal'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBselisih_mrs_sapr3_prd: TIntegerField
      FieldName = 'selisih_mrs_sapr3_prd'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
  ...
  object Mrs: TUniQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'select t.* , case WHEN ABS(selisih_mrs_sapr3) <> 0 or  MRS_nama_' +
        'stockpoint is null THEN 1 '
      '         ELSE 0 end as Flag_Selisih '
      ' from ('
      'SELECT a.stockpointkd AS MRS_stockpointkd'
      '      ,a.nama_stockpoint AS MRS_nama_stockpoint'
      '      ,a.Po_date AS MRS_Po_date'
      '      ,a.Vendor AS MRS_Vendor'
      '      ,a.PO_Number AS MRS_PO_Number'
      '      ,a.qty AS MRS_qty'
      '      ,a.do_number as mrs_do_number'
      '      '
      '      ,d.STOCKPOINTNAME as R3_STOCKPOINTNAME'
      '      ,d.PO_number as R3_PO_number'
      '      ,d.Po_date as R3_Po_date'
      '      ,d.Po_QTy as R3_Po_QTy'
      '      ,d.Gr_Qty as R3_Gr_Qty'
      '      ,d.vendor as R3_vendor'
      '      ,d.Plant as R3_Plant'
      '      ,d.StockPoint_KD as R3_StockPoint_KD'
      '      ,d.do_number as R3_do_number'
      '      '
      
        '      ,abs(isnull(a.qty,0)-isnull(d.Gr_Qty,0)) as selisih_mrs_sa' +
        'pr3'
      '   '
      '  FROM [MARS].[dbo].[VGr_Mars_do] a  Full  join'
      '  mars.dbo.VGR_SAP3_do D ON D.STOCKPOINTNAME=a.nama_stockpoint'
      '           and d.PO_number=a.PO_Number '
      '           and d.do_number=a.do_number'
      '  where isnull(a.Po_number,d.Po_number)=:0'
      ' ) T'
      'order by t.MRS_stockpointkd')
    Active = True
    Left = 595
    Top = 110
    ParamData = <
    ...
    object MrsMRS_stockpointkd: TStringField
      FieldName = 'MRS_stockpointkd'
      Size = 50
    end
    object MrsMRS_nama_stockpoint: TStringField
      FieldName = 'MRS_nama_stockpoint'
      ReadOnly = True
      Size = 250
    end
    object MrsMRS_Po_date: TDateTimeField
      FieldName = 'MRS_Po_date'
      ReadOnly = True
    end
    object MrsMRS_Vendor: TStringField
      FieldName = 'MRS_Vendor'
      Size = 250
    end
    object MrsMRS_PO_Number: TStringField
      FieldName = 'MRS_PO_Number'
      Size = 50
    end
    object MrsMRS_qty: TFloatField
      FieldName = 'MRS_qty'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Mrsmrs_do_number: TStringField
      FieldName = 'mrs_do_number'
      Size = 50
    end
    object MrsR3_STOCKPOINTNAME: TStringField
      FieldName = 'R3_STOCKPOINTNAME'
      ReadOnly = True
      Size = 250
    end
    object MrsR3_PO_number: TStringField
      FieldName = 'R3_PO_number'
      ReadOnly = True
      Size = 250
    end
    object MrsR3_Po_date: TDateTimeField
      FieldName = 'R3_Po_date'
      ReadOnly = True
    end
    object MrsR3_Po_QTy: TFloatField
      FieldName = 'R3_Po_QTy'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object MrsR3_Gr_Qty: TFloatField
      FieldName = 'R3_Gr_Qty'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object MrsR3_vendor: TStringField
      FieldName = 'R3_vendor'
      ReadOnly = True
      Size = 250
    end
    object MrsR3_Plant: TStringField
      FieldName = 'R3_Plant'
      ReadOnly = True
      Size = 250
    end
    object MrsR3_StockPoint_KD: TStringField
      FieldName = 'R3_StockPoint_KD'
      ReadOnly = True
      Size = 50
    end
    object MrsR3_do_number: TStringField
      FieldName = 'R3_do_number'
      ReadOnly = True
      Size = 50
    end
    object Mrsselisih_mrs_sapr3: TFloatField
      FieldName = 'selisih_mrs_sapr3'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object MrsFlag_Selisih: TIntegerField
      FieldName = 'Flag_Selisih'
      ReadOnly = True
      Required = True
    end
