object Inf_AR_Detil_BWFrm: TInf_AR_Detil_BWFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_AR_Detil_BWFrm'
  Color = clBtnFace
    ...
    object TabSheet3: TTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          object cxGridDBTableView1per_tanggal: TcxGridDBColumn
            DataBinding.FieldName = 'per_tanggal'
            Width = 100
          end
          object cxGridDBTableView1tgl_Periode_int: TcxGridDBColumn
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'CURRENCT'
              Column = cxGrid3DBTableView1CURRENCT
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD11SD20'
              Column = cxGrid3DBTableView1OD11SD20
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD1SD10'
              Column = cxGrid3DBTableView1OD1SD10
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD21SD30'
              Column = cxGrid3DBTableView1OD21SD30
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD31SD60'
              Column = cxGrid3DBTableView1OD31SD60
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD61SD90'
              Column = cxGrid3DBTableView1OD61SD90
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'ODDIATAS90'
              Column = cxGrid3DBTableView1ODDIATAS90
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
            ...
            item
              ...
              Kind = skSum
              FieldName = 'TOTAL_OD'
              Column = cxGrid3DBTableView1TOTAL_OD
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          Styles.ContentEven = _DataModule.cxStyle1
          Styles.ContentOdd = _DataModule.cxStyle3
          object cxGrid3DBTableView1per_tanggal: TcxGridDBColumn
            DataBinding.FieldName = 'per_tanggal'
          end
          object cxGrid3DBTableView1tgl_Periode: TcxGridDBColumn
            DataBinding.FieldName = 'tgl_Periode'
          end
          object cxGrid3DBTableView1KODE_DEPO: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1KODE_CUST: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1CURRENCT: TcxGridDBColumn
            DataBinding.FieldName = 'CURRENCT'
          end
          object cxGrid3DBTableView1TOTAL_OD: TcxGridDBColumn
            DataBinding.FieldName = 'TOTAL_OD'
          end
          object cxGrid3DBTableView1OD1SD10: TcxGridDBColumn
            DataBinding.FieldName = 'OD1SD10'
          end
          object cxGrid3DBTableView1OD11SD20: TcxGridDBColumn
            DataBinding.FieldName = 'OD11SD20'
          end
          object cxGrid3DBTableView1OD21SD30: TcxGridDBColumn
            DataBinding.FieldName = 'OD21SD30'
          end
          object cxGrid3DBTableView1OD31SD60: TcxGridDBColumn
            DataBinding.FieldName = 'OD31SD60'
          end
          object cxGrid3DBTableView1OD61SD90: TcxGridDBColumn
            DataBinding.FieldName = 'OD61SD90'
          end
          object cxGrid3DBTableView1ODDIATAS90: TcxGridDBColumn
            DataBinding.FieldName = 'ODDIATAS90'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
        ...
        'SELECT a.*,cast(a.DUE_DATE-a.DOCUMENT_DATE as int) as TerminOfPa' +
        'yment'
      
        '       ,[MARS].[dbo].[F_periode_Indofood_int] (a.per_tanggal) as' +
        ' tgl_Periode_int'
      '  FROM [MARS].[dbo].[temp_ar_all] a '
      'where  a.per_tanggal=:0')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBKODE_DEPO: TStringField
      DisplayLabel = 'SP KD'
      FieldName = 'KODE_DEPO'
      Size = 250
    end
    object Daily_DBDEPO: TStringField
      DisplayLabel = 'Stock Point'
      FieldName = 'DEPO'
      Size = 250
    end
    object Daily_DBKODE_CUST: TStringField
      DisplayLabel = 'CUST KD'
      FieldName = 'KODE_CUST'
      Size = 250
    end
    ...
    object Daily_DBCURRENCT: TFloatField
      DisplayLabel = 'CURRENT'
      FieldName = 'CURRENCT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBTOTAL_OD: TFloatField
      DisplayLabel = 'TOTAL OD'
      FieldName = 'TOTAL_OD'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD1SD10: TFloatField
      DisplayLabel = '1 - 10 DAY'
      FieldName = 'OD1SD10'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD11SD20: TFloatField
      DisplayLabel = '11- 20 DAY'
      FieldName = 'OD11SD20'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD21SD30: TFloatField
      DisplayLabel = '21 - 30 DAY'
      FieldName = 'OD21SD30'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD31SD60: TFloatField
      DisplayLabel = '31 - 60 DAY'
      FieldName = 'OD31SD60'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD61SD90: TFloatField
      DisplayLabel = '61 - 90 DAY'
      FieldName = 'OD61SD90'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBODDIATAS90: TFloatField
      DisplayLabel = '> 90 DAY'
      FieldName = 'ODDIATAS90'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBper_tanggal: TDateTimeField
      DisplayLabel = 'PER TANGGAL'
      FieldName = 'per_tanggal'
    end
    object Daily_DBTerminOfPayment: TIntegerField
      FieldName = 'TerminOfPayment'
      ReadOnly = True
      DisplayFormat = 'TOP'
    end
  ...
  object UniQuery1: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT per_tanggal'
        ...
        '     ,[MARS].[dbo].[F_periode_Indofood_int] (a.per_tanggal) as t' +
        'gl_Periode_int'
      '  FROM [MARS].[dbo].[temp_ar_all] a '
      'where  a.per_tanggal>=:0'
      '  and a.per_tanggal<=:1'
      'group by per_tanggal')
    Left = 571
    Top = 86
    ParamData = <
      item
    ...
    object UniQuery1per_tanggal: TDateTimeField
      FieldName = 'per_tanggal'
    end
    object UniQuery1tgl_Periode_int: TIntegerField
      FieldName = 'tgl_Periode_int'
      ReadOnly = True
    end
  end
