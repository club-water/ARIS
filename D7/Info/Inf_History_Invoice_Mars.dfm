object Inf_History_Invoice_MarsFrm: TInf_History_Invoice_MarsFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_History_Invoice_MarsFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1tgl_Periode_in: TcxGridDBColumn
            DataBinding.FieldName = 'tgl_Periode_in'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select r.* from ('
      'SELECT a.tanggal,a.jenis_transaksi,a.no_doc,a.ref,a.No_Invoice'
      
        '      ,a.debit,a.kredit,a.stockpoint_cd,a.STOCKPOINTNAME,a.Saldo' +
        ',a.kd_customer,a.nama_customer'
        ...
        'Periode_in'
      '  FROM [MARS].[dbo].[VSOA_Mars] a'
      '  where a.tanggal>=:0'
      '    and  a.tanggal<=:1'
      '    and a.jenis_transaksi='#39'Invoice'#39
      '    '
      ' union all'
      ' '
      '   SELECT b.tanggal,b.jenis_transaksi,b.no_doc,b.ref'
      '      ,b.No_Invoice,b.debit,b.kredit,b.stockpoint_cd'
      '      ,b.STOCKPOINTNAME,b.Saldo,b.kd_customer,b.nama_customer'
      
        '      ,[MARS].[dbo].[F_periode_Indofood] (b.Tanggal) as tgl_Peri' +
        'ode'
      
        '      ,[MARS].[dbo].[F_periode_Indofood_int] (b.Tanggal) as tgl_' +
        'Periode_in'
      '  FROM [MARS].[dbo].[VSOA_Mars] b'
      '  where b.jenis_transaksi<>'#39'Invoice'#39
      '    and EXISTS (select *'
      '               from [MARS].[dbo].[VSOA_Mars] c'
      '               where c.tanggal>=:0'
      '                and  c.tanggal<=:1'
      '                and c.jenis_transaksi='#39'Invoice'#39
      '                and c.stockpoint_cd=b.stockpoint_cd'
      '                and c.no_invoice=b.no_invoice'
      '                and c.kd_customer=b.kd_customer  '
      '            )'
      ') r')
    FetchRows = 5000
    Left = 323
    ...
    object Daily_DBno_doc: TStringField
      FieldName = 'no_doc'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBref: TStringField
      FieldName = 'ref'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBNo_Invoice: TStringField
      FieldName = 'No_Invoice'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBdebit: TFloatField
      FieldName = 'debit'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBkredit: TFloatField
      FieldName = 'kredit'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    ...
    object Daily_DBSaldo: TFloatField
      FieldName = 'Saldo'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBtgl_Periode_in: TIntegerField
      FieldName = 'tgl_Periode_in'
      ReadOnly = True
    end
