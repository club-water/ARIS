object Inf_Sales_Detil_marsFrm: TInf_Sales_Detil_marsFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Sales_Detil_marsFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Column = cxGrid3DBTableView1GROSS_AMOUNT
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Disc'
              Column = cxGrid3DBTableView1Disc
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1Kode_Customer: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1tax_code: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1Invoice_nomer: TcxGridDBColumn
            DataBinding.FieldName = 'Invoice_nomer'
            Width = 75
          end
          object cxGrid3DBTableView1Invoice_date: TcxGridDBColumn
            DataBinding.FieldName = 'Invoice_date'
            Width = 67
          end
          object cxGrid3DBTableView1ITEM_CODE: TcxGridDBColumn
            DataBinding.FieldName = 'ITEM_CODE'
            Width = 84
          end
          object cxGrid3DBTableView1ITEM_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'ITEM_NAMA'
            Width = 139
          end
          object cxGrid3DBTableView1QTY: TcxGridDBColumn
            DataBinding.FieldName = 'QTY'
          end
          object cxGrid3DBTableView1GROSS_AMOUNT: TcxGridDBColumn
            DataBinding.FieldName = 'GROSS_AMOUNT'
          end
          object cxGrid3DBTableView1Disc: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT   a.Kode_Customer, a.Nama_Customer, c.adress, c.kota, c.p' +
        'rice_level, c.outlet_type, c.term, c.tax_code, '
      
        '                      CASE c.term WHEN '#39'T00'#39' THEN '#39'Tunai'#39' ELSE '#39 +
        'Kredit'#39' END AS Jenis_Customer, a.Invoice_nomer, '
      
        '           isnull(d.Tanggal,a.Invoice_date) as Invoice_date, a.I' +
        'TEM_CODE, a.ITEM_NAMA, a.QTY, '
      
        '                      a.GROSS_AMOUNT, a.Disc, a.NET, a.SALESPOIN' +
        'TCD, a.kode_branch, b.STOCKPOINTNAME, b.nama_Branch'
      
        '            ,dbo.F_periode_Indofood_int (isnull(d.Tanggal,a.Invo' +
        'ice_date)) as Periode_Indofood'
      'FROM         Sales_Report_oer14 AS a LEFT OUTER JOIN'
      
        '             LIST_STOCKPOINT AS b ON b.kode_branch = a.kode_bran' +
        'ch AND a.SALESPOINTCD = b.SALESPOINTCD LEFT OUTER JOIN'
      
        '             MST_CUSTOMER AS c ON c.stockpoint_code = a.SALESPOI' +
        'NTCD AND c.kode_branch = a.kode_branch AND c.code=a.Kode_Custome' +
        'r left outer join'
      
        '             Sales_Detil_BW_Rev1 d on d.kode_branch=a.kode_branc' +
        'h and d.stockPOint_cd=a.SALESPOINTCD and d.Invoice=a.Invoice_nom' +
        'er '
      
        '                 and d.Cust_Cd=a.Kode_Customer and cast(d.Materi' +
        'al_cd as int)=a.ITEM_CODE '
      'where isnull(d.Tanggal,a.Invoice_date)>=:0'
      '   and isnull(d.Tanggal,a.Invoice_date)<=:1')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBKode_Customer: TStringField
    ...
    object Daily_DBtax_code: TStringField
      FieldName = 'tax_code'
      ReadOnly = True
      Size = 50
    end
    ...
    object Daily_DBInvoice_nomer: TStringField
      FieldName = 'Invoice_nomer'
      Size = 50
    end
    object Daily_DBInvoice_date: TDateTimeField
      FieldName = 'Invoice_date'
    end
    object Daily_DBITEM_CODE: TStringField
      FieldName = 'ITEM_CODE'
      Size = 250
    end
    object Daily_DBITEM_NAMA: TStringField
      FieldName = 'ITEM_NAMA'
      Size = 250
    end
    ...
    object Daily_DBGROSS_AMOUNT: TFloatField
      FieldName = 'GROSS_AMOUNT'
    end
    object Daily_DBDisc: TFloatField
      FieldName = 'Disc'
    end
    object Daily_DBNET: TFloatField
      FieldName = 'NET'
    end
