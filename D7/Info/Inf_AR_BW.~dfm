object Inf_AR_BWFrm: TInf_AR_BWFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_AR_BWFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skMax
              FieldName = 'Apply_NKR'
              Column = cxGrid3DBTableView1Apply_NKR
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'AR_Split'
              Column = cxGrid3DBTableView1AR_Split
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Collection'
              Column = cxGrid3DBTableView1Collection
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Credit_Note'
              Column = cxGrid3DBTableView1Credit_Note
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Current_Debt'
              Column = cxGrid3DBTableView1Current_Debt
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Debit_Note'
              Column = cxGrid3DBTableView1Debit_Note
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Od_1_7'
              Column = cxGrid3DBTableView1Od_1_7
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'OD_31_60'
              Column = cxGrid3DBTableView1OD_31_60
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'OD_61_90'
              Column = cxGrid3DBTableView1OD_61_90
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'OD_8_30'
              Column = cxGrid3DBTableView1OD_8_30
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD_Diatas_90'
              Column = cxGrid3DBTableView1OD_Diatas_90
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Other_Expense'
              Column = cxGrid3DBTableView1Other_Expense
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Retur'
              Column = cxGrid3DBTableView1Retur
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Saldo_Akhir'
              Column = cxGrid3DBTableView1Saldo_Akhir
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'Saldo_Awal'
              Column = cxGrid3DBTableView1Saldo_Awal
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'sales'
              Column = cxGrid3DBTableView1sales
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Sundry'
              Column = cxGrid3DBTableView1Sundry
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Total_Overdue'
              Column = cxGrid3DBTableView1Total_Overdue
            end>
          ...
          object cxGrid3DBTableView1dateasOF: TcxGridDBColumn
            DataBinding.FieldName = 'dateasOF'
            Width = 68
          end
          ...
          object cxGrid3DBTableView1Stockpoint: TcxGridDBColumn
            DataBinding.FieldName = 'Stockpoint'
            Width = 73
          end
          object cxGrid3DBTableView1Customer_KD: TcxGridDBColumn
            DataBinding.FieldName = 'Customer_KD'
            Width = 70
          end
          ...
          object cxGrid3DBTableView1Duedate: TcxGridDBColumn
            DataBinding.FieldName = 'Duedate'
            Width = 46
          end
          object cxGrid3DBTableView1Saldo_Awal: TcxGridDBColumn
            DataBinding.FieldName = 'Saldo_Awal'
            Width = 84
          end
          object cxGrid3DBTableView1sales: TcxGridDBColumn
            DataBinding.FieldName = 'sales'
          end
          object cxGrid3DBTableView1Debit_Note: TcxGridDBColumn
            DataBinding.FieldName = 'Debit_Note'
          end
          object cxGrid3DBTableView1Collection: TcxGridDBColumn
            DataBinding.FieldName = 'Collection'
          end
          object cxGrid3DBTableView1Sundry: TcxGridDBColumn
            DataBinding.FieldName = 'Sundry'
          end
          object cxGrid3DBTableView1Other_Expense: TcxGridDBColumn
            DataBinding.FieldName = 'Other_Expense'
          end
          object cxGrid3DBTableView1Retur: TcxGridDBColumn
            DataBinding.FieldName = 'Retur'
          end
          object cxGrid3DBTableView1Credit_Note: TcxGridDBColumn
            DataBinding.FieldName = 'Credit_Note'
          end
          object cxGrid3DBTableView1Apply_NKR: TcxGridDBColumn
            DataBinding.FieldName = 'Apply_NKR'
          end
          object cxGrid3DBTableView1AR_Split: TcxGridDBColumn
            DataBinding.FieldName = 'AR_Split'
          end
          object cxGrid3DBTableView1Saldo_Akhir: TcxGridDBColumn
            DataBinding.FieldName = 'Saldo_Akhir'
          end
          object cxGrid3DBTableView1Current_Debt: TcxGridDBColumn
            DataBinding.FieldName = 'Current_Debt'
          end
          object cxGrid3DBTableView1Total_Overdue: TcxGridDBColumn
            DataBinding.FieldName = 'Total_Overdue'
          end
          object cxGrid3DBTableView1Persen_Overdue: TcxGridDBColumn
            DataBinding.FieldName = 'Persen_Overdue'
          end
          object cxGrid3DBTableView1Od_1_7: TcxGridDBColumn
            DataBinding.FieldName = 'Od_1_7'
          end
          object cxGrid3DBTableView1OD_8_30: TcxGridDBColumn
            DataBinding.FieldName = 'OD_8_30'
          end
          object cxGrid3DBTableView1OD_31_60: TcxGridDBColumn
            DataBinding.FieldName = 'OD_31_60'
          end
          object cxGrid3DBTableView1OD_61_90: TcxGridDBColumn
            DataBinding.FieldName = 'OD_61_90'
          end
          object cxGrid3DBTableView1OD_Diatas_90: TcxGridDBColumn
            DataBinding.FieldName = 'OD_Diatas_90'
          end
          object cxGrid3DBTableView1Persen_Coll: TcxGridDBColumn
            DataBinding.FieldName = 'Persen_Coll'
          end
          object cxGrid3DBTableView1DSO: TcxGridDBColumn
            DataBinding.FieldName = 'DSO'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT b.STOCKPOINTNAME,a.*'
      '  FROM [MARS].[dbo].[AR_BW] a  LEFT OUTER JOIN'
      
        '        dbo.LIST_STOCKPOINT AS b ON a. Stockpoint_KD = b.SALESPO' +
        'INTCD'
      'where  a.dateasOF=:0')
    Left = 323
    Top = 166
    ...
    object Daily_DBdateasOF: TDateTimeField
      FieldName = 'dateasOF'
      ReadOnly = True
    end
    object Daily_DBStockpoint_KD: TStringField
      FieldName = 'Stockpoint_KD'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBStockpoint: TStringField
      FieldName = 'Stockpoint'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBCustomer_KD: TStringField
      FieldName = 'Customer_KD'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBCustomer_Name: TStringField
    ...
    object Daily_DBDuedate: TDateTimeField
      FieldName = 'Duedate'
      ReadOnly = True
    end
    object Daily_DBSaldo_Awal: TFloatField
      FieldName = 'Saldo_Awal'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBsales: TFloatField
      FieldName = 'sales'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBDebit_Note: TFloatField
      FieldName = 'Debit_Note'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCollection: TFloatField
      FieldName = 'Collection'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSundry: TFloatField
      FieldName = 'Sundry'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOther_Expense: TFloatField
      FieldName = 'Other_Expense'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBRetur: TFloatField
      FieldName = 'Retur'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCredit_Note: TFloatField
      FieldName = 'Credit_Note'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBApply_NKR: TFloatField
      FieldName = 'Apply_NKR'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBAR_Split: TFloatField
      FieldName = 'AR_Split'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSaldo_Akhir: TFloatField
      FieldName = 'Saldo_Akhir'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCurrent_Debt: TFloatField
      FieldName = 'Current_Debt'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBTotal_Overdue: TFloatField
      FieldName = 'Total_Overdue'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBPersen_Overdue: TFloatField
      FieldName = 'Persen_Overdue'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOd_1_7: TFloatField
      FieldName = 'Od_1_7'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD_8_30: TFloatField
      FieldName = 'OD_8_30'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD_31_60: TFloatField
      FieldName = 'OD_31_60'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD_61_90: TFloatField
      FieldName = 'OD_61_90'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD_Diatas_90: TFloatField
      FieldName = 'OD_Diatas_90'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBPersen_Coll: TFloatField
      FieldName = 'Persen_Coll'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBDSO: TFloatField
      FieldName = 'DSO'
      ReadOnly = True
    end
  end
