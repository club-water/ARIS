object Inf_Gr_SAPBWFrm: TInf_Gr_SAPBWFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Gr_SAPBWFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Column = cxGrid3DBTableView1Calc_Selisih
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1Calendar_Day: TcxGridDBColumn
            DataBinding.FieldName = 'Calendar_Day'
          end
          object cxGrid3DBTableView1plantkode: TcxGridDBColumn
            DataBinding.FieldName = 'plantkode'
            Width = 53
          end
          object cxGrid3DBTableView1plantnama: TcxGridDBColumn
            DataBinding.FieldName = 'plantnama'
            Width = 83
          end
          ...
          object cxGrid3DBTableView1pr_qty: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1po_price: TcxGridDBColumn
            DataBinding.FieldName = 'po_price'
            Visible = False
          end
          ...
          object cxGrid3DBTableView1Calc_Selisih: TcxGridDBColumn
            DataBinding.FieldName = 'Calc_Selisih'
            Width = 108
          end
          object cxGrid3DBTableView1gr_price: TcxGridDBColumn
            DataBinding.FieldName = 'gr_price'
            Visible = False
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT *'
      '  FROM [MARS].[dbo].[GR_SAP_bw] a'
      'where  a.Calendar_Day>=:0'
      '  and  a.Calendar_Day<=:1'
      'order by a.Calendar_Day,a.PO_number')
    ...
    object Daily_DBplantkode: TStringField
      FieldName = 'plantkode'
      Size = 50
    end
    object Daily_DBplantnama: TStringField
      FieldName = 'plantnama'
      Size = 250
    end
    ...
    object Daily_DBpr_qty: TFloatField
      FieldName = 'pr_qty'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBpo_price: TFloatField
      FieldName = 'po_price'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBgr_price: TFloatField
      FieldName = 'gr_price'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCalendar_Day: TDateTimeField
      FieldName = 'Calendar_Day'
    end
    object Daily_DBCalc_Selisih: TFloatField
      DisplayLabel = 'Outstanding'
