object Inf_CostingFrm: TInf_CostingFrm
  Left = 171
  Top = 67
  Width = 993
  Height = 575
  Caption = 'Inf_CostingFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'nilai'
              Column = cxGrid3DBTableView1nilai
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1NO_POLISI: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1kode_biaya: TcxGridDBColumn
            DataBinding.FieldName = 'kode_biaya'
            Width = 66
          end
          object cxGrid3DBTableView1nama_biaya: TcxGridDBColumn
            DataBinding.FieldName = 'nama_biaya'
            Width = 209
          end
          object cxGrid3DBTableView1nilai: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    SQL.Strings = (
      'use tb_hris'
      'SELECT a.NO_POLISI,a.NO_TRANSAKSI,a.TGL_TRANSAKSI,'
      '       a.NIK,c.NAMA, c.BAGIAN AS Bagian_Peminta,'
      '       b.kode_biaya,d.keterangan as nama_biaya,b.qty As nilai'
      'FROM         costing_m a LEFT OUTER JOIN'
      
        '             costing_D b ON a.NO_TRANSAKSI = b.NO_TRANSAKSI LEFT' +
        ' OUTER JOIN'
      '             M_KARYAWAN c ON a.NIK = c.NIK LEFT OUTER JOIN'
      
        '             tb_aris.dbo.mst_biaya_pendapatan D ON B.KODE_BIAYA=' +
        'D.KODE'
    ...
    object Daily_DBNO_POLISI: TStringField
      DisplayLabel = 'NO POLISI'
      FieldName = 'NO_POLISI'
      Size = 50
    end
    ...
    object Daily_DBkode_biaya: TStringField
      DisplayLabel = 'KD BIAYA'
      FieldName = 'kode_biaya'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBnama_biaya: TStringField
      DisplayLabel = 'NAMA BIAYA'
      FieldName = 'nama_biaya'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBnilai: TIntegerField
      DisplayLabel = 'NILAI'
      FieldName = 'nilai'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
