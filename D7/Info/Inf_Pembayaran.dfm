object Inf_PembayaranFrm: TInf_PembayaranFrm
  Left = 171
  Top = 67
  Width = 909
  Height = 575
  Caption = 'Inf_PembayaranFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'potongan'
              Column = cxGrid3DBTableView1potongan
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1NO_TRANSAKSI_NOTA: TcxGridDBColumn
            DataBinding.FieldName = 'NO_TRANSAKSI_NOTA'
            Width = 112
          end
          object cxGrid3DBTableView1kd_supplier: TcxGridDBColumn
            DataBinding.FieldName = 'kd_supplier'
            Width = 104
          end
          ...
          object cxGrid3DBTableView1potongan: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    SQL.Strings = (
      'SELECT  a.TGL_TRANSAKSI,a.NO_TRANSAKSI,d.NO_TRANSAKSI_NOTA,'
      
        '        d.kode_outlet AS kd_supplier,b.NAMA as nama_supplier,b.A' +
        'LAMAT_1,d.SALDO,d.TOTAL_PEMBAYARAN,d.potongan,d.keterangan'
      '  FROM pelunasan_M a'
      
        '  left outer join pelunasan_d  d on a.no_transaksi=d.no_transaks' +
        'i  '
      
        '  left outer join MST_SUPPLIER b on d.kode_outlet=b.KODE and a.d' +
        'epo=b.depo'
      
        '  left outer join TB_HRIS.dbo.M_KARYAWAN c on a.kode_penagih=c.N' +
        'IK and a.depo=c.kode'
    ...
    object Daily_DBNO_TRANSAKSI_NOTA: TStringField
      DisplayLabel = 'NO NOTA'
      FieldName = 'NO_TRANSAKSI_NOTA'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBkd_supplier: TStringField
    ...
    object Daily_DBTOTAL_PEMBAYARAN: TFloatField
      DisplayLabel = 'BAYAR TUNAI'
      FieldName = 'TOTAL_PEMBAYARAN'
      ReadOnly = True
    end
    object Daily_DBpotongan: TIntegerField
      DisplayLabel = 'POTONGAN'
      FieldName = 'potongan'
      ReadOnly = True
    end
