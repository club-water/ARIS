object Inf_SOA_Mars_Frm: TInf_SOA_Mars_Frm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_SOA_Mars_Frm'
  Color = clBtnFace
  ...
  object UniQuery1: TUniQuery
    ...
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
        ...
        'SELECT min(a.tanggal) as tanggal_minimum,max(a.tanggal) as tangg' +
        'al_maximum'
      '  FROM [MARS].[dbo].[SOA_Mars] a')
    FetchRows = 5000
    Left = 651
    Top = 182
    object UniQuery1tanggal_minimum: TDateTimeField
      FieldName = 'tanggal_minimum'
      ReadOnly = True
    end
    object UniQuery1tanggal_maximum: TDateTimeField
      FieldName = 'tanggal_maximum'
      ReadOnly = True
    end
  end
end
