object Inf_Stock_SAPFrm: TInf_Stock_SAPFrm
  Left = 232
  Top = 132
  Width = 1036
  Height = 575
  Caption = 'Inf_Stock_SAPFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'SAP_QUANTITY1'
              Column = cxGrid3DBTableView1SAP_QUANTITY1
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1SAP_PLANTCD: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_PLANTCD'
            Width = 99
          end
          object cxGrid3DBTableView1SAP_nama_Branch: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_nama_Branch'
            Width = 124
          end
          ...
          object cxGrid3DBTableView1SAP_TRANSTYPE: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_TRANSTYPE'
            Width = 97
          end
          object cxGrid3DBTableView1SAP_DOCNO: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_DOCNO'
            Width = 88
          end
          object cxGrid3DBTableView1SAP_POSTDATE: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_POSTDATE'
          end
          object cxGrid3DBTableView1SAP_ITEMCD: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_ITEMCD'
            Width = 73
          end
          object cxGrid3DBTableView1SAP_Material_Nama: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_Material_Nama'
            Width = 103
          end
          object cxGrid3DBTableView1SAP_QUANTITY1: TcxGridDBColumn
            DataBinding.FieldName = 'SAP_QUANTITY1'
            Width = 116
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
      'select R.* from '
      '(SELECT a.SAP_PLANTCD,a.SAP_nama_Branch'
      '      ,a.SAP_SALESPOINTCD,a.SAP_STOCKPOINTNAME,a.SAP_TRANSTYPE'
      '      ,a.SAP_DOCNO,a.SAP_POSTDATE,a.SAP_ITEMCD'
      '      ,[SAP_SITETP]'
      '      ,[SAP_SITETP_1]'
      
        '      ,a.SAP_Material_Nama,a.SAP_QUANTITY1*a.sap_pengali as SAP_' +
        'QUANTITY1'
      '  FROM mars.dbo.VYB25A a'
      '  where a.SAP_POSTDATE>=:0'
      '     and a.SAP_POSTDATE<=:1'
      '     --and a.SAP_PLANTCD='#39'J441'#39
      '     --and a.SAP_SALESPOINTCD='#39'25'#39
      '     --and a.SAP_ITEMCD='#39'143015'#39
      'UNION ALL'
      'select f.*'
      
        ',MARS.DBO.F_cari_sap_Stock_1(SALESPOINTCD,PLANTCD,ITEMCD,dateadd' +
        '(day,-1,:0))'
      ' from ('
      'SELECT b.PLANTCD,a.nama_Branch'
      '      ,b.SALESPOINTCD,a.STOCKPOINTNAME,'#39'-'#39' as  unk5'
      
        '      ,'#39'Saldo Awal'#39' as  unk3,dateadd(day,-1,:0) as  unk4,b.ITEMC' +
        'D'
      '      ,c.Material_Nama'
      '      ,'#39'GS'#39' as unk1,'#39'G'#39' as  unk2'
      ' FROM mars.dbo. YB25A_saldo b left outer join'
      
        '     mars.dbo.LIST_STOCKPOINT a on a.SALESPOINTCD=cast(b.SALESPO' +
        'INTCD as int)'
    ...
    object Daily_DBSAP_PLANTCD: TStringField
      FieldName = 'SAP_PLANTCD'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBSAP_nama_Branch: TStringField
      FieldName = 'SAP_nama_Branch'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBSAP_SALESPOINTCD: TIntegerField
    ...
    object Daily_DBSAP_TRANSTYPE: TStringField
      FieldName = 'SAP_TRANSTYPE'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBSAP_DOCNO: TStringField
      FieldName = 'SAP_DOCNO'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBSAP_POSTDATE: TDateTimeField
      FieldName = 'SAP_POSTDATE'
      ReadOnly = True
    end
    object Daily_DBSAP_ITEMCD: TIntegerField
      FieldName = 'SAP_ITEMCD'
      ReadOnly = True
    end
    object Daily_DBSAP_Material_Nama: TStringField
      FieldName = 'SAP_Material_Nama'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBSAP_QUANTITY1: TFloatField
      FieldName = 'SAP_QUANTITY1'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
