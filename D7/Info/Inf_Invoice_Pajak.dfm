object Inf_Invoice_PajakFrm: TInf_Invoice_PajakFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Invoice_PajakFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1stockpoint_Kode: TcxGridDBColumn
            DataBinding.FieldName = 'stockpoint_Kode'
            Width = 105
          end
          ...
          object cxGrid3DBTableView1customer_nama: TcxGridDBColumn
            DataBinding.FieldName = 'customer_nama'
            Width = 353
          end
          ...
          object cxGrid3DBTableView1no_seri_pajak: TcxGridDBColumn
            DataBinding.FieldName = 'no_seri_pajak'
            Width = 71
          end
          object cxGrid3DBTableView1bill_to_nama: TcxGridDBColumn
            DataBinding.FieldName = 'bill_to_nama'
            Width = 186
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      ' from ('
        ...
        'SELECT A.*,cast(stockpoint_cd as int) as stockpoint_Kode,b.STOCK' +
        'POINTNAME,c.bill_to_nama,c.tax_code,b.nama_Branch'
      '      ,isnull(c.jenis_customer,'#39'Kredit'#39') as jenis_customer'
        ...
        'Periode_int'
      '  FROM [MARS].[dbo].[TList_Faktur_Pajak_Mars] a left outer join'
        ...
        'and c.CODE=a.customer_cd and c.kode_branch=a.kode_branch'
      ''
      'where  a.Tanggal>=:0'
      '  and  a.Tanggal<=:1 ) r')
    FetchRows = 5000
    ...
    object Daily_DBnomer: TStringField
      FieldName = 'nomer'
      Size = 50
    end
    ...
    object Daily_DBno_seri_pajak: TStringField
    ...
    object Daily_DBcustomer_nama: TStringField
    ...
    object Daily_DBbill_to_nama: TStringField
    ...
    object Daily_DBstockpoint_Kode: TIntegerField
      FieldName = 'stockpoint_Kode'
    end
