object Inf_Serah_Terima_InvoiceFrm: TInf_Serah_Terima_InvoiceFrm
  Left = 245
  Top = 122
  Width = 1057
  Height = 575
  Caption = 'Inf_Serah_Terima_InvoiceFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'currentdebet'
              Column = cxGrid3DBTableView1currentdebet
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'total_pembayaran'
              Column = cxGrid3DBTableView1total_pembayaran
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'total_pembayaran_2'
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'sisa_AR'
              Column = cxGrid3DBTableView1sisa_AR
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skCount
              FieldName = 'nama'
              Column = cxGrid3DBTableView1nama
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1SP: TcxGridDBColumn
            DataBinding.FieldName = 'SP'
            Options.Editing = False
            Width = 90
          end
          object cxGrid3DBTableView1code: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1Tgl_Upload: TcxGridDBColumn
            Caption = 'Tgl Upload'
            DataBinding.FieldName = 'Tgl_Upload'
            Options.Editing = False
          end
          ...
          object cxGrid3DBTableView1invoice: TcxGridDBColumn
            DataBinding.FieldName = 'invoice'
            Options.Editing = False
            Width = 131
          end
          object cxGrid3DBTableView1reffno: TcxGridDBColumn
            DataBinding.FieldName = 'reffno'
            Options.Editing = False
            Width = 104
          end
          object cxGrid3DBTableView1currentdebet: TcxGridDBColumn
            DataBinding.FieldName = 'currentdebet'
            Options.Editing = False
            Width = 161
          end
          object cxGrid3DBTableView1diterima: TcxGridDBColumn
            Caption = 'Terima Cabang'
          ...
          object cxGrid3DBTableView1total_pembayaran: TcxGridDBColumn
            Caption = 'Total Pembayaran'
            DataBinding.FieldName = 'total_pembayaran'
            Options.Editing = False
            Width = 114
          end
          object cxGrid3DBTableView1sisa_AR: TcxGridDBColumn
            Caption = 'Sisa  AR'
            DataBinding.FieldName = 'sisa_AR'
            Options.Editing = False
            Width = 87
          end
          ...
          object cxGrid3DBTableView1otorisasi_by_nama: TcxGridDBColumn
            Caption = 'Otorisasi by nama'
            DataBinding.FieldName = 'otorisasi_by_nama'
            Options.Editing = False
            Width = 134
          end
          object cxGrid3DBTableView1otorisasi_by_nama_Lengkap: TcxGridDBColumn
            Caption = 'Otorisasi by nama lengkap'
            DataBinding.FieldName = 'otorisasi_by_nama_Lengkap'
            Options.Editing = False
            Width = 170
          end
        end
          ...
          object cxGridDBTableView1: TcxGridDBTableView
            ...
            DataController.Summary.FooterSummaryItems = <
              item
                ...
                Kind = skSum
                FieldName = 'currentdebet'
                Column = cxGridDBTableView1currentdebet
              end
              item
                Format = '#,##0.;(#,##0.)'
                Kind = skSum
                FieldName = 'pembayaran'
                Column = cxGridDBTableView1pembayaran
              end>
            DataController.Summary.SummaryGroups = <>
            ...
            object cxGridDBTableView1no_kuitansi: TcxGridDBColumn
              Caption = 'No Kuitansi'
              DataBinding.FieldName = 'no_kuitansi'
              Options.Editing = False
              Width = 150
            end
            ...
            object cxGridDBTableView1Nama_Kolektor: TcxGridDBColumn
              Caption = 'Nama Kolektor'
              DataBinding.FieldName = 'Nama_Kolektor'
              Options.Editing = False
              Width = 79
            end
            object cxGridDBTableView1keterangan_1: TcxGridDBColumn
              Caption = 'keterangan 1'
              DataBinding.FieldName = 'keterangan_1'
              Options.Editing = False
              Width = 100
            end
            object cxGridDBTableView1currentdebet: TcxGridDBColumn
              Caption = 'Current Debet'
              DataBinding.FieldName = 'currentdebet'
              Options.Editing = False
              Width = 104
            end
  ...
  object Daily_DB: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO dbo.serah_terima_invoice'
      
        '  (code, nama, address, order_date, invoice, reffno, currentdebe' +
        't, SP, diterima, dilunasi, total_pembayaran, Keterangan, duedate' +
        ', Tgl_Upload)'
      'VALUES'
      
        '  (:code, :nama, :address, :order_date, :invoice, :reffno, :curr' +
        'entdebet, :SP, :diterima, :dilunasi, :total_pembayaran, :Keteran' +
        'gan, :duedate, :Tgl_Upload)')
    Connection = _DataModule.UniConnection_Mars
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
      'SELECT a.*,currentdebet-ISNULL(total_pembayaran,0) as sisa_AR'
      '  FROM MARS.dbo.serah_terima_invoice a '
      'where  a.order_date>=:0'
      '  and  a.order_date<=:1')
    RefreshOptions = [roAfterInsert, roAfterUpdate, roBeforeEdit]
    BeforePost = Daily_DBBeforePost
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBcode: TStringField
      FieldName = 'code'
      ReadOnly = True
      Size = 250
    end
    ...
    object Daily_DBaddress: TStringField
      FieldName = 'address'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBorder_date: TDateTimeField
      FieldName = 'order_date'
      ReadOnly = True
    end
    object Daily_DBinvoice: TStringField
      FieldName = 'invoice'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBreffno: TStringField
      FieldName = 'reffno'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBcurrentdebet: TFloatField
      FieldName = 'currentdebet'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSP: TStringField
      FieldName = 'SP'
      ReadOnly = True
      Required = True
      Size = 250
    end
    object Daily_DBditerima: TStringField
      FieldName = 'diterima'
      Size = 50
    end
    object Daily_DBdilunasi: TStringField
      FieldName = 'dilunasi'
      Size = 50
    end
    ...
    object Daily_DBtotal_pembayaran: TFloatField
      FieldName = 'total_pembayaran'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBsisa_AR: TFloatField
      FieldName = 'sisa_AR'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBTgl_Upload: TDateTimeField
      FieldName = 'Tgl_Upload'
      DisplayFormat = 'dd mmm yyyy'
    end
    object Daily_DBotorisasi_by_nama: TStringField
      FieldName = 'otorisasi_by_nama'
      Size = 50
    end
    object Daily_DBotorisasi_by_nama_Lengkap: TStringField
      FieldName = 'otorisasi_by_nama_Lengkap'
      Size = 250
    end
  end
  ...
  object ZBrowse: TUniQuery
    ...
    SQL.Strings = (
      ...
      ''
      '      ,a.no_kuitansi'
      '  FROM MARS.dbo.Daftar_Tagihan_M a left outer join'
      
        '    MARS.dbo.Daftar_Tagihan_d b on a.no_transaksi=b.no_transaksi' +
        ' left outer join'
      '    TB_HRIS.dbo.M_KARYAWAN d on a.nik=d.nik')
    MasterSource = UniDataSource1
    MasterFields = 'SP;invoice'
    DetailFields = 'sp;invoice'
    ...
    object ZBrowseID_TRANSAKSI: TIntegerField
      FieldName = 'ID_TRANSAKSI'
      Required = True
    end
    object ZBrowseKODE: TStringField
      FieldName = 'KODE'
    end
    ...
    object ZBrowseSTATUS: TStringField
      FieldName = 'STATUS'
      Size = 1
    end
    ...
    object ZBrowseNama_Kolektor: TStringField
      FieldName = 'Nama_Kolektor'
      ReadOnly = True
      Size = 100
    end
    object ZBrowsesp: TStringField
      FieldName = 'sp'
      ReadOnly = True
      Size = 255
    end
    object ZBrowseinvoice: TIntegerField
      FieldName = 'invoice'
      ReadOnly = True
    end
    object ZBrowseketerangan_1: TStringField
      FieldName = 'keterangan_1'
      ReadOnly = True
      Size = 250
    end
    object ZBrowsecurrentdebet: TFloatField
      FieldName = 'currentdebet'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object ZBrowsepembayaran: TFloatField
      FieldName = 'pembayaran'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object ZBrowseno_kuitansi: TStringField
