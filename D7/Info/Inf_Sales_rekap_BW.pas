...
type
  TInf_Sales_rekap_BWFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    cxGrid3DBTableView1GROSS_SALES_AMOUNT: TcxGridDBColumn;
    cxGrid3DBTableView1Sales_Return_Qty: TcxGridDBColumn;
    cxGrid3DBTableView1Sales_Return: TcxGridDBColumn;
    cxGrid3DBTableView1Promo_Discount: TcxGridDBColumn;
    cxGrid3DBTableView1Manual_Discount: TcxGridDBColumn;
    cxGrid3DBTableView1Discount_Distributor: TcxGridDBColumn;
    cxGrid3DBTableView1Discount_Principal: TcxGridDBColumn;
    cxGrid3DBTableView1Total_Discount: TcxGridDBColumn;
    cxGrid3DBTableView1CNDN_Disc_Distributor: TcxGridDBColumn;
    cxGrid3DBTableView1CNDN_Disc_Principal: TcxGridDBColumn;
    cxGrid3DBTableView1Grand_TotalDiscount: TcxGridDBColumn;
    cxGrid3DBTableView1NetSales_Qty: TcxGridDBColumn;
    cxGrid3DBTableView1NetSalesAmount: TcxGridDBColumn;
    ...
    Daily_DBQTY: TFloatField;
    Daily_DBGROSS_SALES_AMOUNT: TFloatField;
    Daily_DBSales_Return_Qty: TFloatField;
    Daily_DBSales_Return: TFloatField;
    Daily_DBPromo_Discount: TFloatField;
    Daily_DBManual_Discount: TFloatField;
    Daily_DBDiscount_Distributor: TFloatField;
    Daily_DBDiscount_Principal: TFloatField;
    Daily_DBTotal_Discount: TFloatField;
    Daily_DBCNDN_Disc_Distributor: TFloatField;
    Daily_DBCNDN_Disc_Principal: TFloatField;
    Daily_DBGrand_TotalDiscount: TFloatField;
    Daily_DBNetSales_Qty: TFloatField;
    Daily_DBNetSalesAmount: TFloatField;
    Daily_DBvat: TFloatField;
    Daily_DBar: TFloatField;
    Daily_DBSTOCKPOINTKD: TStringField;
    cxGrid3DBTableView1STOCKPOINTKD: TcxGridDBColumn;
...
var
  Inf_Sales_rekap_BWFrm: TInf_Sales_rekap_BWFrm;
implementation
...
procedure TInf_Sales_rekap_BWFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Sales_rekap_BWFrm := nil;
end;

procedure TInf_Sales_rekap_BWFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin

  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Sales_rekap_BWFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Sales_rekap_BWFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Sales_rekap_BWFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Sales_rekap_BWFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Sales_rekap_BWFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_Sales_rekap_BWFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Sales_rekap_BWFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
