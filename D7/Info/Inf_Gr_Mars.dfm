object Inf_Gr_MarsFrm: TInf_Gr_MarsFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Gr_MarsFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1Receipt_Number: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1nama_stockpoint: TcxGridDBColumn
            DataBinding.FieldName = 'nama_stockpoint'
            Width = 86
          end
          object cxGrid3DBTableView1Receipt_Date: TcxGridDBColumn
            DataBinding.FieldName = 'Receipt_Date'
          end
          object cxGrid3DBTableView1Reference_No: TcxGridDBColumn
            DataBinding.FieldName = 'Reference_No'
          end
          object cxGrid3DBTableView1Reference_Date: TcxGridDBColumn
            DataBinding.FieldName = 'Reference_Date'
          end
          object cxGrid3DBTableView1Vendor: TcxGridDBColumn
            DataBinding.FieldName = 'Vendor'
            Width = 118
          end
          object cxGrid3DBTableView1material_Group: TcxGridDBColumn
            DataBinding.FieldName = 'material_Group'
            Width = 98
          end
          object cxGrid3DBTableView1site: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1Do_Number: TcxGridDBColumn
            DataBinding.FieldName = 'Do_Number'
            Width = 92
          end
          object cxGrid3DBTableView1kd_material: TcxGridDBColumn
            DataBinding.FieldName = 'kd_material'
            Width = 59
          end
          object cxGrid3DBTableView1material: TcxGridDBColumn
            DataBinding.FieldName = 'material'
          end
          object cxGrid3DBTableView1uom: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1qty_Fraction: TcxGridDBColumn
            DataBinding.FieldName = 'qty_Fraction'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
        ...
        'SELECT *,[MARS].[dbo].[F_stockpointname] (stockpointkd) as nama_' +
        'stockpoint, dbo.F_tanggal_po(PO_Number) AS Po_date,'
      '   cast(stockpointkd as int) as stockpoint_CD'
      
        '     ,[MARS].[dbo].[F_periode_Indofood_int] (a.Receipt_Date) as ' +
        'tgl_Periode_int'
      '  FROM [MARS].[dbo].[GR_mars] a'
      'where  a.Receipt_Date>=:0'
      '  and  a.Receipt_Date<=:1'
      'order by a.Receipt_Date,a.PO_number')
    ...
    object Daily_DBReceipt_Number: TStringField
      FieldName = 'Receipt_Number'
      Size = 250
    end
    object Daily_DBReceipt_Date: TDateTimeField
      FieldName = 'Receipt_Date'
    end
    object Daily_DBReference_No: TStringField
      FieldName = 'Reference_No'
      Size = 50
    end
    object Daily_DBReference_Date: TDateTimeField
      FieldName = 'Reference_Date'
    end
    object Daily_DBVendor: TStringField
      FieldName = 'Vendor'
      Size = 250
    end
    object Daily_DBmaterial_Group: TStringField
      FieldName = 'material_Group'
      Size = 250
    end
    object Daily_DBsite: TStringField
      FieldName = 'site'
      Size = 50
    end
    object Daily_DBPo_date: TDateTimeField
      FieldName = 'Po_date'
      ReadOnly = True
    end
    ...
    object Daily_DBDo_Number: TStringField
      FieldName = 'Do_Number'
      Size = 50
    end
    object Daily_DBkd_material: TStringField
    ...
    object Daily_DBuom: TStringField
      FieldName = 'uom'
      Size = 50
    end
    ...
    object Daily_DBqty_Fraction: TFloatField
      FieldName = 'qty_Fraction'
    end
    object Daily_DBnama_stockpoint: TStringField
      FieldName = 'nama_stockpoint'
      ReadOnly = True
      Size = 250
    end
