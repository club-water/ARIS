...
type
  TInf_LHPFrm = class(TForm)
    ...
    Label14: TLabel;
    RichEdit3: TRichEdit;
    Daily_DBNOLHP: TStringField;
    Daily_DBTGLDOCU: TDateTimeField;
    Daily_DBKDSLM: TStringField;
    Daily_DBSALESMAN: TStringField;
    Daily_DBSUBUNIT: TStringField;
    Daily_DBKETSUBUNIT: TStringField;
    Daily_DBKOTA: TStringField;
    Daily_DBKETSATUS: TStringField;
    Daily_DBKDCUST: TStringField;
    Daily_DBCUSTOMER: TStringField;
    Daily_DBALAMAT: TStringField;
    Daily_DBGRP_BY: TStringField;
    Daily_DBTGLDOCUDTL: TDateTimeField;
    Daily_DBNODOKUMEN: TStringField;
    Daily_DBNOTAJUAL: TStringField;
    Daily_DBNILAIDOCU: TFloatField;
    Daily_DBNILJAMINAN: TFloatField;
    Daily_DBBIAYABANK: TFloatField;
    Daily_DBBIAYALAIN: TFloatField;
    Daily_DBLUNASTUNAI: TFloatField;
    Daily_DBLUNASGIRO: TFloatField;
    Daily_DBANTARDOKU: TFloatField;
    Daily_DBTKRFAKTUR: TStringField;
    Daily_DBFLG_KEMBALI: TStringField;
    Daily_DBNOREFERENSI: TStringField;
    cxGrid3DBTableView1NOLHP: TcxGridDBColumn;
    cxGrid3DBTableView1TGLDOCU: TcxGridDBColumn;
    cxGrid3DBTableView1KDSLM: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1KETSATUS: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1GRP_BY: TcxGridDBColumn;
    cxGrid3DBTableView1TGLDOCUDTL: TcxGridDBColumn;
    cxGrid3DBTableView1NODOKUMEN: TcxGridDBColumn;
    cxGrid3DBTableView1NOTAJUAL: TcxGridDBColumn;
    cxGrid3DBTableView1NILAIDOCU: TcxGridDBColumn;
    cxGrid3DBTableView1NILJAMINAN: TcxGridDBColumn;
    cxGrid3DBTableView1BIAYABANK: TcxGridDBColumn;
    cxGrid3DBTableView1BIAYALAIN: TcxGridDBColumn;
    cxGrid3DBTableView1LUNASTUNAI: TcxGridDBColumn;
    cxGrid3DBTableView1LUNASGIRO: TcxGridDBColumn;
    cxGrid3DBTableView1ANTARDOKU: TcxGridDBColumn;
    cxGrid3DBTableView1TKRFAKTUR: TcxGridDBColumn;
    cxGrid3DBTableView1FLG_KEMBALI: TcxGridDBColumn;
    cxGrid3DBTableView1NOREFERENSI: TcxGridDBColumn;
    Daily_DBNilai_Amount: TFloatField;
    cxGrid3DBTableView1KOTA: TcxGridDBColumn;
    cxGrid3DBTableView1Nilai_Amount: TcxGridDBColumn;
    Button2: TButton;
...
var
  Inf_LHPFrm: TInf_LHPFrm;
implementation

uses DataModule;
{$R *.dfm}

procedure TInf_LHPFrm.MenuClick(Sender: TObject);
...
begin
      ...
      FileName:=ExtractFileDir(Application.ExeName)+'\LHP\'+my_text;
...
procedure TInf_LHPFrm.Set_Pop_up_monClick(Sender: TObject);
var FileName,Path :String;
    i :integer;
    NewItem : TMenuItem;
    Vnama :String;
begin
    FileName:=ExtractFileDir(Application.ExeName)+'\LHP';
  try
  MkDir(FileName);
  except
  end;
...
{ Clear PopupItems }
  ...
  PATH:=ExtractFileDir(Application.ExeName)+'\LHP';
...
procedure TInf_LHPFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 FileName:=ExtractFileDir(Application.ExeName)+'\LHP_rekap.mds';
...
procedure TInf_LHPFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  {
 try
   FileName:=ExtractFileDir(Application.ExeName)+'\LHP_rekapGrids.ini';
   cxGrid3DBTableView1.RestoreFromIniFile(FileName,True,False, [gsoUseFilter]);
   except
   end;
...
procedure TInf_LHPFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_LHPFrm.FormShow(Sender: TObject);
begin
...
procedure TInf_LHPFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_LHPFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_LHPFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_LHPFrm.Button2Click(Sender: TObject);
var FileName :String;
begin
try
 FileName:=ExtractFileDir(Application.ExeName)+'\LHP_rekapGrids.ini';
...
procedure TInf_LHPFrm.Button3Click(Sender: TObject);
var FileName :String;
begin
  FileName:=ExtractFileDir(Application.ExeName)+'\LHP';
