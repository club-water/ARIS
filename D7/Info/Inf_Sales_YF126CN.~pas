...
type
  TInf_Sales_YF126CNFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBTax_date: TDateTimeField;
    Daily_DBTax_Number: TStringField;
    Daily_DBNo_Faktur: TStringField;
    Daily_DBCustomer_cd: TStringField;
    Daily_DBCustomer_Name: TStringField;
    Daily_DBAdress1: TStringField;
    Daily_DBNPWP: TStringField;
    ...
    cxGrid3DBTableView1Tax_date: TcxGridDBColumn;
    cxGrid3DBTableView1Tax_Number: TcxGridDBColumn;
    cxGrid3DBTableView1No_Faktur: TcxGridDBColumn;
    cxGrid3DBTableView1Customer_cd: TcxGridDBColumn;
    cxGrid3DBTableView1Customer_Name: TcxGridDBColumn;
    cxGrid3DBTableView1Adress1: TcxGridDBColumn;
    cxGrid3DBTableView1NPWP: TcxGridDBColumn;
...
var
  Inf_Sales_YF126CNFrm: TInf_Sales_YF126CNFrm;
implementation
...
procedure TInf_Sales_YF126CNFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Sales_YF126CNFrm := nil;
end;

procedure TInf_Sales_YF126CNFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Sales_YF126CNFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Sales_YF126CNFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Sales_YF126CNFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Sales_YF126CNFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Sales_YF126CNFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Sales_YF126CNFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Sales_YF126CNFrm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Sales_YF126CNFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Sales_YF126CNFrm.DataRaw1Click(Sender: TObject);
begin
