object Inf_Sales_YF126CNFrm: TInf_Sales_YF126CNFrm
  Left = 335
  Top = 112
  Width = 798
  Height = 558
  Caption = 'Inf_Sales_YF126CNFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1Tax_date: TcxGridDBColumn
            DataBinding.FieldName = 'Tax_date'
          end
          object cxGrid3DBTableView1Tax_Number: TcxGridDBColumn
            DataBinding.FieldName = 'Tax_Number'
            Width = 111
          end
          object cxGrid3DBTableView1No_Faktur: TcxGridDBColumn
            DataBinding.FieldName = 'No_Faktur'
            Width = 55
          end
          object cxGrid3DBTableView1Customer_cd: TcxGridDBColumn
            DataBinding.FieldName = 'Customer_cd'
            Width = 84
          end
          ...
          object cxGrid3DBTableView1Adress1: TcxGridDBColumn
            DataBinding.FieldName = 'Adress1'
            Width = 213
          end
          object cxGrid3DBTableView1NPWP: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
        ...
        'SELECT      a.Stockpoint_cd, b.STOCKPOINTNAME, a.Tax_date, a.Tax' +
        '_Number, a.No_Faktur, a.Customer_cd, a.Customer_Name, a.Adress1,' +
        ' a.NPWP, a.DPP, a.PPN, '
      
        '                  a.Kode_Branch, b.nama_Branch,a.dpp+a.ppn as to' +
        'tal,'
      
        '                 dbo.F_periode_Indofood_int ( a.Tax_date) as Per' +
        'iode_Indofood'
      'FROM         sap_Sales_YF126cn AS a LEFT OUTER JOIN'
      
        '                      LIST_STOCKPOINT AS b ON a.Stockpoint_cd = ' +
        'b.SALESPOINTCD AND a.Kode_Branch = b.kode_branch'
      'where  a.Tax_date>=:0'
      '  and  a.Tax_date<=:1')
    Left = 323
    Top = 166
    ...
    object Daily_DBTax_date: TDateTimeField
      FieldName = 'Tax_date'
    end
    object Daily_DBTax_Number: TStringField
      FieldName = 'Tax_Number'
      Size = 250
    end
    object Daily_DBNo_Faktur: TStringField
      FieldName = 'No_Faktur'
      Size = 50
    end
    object Daily_DBCustomer_cd: TStringField
    ...
    object Daily_DBAdress1: TStringField
      FieldName = 'Adress1'
      Size = 250
    end
    object Daily_DBNPWP: TStringField
      FieldName = 'NPWP'
      Size = 50
    end
