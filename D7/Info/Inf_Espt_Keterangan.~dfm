object Inf_Espt_KeteranganFrm: TInf_Espt_KeteranganFrm
  Left = 375
  Top = 99
  Width = 798
  Height = 558
  Caption = 'Inf_Espt_KeteranganFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1no_Tax_Document: TcxGridDBColumn
            DataBinding.FieldName = 'no_Tax_Document'
            Width = 204
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT a.* ,b.nama_Branch '
      '  FROM [MARS].[dbo].[Espt_Keterangan] a left outer join'
      '  mars.dbo.LIST_STOCKPOINT b on b.kode_branch=a.kode_branch'
      'where  a.tax_date>=:0'
      '  and  a.tax_date<=:1')
    Left = 323
    Top = 166
    ...
    object Daily_DBno_Tax_Document: TStringField
