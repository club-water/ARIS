object Comp_AR_detil_mars_vs_BW_FRM: TComp_AR_detil_mars_vs_BW_FRM
  Left = 166
  Top = 48
  Width = 1130
  Height = 610
  Caption = 'Comp_AR_detil_mars_vs_BW_FRM'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1bw_Customer_KD: TcxGridDBColumn
            DataBinding.FieldName = 'bw_Customer_KD'
            Width = 90
          end
          object cxGrid3DBTableView1bw_Customer_Name: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1bw_DOCUMENT_DATE: TcxGridDBColumn
            DataBinding.FieldName = 'bw_DOCUMENT_DATE'
            Width = 137
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select t.* , case WHEN ABS(selisih_mrs_sapr3) <> 0 or  mrs_STOCK' +
        'POINTNAME is null THEN 1 '
      ...
      '      '
        ...
        '      ,abs(isnull(a.mrs_nilai,0)-isnull(d.bw_nilai,0)) as selisi' +
        'h_mrs_sapr3'
      '   '
      '  FROM [MARS].[dbo].[var_mars] a  Full  join'
      
        '  mars.dbo.VAr_BW_Detil_Invoice D ON D.bw_SALESPOINTCD=a.mrs_SAL' +
        'ESPOINTCD'
      '          and a.mrs_kode_branch=d.bw_kode_branch'
      '           and d.bw_Invoice_Number=a.mrs_invoice '
      '           and a.mrs_customer_Kode=d.bw_Customer_KD'
      '           '
      '  where isnull(a.mrs_TGL,d.bw_TGL)=:0'
      '  '
      '     '
      ' ) T'
    ...
    object Daily_DBmrs_order_date: TDateTimeField
      FieldName = 'mrs_order_date'
    end
    object Daily_DBbw_SALESPOINTCD: TIntegerField
    ...
    object Daily_DBbw_Customer_KD: TStringField
      FieldName = 'bw_Customer_KD'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBbw_Customer_Name: TStringField
    ...
    object Daily_DBbw_DOCUMENT_DATE: TDateTimeField
      FieldName = 'bw_DOCUMENT_DATE'
      ReadOnly = True
    end
  ...
  object UniQuery2: TUniQuery
    ...
    SQL.Strings = (
      ...
      ''
      'EXEC'#9'@return_value = [dbo].[cek_Selisih_AR_SOA] :0')
    Left = 427
    Top = 166
    ParamData = <
      item
