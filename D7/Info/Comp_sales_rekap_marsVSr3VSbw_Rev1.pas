unit Comp_sales_rekap_marsVSr3VSbw_Rev1;
...
type
  TComp_sales_rekap_marsVSr3VSbw_Rev1FRM = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBMRS_nama_Branch: TWideStringField;
    Daily_DBBw_nama_Branch: TWideStringField;
    Daily_DBR3_nama_Branch: TWideStringField;
    ...
    MrsMRS_nama_Branch: TWideStringField;
    ...
    SAPR3R3_Nama_Branch: TWideStringField;
...
var
  Comp_sales_rekap_marsVSr3VSbw_Rev1FRM: TComp_sales_rekap_marsVSr3VSbw_Rev1FRM;
implementation
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
  Comp_sales_rekap_marsVSr3VSbw_Rev1FRM := nil;
end;

procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.BitBtn1Click(Sender: TObject);
var AIndex: integer;
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.RadioButton1Click(
  Sender: TObject);
begin
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.RadioButton2Click(
  Sender: TObject);
begin
  cxGrid1.Visible:=True;
  cxGrid1.Align:=alLeft;
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.RadioButton3Click(
  Sender: TObject);
begin
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.Button2Click(Sender: TObject);
begin
  cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.Grid1Click(Sender: TObject);
begin
...
procedure TComp_sales_rekap_marsVSr3VSbw_Rev1FRM.DataRaw1Click(Sender: TObject);
begin
