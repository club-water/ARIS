object Inf_Olap_SalesFrm: TInf_Olap_SalesFrm
  Left = 109
  Top = 105
  Width = 909
  Height = 608
  Caption = 'Inf_Olap_SalesFrm'
  Color = clBtnFace
  ...
  object Filter: TPageControl
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'GROSS'
              Column = cxGrid3DBTableView1GROSS
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1JENIS_NOTA: TcxGridDBColumn
            DataBinding.FieldName = 'JENIS_NOTA'
            Width = 147
          end
          ...
          object cxGrid3DBTableView1KODE_SALES: TcxGridDBColumn
            DataBinding.FieldName = 'KODE_SALES'
            Width = 82
          end
          object cxGrid3DBTableView1nama_salesman: TcxGridDBColumn
            DataBinding.FieldName = 'nama_salesman'
            Width = 115
          end
          object cxGrid3DBTableView1jenis_bayar: TcxGridDBColumn
            DataBinding.FieldName = 'jenis_bayar'
            Width = 98
          end
          ...
          object cxGrid3DBTableView1qty_kirim: TcxGridDBColumn
            DataBinding.FieldName = 'qty_kirim'
          end
          object cxGrid3DBTableView1qty_kembali: TcxGridDBColumn
            DataBinding.FieldName = 'qty_kembali'
            Width = 88
          end
          object cxGrid3DBTableView1no_transaksi_lama: TcxGridDBColumn
            DataBinding.FieldName = 'no_transaksi_lama'
          end
          object cxGrid3DBTableView1wilayah: TcxGridDBColumn
            DataBinding.FieldName = 'wilayah'
          end
          object cxGrid3DBTableView1kategori: TcxGridDBColumn
    ...
    object TabSheet4: TTabSheet
      Caption = 'Option'
      ImageIndex = 3
      object fcGridOptionsPanel1: TfcGridOptionsPanel
        Left = 16
        Top = 8
        Width = 1073
        Height = 161
      ...
      object fcSliceOptionsPanel1: TfcSliceOptionsPanel
        Left = 16
        Top = 176
        Width = 1073
        Height = 137
  ...
  object Daily_DB: TUniQuery
    SQL.Strings = (
      'select *'
      'from [View_Sales] b'
      'where Tgl_Transaksi>=:0'
      '  and Tgl_Transaksi<=:1'
      'order by CAST(ID_TRANSAKSI AS int)')
    Left = 491
    Top = 182
    ParamData = <
      item
    ...
    object Daily_DBJENIS_NOTA: TStringField
      DisplayLabel = 'JENIS NOTA'
      FieldName = 'JENIS_NOTA'
      Required = True
      Size = 50
    end
    ...
    object Daily_DBKODE_SALES: TStringField
      DisplayLabel = 'KODE SALESMAN'
    ...
    object Daily_DBjenis_bayar: TStringField
      DisplayLabel = 'JENIS BAYAR'
    ...
    object Daily_DBGROSS: TFloatField
      DisplayLabel = 'TOTAL'
      FieldName = 'GROSS'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBqty_kirim: TIntegerField
      DisplayLabel = 'QTY KIRIM'
      FieldName = 'qty_kirim'
      ReadOnly = True
    end
    object Daily_DBqty_kembali: TIntegerField
      DisplayLabel = 'QTY KEMBALI'
      FieldName = 'qty_kembali'
      ReadOnly = True
    end
    object Daily_DBno_transaksi_lama: TStringField
      DisplayLabel = 'NO TRANSAKSI LAMA'
      FieldName = 'no_transaksi_lama'
      ReadOnly = True
      Size = 50
    end
    ...
    object Daily_DBALAMAT_1: TStringField
      DisplayLabel = 'ALAMAT 1'
      FieldName = 'ALAMAT_1'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBwilayah: TStringField
      DisplayLabel = 'WILAYAH'
      FieldName = 'wilayah'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBkategori: TStringField
    ...
    object Daily_DBnama_salesman: TStringField
      DisplayLabel = 'NAMA SALESMAN'
