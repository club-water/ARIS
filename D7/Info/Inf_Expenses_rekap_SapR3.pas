...
type
  TInf_Expenses_rekap_SapR3Frm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBAssignment: TStringField;
    Daily_DBDocument_Date: TDateTimeField;
    Daily_DBPosting_Date: TDateTimeField;
    Daily_DBDocument_Number: TStringField;
    Daily_DBAmount: TFloatField;
    Daily_DBKeterangan: TStringField;
    Daily_DBUserName: TStringField;
    Daily_DBCostCenter: TStringField;
    Daily_DBAccountcode: TStringField;
    Daily_DBKode: TIntegerField;
    Daily_DBSTOCKPOINTNAME: TStringField;
    cxGrid3DBTableView1Assignment: TcxGridDBColumn;
    cxGrid3DBTableView1Document_Date: TcxGridDBColumn;
    cxGrid3DBTableView1Posting_Date: TcxGridDBColumn;
    cxGrid3DBTableView1Document_Number: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1CostCenter: TcxGridDBColumn;
    cxGrid3DBTableView1Accountcode: TcxGridDBColumn;
...
var
  Inf_Expenses_rekap_SapR3Frm: TInf_Expenses_rekap_SapR3Frm;
implementation
...
procedure TInf_Expenses_rekap_SapR3Frm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Expenses_rekap_SapR3Frm := nil;
end;

procedure TInf_Expenses_rekap_SapR3Frm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
  cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Expenses_rekap_SapR3Frm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Expenses_rekap_SapR3Frm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Expenses_rekap_SapR3Frm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Expenses_rekap_SapR3Frm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Expenses_rekap_SapR3Frm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Expenses_rekap_SapR3Frm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Expenses_rekap_SapR3Frm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Expenses_rekap_SapR3Frm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Expenses_rekap_SapR3Frm.DataRaw1Click(Sender: TObject);
begin
