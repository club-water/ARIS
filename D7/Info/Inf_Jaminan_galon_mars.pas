...
type
  TInf_Jaminan_galon_marsFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBKONVERSI: TFloatField;
    Daily_DBqty_quota: TFloatField;
    Daily_DBqty_beginning: TFloatField;
    Daily_DBqty_receipt: TFloatField;
    Daily_DBqty_issue: TFloatField;
    Daily_DBqty_ending: TFloatField;
    ...
    cxGrid3DBTableView1KONVERSI: TcxGridDBColumn;
    cxGrid3DBTableView1qty_quota: TcxGridDBColumn;
    cxGrid3DBTableView1qty_beginning: TcxGridDBColumn;
    cxGrid3DBTableView1qty_receipt: TcxGridDBColumn;
    cxGrid3DBTableView1qty_issue: TcxGridDBColumn;
    cxGrid3DBTableView1qty_ending: TcxGridDBColumn;
    Daily_DBPeriode: TIntegerField;
    Button8: TButton;
...
var
  Inf_Jaminan_galon_marsFrm: TInf_Jaminan_galon_marsFrm;
implementation
...
procedure TInf_Jaminan_galon_marsFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Jaminan_galon_marsFrm := nil;
end;

procedure TInf_Jaminan_galon_marsFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Jaminan_galon_marsFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Jaminan_galon_marsFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Jaminan_galon_marsFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Jaminan_galon_marsFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Jaminan_galon_marsFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Jaminan_galon_marsFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Jaminan_galon_marsFrm.Button8Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Jaminan_galon_marsFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Jaminan_galon_marsFrm.DataRaw1Click(Sender: TObject);
begin
