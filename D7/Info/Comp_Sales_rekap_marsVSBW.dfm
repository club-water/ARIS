object Comp_Sales_rekap_marsVSBWFrm: TComp_Sales_rekap_marsVSBWFrm
  Left = 278
  Top = 98
  Width = 909
  Height = 575
  Caption = 'Comp_Sales_rekap_marsVSBWFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1MRS_PLANTCD: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_PLANTCD'
          ...
          object cxGrid3DBTableView1MRS_SLSGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_SLSGROSSAMT'
            Styles.Content = _DataModule.cxStyle9
            Width = 81
          end
          ...
          object cxGrid3DBTableView1MRS_NETVAT: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_NETVAT'
            Styles.Content = _DataModule.cxStyle9
            Width = 77
          end
          object cxGrid3DBTableView1MRS_AR: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_AR'
            Styles.Content = _DataModule.cxStyle9
            Width = 81
          end
          ...
          object cxGrid3DBTableView1BW_GROSS_SALES_AMOUNT: TcxGridDBColumn
            DataBinding.FieldName = 'BW_GROSS_SALES_AMOUNT'
            Width = 124
          end
          ...
          object cxGrid3DBTableView1BW_AR: TcxGridDBColumn
            DataBinding.FieldName = 'BW_AR'
            Width = 107
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'select t.* , case  WHEN selisih_net > 1 THEN 1 '
      '         ELSE 0 end as Flag_Selisih '
      ' from ('
      'SELECT a.PLANTCD as MRS_PLANTCD'
      '      ,a.SALESPOINTCD as MRS_SALESPOINTCD'
      '      ,a.STOCKPOINTNAME as MRS_STOCKPOINTNAME'
      '      ,a.TGL as MRS_TGL'
      '      ,a.SLSGROSSAMT as MRS_SLSGROSSAMT'
      '      ,a.NETGROSSAMT as MRS_NETGROSSAMT'
      '      ,a.NETVAT as MRS_NETVAT'
      '      ,a.NETTOTAL as  MRS_AR'
      '      ,c.STOCKPOINTNAME as BW_STOCKPOINTNAME'
      '      ,c.TGL as BW_TGL'
      '      ,c.GROSS_SALES_AMOUNT as BW_GROSS_SALES_AMOUNT'
      '      ,c.NetSalesAmount as BW_NetSalesAmount'
      '      ,c.ar as  BW_AR'
      
        '      ,ISNULL(abs(a.NETGROSSAMT-c.NetSalesAmount),100) as selisi' +
        'h_net'
      '      '
      '  FROM [MARS].[dbo].[VSales_rf] a  Full  join'
      
        '  mars.dbo.Sales_detil_BW c on a.STOCKPOINTNAME=c.STOCKPOINTNAME' +
        ' and a.TGL=c.TGL'
      '  where isnull(a.tgl,c.tgl)>=:0'
      '     and isnull(a.tgl,c.tgl)<=:1 ) T'
      '  order by isnull(T.MRS_tgl,t.BW_tgl)')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBMRS_PLANTCD: TStringField
    ...
    object Daily_DBMRS_SLSGROSSAMT: TFloatField
      FieldName = 'MRS_SLSGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBMRS_NETVAT: TFloatField
      FieldName = 'MRS_NETVAT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBMRS_AR: TFloatField
      FieldName = 'MRS_AR'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBBW_GROSS_SALES_AMOUNT: TFloatField
      FieldName = 'BW_GROSS_SALES_AMOUNT'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBBW_AR: TFloatField
      FieldName = 'BW_AR'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBselisih_net: TFloatField
      FieldName = 'selisih_net'
      ReadOnly = True
      Required = True
    end
