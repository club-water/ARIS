object Inf_Stock_mars_SummaryFrm: TInf_Stock_mars_SummaryFrm
  Left = 0
  Top = 153
  Width = 1024
  Height = 575
  Caption = 'Inf_Stock_mars_SummaryFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_Qty_in'
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_Qty_out'
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1uom_1: TcxGridDBColumn
            DataBinding.FieldName = 'uom_1'
            Width = 46
          end
          object cxGrid3DBTableView1uom_2: TcxGridDBColumn
            DataBinding.FieldName = 'uom_2'
            Width = 58
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
        ...
        'select  dbo.F_cari_Mars_Stock(a.stockPOint_cd,a.kode_branch,a.Ma' +
        'terial_cd,:0) as Saldo,'
      'a.stockPOint_cd,b.STOCKPOINTNAME,'
    ...
    object Daily_DBuom_1: TStringField
      FieldName = 'uom_1'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBuom_2: TStringField
      FieldName = 'uom_2'
      ReadOnly = True
      Size = 50
    end
