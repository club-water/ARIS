object Inf_S_Alr_Frm: TInf_S_Alr_Frm
  Left = 248
  Top = 99
  Width = 798
  Height = 558
  Caption = 'Inf_S_Alr_Frm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'ACT_COSTS'
              Column = cxGrid3DBTableView1ACT_COSTS
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'ACTUAL_QTY'
              Column = cxGrid3DBTableView1ACTUAL_QTY
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'PLAN_QTY'
              Column = cxGrid3DBTableView1PLAN_QTY
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'PLANT_COSTS'
              Column = cxGrid3DBTableView1PLANT_COSTS
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'VAR_ABS_1'
              Column = cxGrid3DBTableView1VAR_ABS_1
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'VAR_ABS_2'
              Column = cxGrid3DBTableView1VAR_ABS_2
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'VAR_PERSEN_1'
              Column = cxGrid3DBTableView1VAR_PERSEN_1
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'VAR_PERSEN_2'
              Column = cxGrid3DBTableView1VAR_PERSEN_2
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1COST_ELEMENT_CODE_1: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_CODE_1'
            Width = 140
          end
          object cxGrid3DBTableView1COST_ELEMENT_TEXT_1: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_TEXT_1'
            Width = 137
          end
          object cxGrid3DBTableView1ACT_COSTS: TcxGridDBColumn
            DataBinding.FieldName = 'ACT_COSTS'
            Width = 105
          end
          object cxGrid3DBTableView1PLANT_COSTS: TcxGridDBColumn
            DataBinding.FieldName = 'PLANT_COSTS'
            Width = 113
          end
          object cxGrid3DBTableView1VAR_ABS_1: TcxGridDBColumn
            DataBinding.FieldName = 'VAR_ABS_1'
          end
          object cxGrid3DBTableView1VAR_PERSEN_1: TcxGridDBColumn
            DataBinding.FieldName = 'VAR_PERSEN_1'
          end
          object cxGrid3DBTableView1COST_ELEMENT_CODE_2: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_CODE_2'
            Width = 139
          end
          object cxGrid3DBTableView1COST_ELEMENT_TEXT_2: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_TEXT_2'
            Width = 137
          end
          object cxGrid3DBTableView1ACTUAL_QTY: TcxGridDBColumn
            DataBinding.FieldName = 'ACTUAL_QTY'
          end
          object cxGrid3DBTableView1PLAN_QTY: TcxGridDBColumn
            DataBinding.FieldName = 'PLAN_QTY'
          end
          object cxGrid3DBTableView1VAR_ABS_2: TcxGridDBColumn
            DataBinding.FieldName = 'VAR_ABS_2'
          end
          object cxGrid3DBTableView1VAR_PERSEN_2: TcxGridDBColumn
            DataBinding.FieldName = 'VAR_PERSEN_2'
          end
          object cxGrid3DBTableView1plant_code: TcxGridDBColumn
            DataBinding.FieldName = 'plant_code'
            Width = 58
          end
          object cxGrid3DBTableView1Plant_Name: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1TGL_AWAL: TcxGridDBColumn
            DataBinding.FieldName = 'TGL_AWAL'
          end
          object cxGrid3DBTableView1TGL_AKHIR: TcxGridDBColumn
            DataBinding.FieldName = 'TGL_AKHIR'
          end
          object cxGrid3DBTableView1COST_ELEMENT_1: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_1'
          end
          object cxGrid3DBTableView1COST_ELEMENT_2: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ELEMENT_2'
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      '/****** Script for SelectTopNRows command from SSMS  ******/'
        ...
        'SELECT a.COST_ELEMENT_CODE_1, a.COST_ELEMENT_TEXT_1, a.ACT_COSTS' +
        ', a.PLANT_COSTS, a.VAR_ABS_1, a.VAR_PERSEN_1, a.COST_ELEMENT_COD' +
        'E_2, '
      
        '                      a.COST_ELEMENT_TEXT_2, a.ACTUAL_QTY, a.PLA' +
        'N_QTY, a.VAR_ABS_2, a.VAR_PERSEN_2, a.plant_code, '
      
        '   a.plant_nama as Jenis, a.periode_indofood, a.TGL_AWAL, a.TGL_' +
        'AKHIR, '
      
        '                      a.COST_ELEMENT_1, a.COST_ELEMENT_2, a.kete' +
        'rangan,'
      ''
      '   b.Plant_Name'
      '  FROM [ho].[dbo].[S_ALR] a left outer join '
      '    ho.dbo.list_plant b on b.PLant_Code=a.plant_code'
      'where  a.TGL_AWAL>=:0'
      '  and  a.TGL_AWAL<=:1')
    FetchRows = 5000
    Left = 323
    ...
    object Daily_DBCOST_ELEMENT_CODE_1: TStringField
      FieldName = 'COST_ELEMENT_CODE_1'
      Size = 50
    end
    object Daily_DBCOST_ELEMENT_TEXT_1: TStringField
      FieldName = 'COST_ELEMENT_TEXT_1'
      Size = 250
    end
    object Daily_DBACT_COSTS: TFloatField
      FieldName = 'ACT_COSTS'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBPLANT_COSTS: TFloatField
      FieldName = 'PLANT_COSTS'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBVAR_ABS_1: TFloatField
      FieldName = 'VAR_ABS_1'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBVAR_PERSEN_1: TFloatField
      FieldName = 'VAR_PERSEN_1'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBCOST_ELEMENT_CODE_2: TStringField
      FieldName = 'COST_ELEMENT_CODE_2'
      Size = 50
    end
    object Daily_DBCOST_ELEMENT_TEXT_2: TStringField
      FieldName = 'COST_ELEMENT_TEXT_2'
      Size = 250
    end
    object Daily_DBACTUAL_QTY: TFloatField
      FieldName = 'ACTUAL_QTY'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBPLAN_QTY: TFloatField
      FieldName = 'PLAN_QTY'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBVAR_ABS_2: TFloatField
      FieldName = 'VAR_ABS_2'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBVAR_PERSEN_2: TFloatField
      FieldName = 'VAR_PERSEN_2'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Daily_DBplant_code: TStringField
    ...
    object Daily_DBTGL_AWAL: TDateTimeField
      FieldName = 'TGL_AWAL'
    end
    object Daily_DBTGL_AKHIR: TDateTimeField
      FieldName = 'TGL_AKHIR'
    end
    object Daily_DBCOST_ELEMENT_1: TStringField
      FieldName = 'COST_ELEMENT_1'
      Size = 250
    end
    object Daily_DBCOST_ELEMENT_2: TStringField
    ...
    object Daily_DBPlant_Name: TStringField
