object Inf_Gr_SAPR3Frm: TInf_Gr_SAPR3Frm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Gr_SAPR3Frm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'Gr_Qty'
              Column = cxGrid3DBTableView1Gr_Qty
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skMax
              FieldName = 'Po_QTy'
              Column = cxGrid3DBTableView1Po_QTy
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1Delivery_Date: TcxGridDBColumn
            DataBinding.FieldName = 'Delivery_Date'
            Width = 89
          end
          object cxGrid3DBTableView1Delv_Completed: TcxGridDBColumn
            DataBinding.FieldName = 'Delv_Completed'
            Width = 83
          end
          object cxGrid3DBTableView1Gr_Document: TcxGridDBColumn
            DataBinding.FieldName = 'Gr_Document'
            Width = 71
          end
          object cxGrid3DBTableView1GR_Date: TcxGridDBColumn
            DataBinding.FieldName = 'GR_Date'
            Width = 58
          end
          ...
          object cxGrid3DBTableView1Po_QTy: TcxGridDBColumn
            DataBinding.FieldName = 'Po_QTy'
            Width = 65
          end
          object cxGrid3DBTableView1Gr_Qty: TcxGridDBColumn
            DataBinding.FieldName = 'Gr_Qty'
            Width = 65
          end
          object cxGrid3DBTableView1Outstanding_PO: TcxGridDBColumn
            DataBinding.FieldName = 'Outstanding_PO'
            Width = 102
          end
          object cxGrid3DBTableView1Item_Text: TcxGridDBColumn
            DataBinding.FieldName = 'Item_Text'
            Width = 814
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT *'
      '  FROM [MARS].[dbo].[GR_SAP_R3] a'
      'where  a.Delivery_Date>=:0'
      '  and  a.Delivery_Date<=:1'
      'order by a.Po_date,a.PO_number')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBDelivery_Date: TDateTimeField
      FieldName = 'Delivery_Date'
    end
    object Daily_DBDelv_Completed: TStringField
      FieldName = 'Delv_Completed'
      Size = 50
    end
    object Daily_DBGr_Document: TStringField
      FieldName = 'Gr_Document'
      Size = 250
    end
    object Daily_DBGR_Date: TDateTimeField
      FieldName = 'GR_Date'
    end
    object Daily_DBDescription: TStringField
      FieldName = 'Description'
      Size = 250
    end
    object Daily_DBPo_QTy: TFloatField
      FieldName = 'Po_QTy'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBGr_Qty: TFloatField
      FieldName = 'Gr_Qty'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOutstanding_PO: TFloatField
      FieldName = 'Outstanding_PO'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBItem_Text: TStringField
      FieldName = 'Item_Text'
      Size = 250
    end
