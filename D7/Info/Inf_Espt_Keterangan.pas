...
type
  TInf_Espt_KeteranganFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBno_Tax_Document: TStringField;
    Daily_DBKeterangan: TStringField;
    Daily_DBtax_date: TDateTimeField;
    cxGrid3DBTableView1no_Tax_Document: TcxGridDBColumn;
...
var
  Inf_Espt_KeteranganFrm: TInf_Espt_KeteranganFrm;
implementation
...
procedure TInf_Espt_KeteranganFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Espt_KeteranganFrm := nil;
end;

procedure TInf_Espt_KeteranganFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Espt_KeteranganFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Espt_KeteranganFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Espt_KeteranganFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Espt_KeteranganFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Espt_KeteranganFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Espt_KeteranganFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Espt_KeteranganFrm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Espt_KeteranganFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Espt_KeteranganFrm.DataRaw1Click(Sender: TObject);
begin
