object Inf_Jaminan_galon_marsFrm: TInf_Jaminan_galon_marsFrm
  Left = 194
  Top = 96
  Width = 909
  Height = 575
  Caption = 'Inf_Jaminan_galon_marsFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Column = cxGrid3DBTableView1qty_beginning
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'qty_ending'
              Column = cxGrid3DBTableView1qty_ending
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'qty_issue'
              Column = cxGrid3DBTableView1qty_issue
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'qty_quota'
              Column = cxGrid3DBTableView1qty_quota
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'qty_receipt'
              Column = cxGrid3DBTableView1qty_receipt
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1KONVERSI: TcxGridDBColumn
            DataBinding.FieldName = 'KONVERSI'
          end
          object cxGrid3DBTableView1qty_quota: TcxGridDBColumn
            DataBinding.FieldName = 'qty_quota'
          end
          object cxGrid3DBTableView1qty_beginning: TcxGridDBColumn
            DataBinding.FieldName = 'qty_beginning'
          end
          object cxGrid3DBTableView1qty_receipt: TcxGridDBColumn
            DataBinding.FieldName = 'qty_receipt'
          end
          object cxGrid3DBTableView1qty_issue: TcxGridDBColumn
            DataBinding.FieldName = 'qty_issue'
          end
          object cxGrid3DBTableView1qty_ending: TcxGridDBColumn
            DataBinding.FieldName = 'qty_ending'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT b.STOCKPOINTNAME,cast(a.depo as int) as StockPoint_CD'
      
        '      ,a.* ,[MARS].[dbo].[F_periode_Indofood] (a.TGL_awal) as tg' +
        'l_Periode,'
      
        '      [MARS].[dbo].[F_periode_Indofood_int] (a.TGL_awal) as Peri' +
        'ode'
      '  FROM [MARS].[dbo].[Jaminan_pinjaman_galon] a left outer join'
      '  mars.dbo.LIST_STOCKPOINT b on a.depo=b.SALESPOINTCD'
      'where  [MARS].[dbo].[F_periode_Indofood] (a.TGL_awal)>=:0'
      '  and  [MARS].[dbo].[F_periode_Indofood] (a.TGL_awal)<=:1')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBKONVERSI: TFloatField
      FieldName = 'KONVERSI'
      ReadOnly = True
    end
    object Daily_DBqty_quota: TFloatField
      FieldName = 'qty_quota'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBqty_beginning: TFloatField
      FieldName = 'qty_beginning'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBqty_receipt: TFloatField
      FieldName = 'qty_receipt'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBqty_issue: TFloatField
      FieldName = 'qty_issue'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBqty_ending: TFloatField
      FieldName = 'qty_ending'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBPeriode: TIntegerField
      FieldName = 'Periode'
      ReadOnly = True
    end
    object Daily_DBStockPoint_CD: TIntegerField
