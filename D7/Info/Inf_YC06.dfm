object Inf_YC06Frm: TInf_YC06Frm
  Left = 248
  Top = 99
  Width = 798
  Height = 558
  Caption = 'YC06-Costing N Variance Analys'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Column = cxGrid3DBTableView1ACTUAL_COST
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'ACTUAL_USAGE_QTY'
              Column = cxGrid3DBTableView1ACTUAL_USAGE_QTY
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'ACTUAL_USAGE_RP'
              Column = cxGrid3DBTableView1ACTUAL_USAGE_RP
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'COST_ACTUAL'
              Column = cxGrid3DBTableView1COST_ACTUAL
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'COST_STANDARD'
              Column = cxGrid3DBTableView1COST_STANDARD
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'FACTORY_OUT'
              Column = cxGrid3DBTableView1FACTORY_OUT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'QTY_ACTUAL_FG'
              Column = cxGrid3DBTableView1QTY_ACTUAL_FG
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'PRICE_VARIANCE'
              Column = cxGrid3DBTableView1PRICE_VARIANCE
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'STANDARD_USAGE_QTY'
              Column = cxGrid3DBTableView1STANDARD_USAGE_QTY
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'STANDARD_USAGE_RP'
              Column = cxGrid3DBTableView1STANDARD_USAGE_RP
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1FG_MATERIAL_TEXT: TcxGridDBColumn
            DataBinding.FieldName = 'FG_MATERIAL_TEXT'
            Width = 139
          end
          object cxGrid3DBTableView1RAW_MATERIAL_NO: TcxGridDBColumn
            DataBinding.FieldName = 'RAW_MATERIAL_NO'
            Width = 130
          end
          object cxGrid3DBTableView1RAW_MATERIAL_TEXT: TcxGridDBColumn
            DataBinding.FieldName = 'RAW_MATERIAL_TEXT'
            Width = 142
          end
          object cxGrid3DBTableView1ACTUAL_USAGE_QTY: TcxGridDBColumn
            DataBinding.FieldName = 'ACTUAL_USAGE_QTY'
            Width = 126
          end
          object cxGrid3DBTableView1ACTUAL_USAGE_RP: TcxGridDBColumn
            DataBinding.FieldName = 'ACTUAL_USAGE_RP'
            Width = 132
          end
          object cxGrid3DBTableView1STANDARD_USAGE_QTY: TcxGridDBColumn
            DataBinding.FieldName = 'STANDARD_USAGE_QTY'
            Width = 114
          end
          object cxGrid3DBTableView1STANDARD_USAGE_RP: TcxGridDBColumn
            DataBinding.FieldName = 'STANDARD_USAGE_RP'
            Width = 128
          end
          object cxGrid3DBTableView1ACTUAL_COST: TcxGridDBColumn
            DataBinding.FieldName = 'ACTUAL_COST'
          end
          object cxGrid3DBTableView1COST_ACTUAL: TcxGridDBColumn
            DataBinding.FieldName = 'COST_ACTUAL'
          end
          object cxGrid3DBTableView1TYPE: TcxGridDBColumn
            DataBinding.FieldName = 'TYPE'
            Width = 91
          end
          object cxGrid3DBTableView1FG_MATERIAL_NO: TcxGridDBColumn
            DataBinding.FieldName = 'FG_MATERIAL_NO'
          end
          object cxGrid3DBTableView1COST_STANDARD: TcxGridDBColumn
            DataBinding.FieldName = 'COST_STANDARD'
          end
          object cxGrid3DBTableView1FACTORY_OUT: TcxGridDBColumn
            DataBinding.FieldName = 'FACTORY_OUT'
            Width = 94
          end
          object cxGrid3DBTableView1FINISHED_GOODS: TcxGridDBColumn
            DataBinding.FieldName = 'FINISHED_GOODS'
            Width = 93
          end
          object cxGrid3DBTableView1PRICE_VARIANCE: TcxGridDBColumn
            DataBinding.FieldName = 'PRICE_VARIANCE'
            Width = 114
          end
          object cxGrid3DBTableView1QTY_ACTUAL_FG: TcxGridDBColumn
            DataBinding.FieldName = 'QTY_ACTUAL_FG'
          end
          object cxGrid3DBTableView1PLANT: TcxGridDBColumn
            DataBinding.FieldName = 'PLANT'
            Width = 40
          end
          object cxGrid3DBTableView1NAMA_PLANT: TcxGridDBColumn
            DataBinding.FieldName = 'NAMA_PLANT'
            Width = 77
          end
          ...
          object cxGrid3DBTableView1TANGGAL_AWAL: TcxGridDBColumn
            DataBinding.FieldName = 'TANGGAL_AWAL'
          end
          object cxGrid3DBTableView1TANGGAL_AKHIR: TcxGridDBColumn
            DataBinding.FieldName = 'TANGGAL_AKHIR'
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select a.FG_MATERIAL_TEXT, a.RAW_MATERIAL_NO, a.RAW_MATERIAL_TEX' +
        'T, a.ACTUAL_USAGE_QTY, a.ACTUAL_USAGE_RP, '
      '         a.STANDARD_USAGE_QTY, '
      
        '         a.STANDARD_USAGE_RP, a.ACTUAL_COST, a.COST_ACTUAL, a.TY' +
        'PE, a.FG_MATERIAL_NO, a.COST_STANDARD, '
      '         a.FACTORY_OUT, a.FINISHED_GOODS, a.PRICE_VARIANCE, '
      
        '         a.QTY_ACTUAL_FG, a.PLANT, e.Plant_Name as nama_Plant, a' +
        '.PERIODE_INDOFOOD, a.TANGGAL_AWAL, a.TANGGAL_AKHIR,'#39'YC06'#39' as Jen' +
        'is'
      ''
      
        '  FROM [ho].[dbo].[YC06_Costing_variance_analys] a  left outer j' +
        'oin '
      '   [ho].[dbo].List_Plant e on a.PLANT=e.PLant_Code'
      'where  a.TANGGAL_AWAL>=:0'
      '  and  a.TANGGAL_AWAL<=:1'
      'union all'
      
        'select b.MATERIAL_DESCRIPTION,b.MATERIAL_SKU,b.MATERIAL_DESCRIPT' +
        'ION,b.ACTUAL_OUTPUT_QTY,0,'
      '       0,'
      '       0,0,0,'#39'Finish Good'#39',b.MATERIAL_SKU,0,'
      '       0,0,0,'
      
        '       0,b.PLANT_CODE,d.Plant_Name,b.PERIODE_INDOFOOD,b.TGL_AWAL' +
        ', b.TGL_AKHIR,'#39'FG'#39'  '
      'from [ho].[dbo].hasil_fg b left outer join '
      '   [ho].[dbo].List_Plant d on b.PLANT_CODE=d.PLant_Code'
      ''
      'where b.tgl_awal>=:0'
      '  and b.tgl_awal<=:1')
    FetchRows = 5000
    ...
    object Daily_DBFG_MATERIAL_TEXT: TStringField
      FieldName = 'FG_MATERIAL_TEXT'
      Size = 250
    end
    object Daily_DBRAW_MATERIAL_NO: TStringField
      FieldName = 'RAW_MATERIAL_NO'
      Size = 250
    end
    object Daily_DBRAW_MATERIAL_TEXT: TStringField
      FieldName = 'RAW_MATERIAL_TEXT'
      Size = 250
    end
    object Daily_DBACTUAL_USAGE_QTY: TFloatField
      FieldName = 'ACTUAL_USAGE_QTY'
    end
    object Daily_DBACTUAL_USAGE_RP: TFloatField
      FieldName = 'ACTUAL_USAGE_RP'
    end
    object Daily_DBSTANDARD_USAGE_QTY: TFloatField
      FieldName = 'STANDARD_USAGE_QTY'
    end
    object Daily_DBSTANDARD_USAGE_RP: TFloatField
      FieldName = 'STANDARD_USAGE_RP'
    end
    object Daily_DBACTUAL_COST: TFloatField
      FieldName = 'ACTUAL_COST'
    end
    object Daily_DBCOST_ACTUAL: TFloatField
      FieldName = 'COST_ACTUAL'
    end
    object Daily_DBTYPE: TStringField
      FieldName = 'TYPE'
      Size = 250
    end
    object Daily_DBCOST_STANDARD: TFloatField
      FieldName = 'COST_STANDARD'
    end
    object Daily_DBFACTORY_OUT: TFloatField
      FieldName = 'FACTORY_OUT'
    end
    object Daily_DBFINISHED_GOODS: TFloatField
      FieldName = 'FINISHED_GOODS'
    end
    object Daily_DBPRICE_VARIANCE: TFloatField
      FieldName = 'PRICE_VARIANCE'
    end
    object Daily_DBQTY_ACTUAL_FG: TFloatField
      FieldName = 'QTY_ACTUAL_FG'
    end
    object Daily_DBPLANT: TStringField
      FieldName = 'PLANT'
      Size = 50
    end
    object Daily_DBNAMA_PLANT: TStringField
    ...
    object Daily_DBTANGGAL_AWAL: TDateTimeField
      FieldName = 'TANGGAL_AWAL'
    end
    object Daily_DBTANGGAL_AKHIR: TDateTimeField
      FieldName = 'TANGGAL_AKHIR'
    end
    object Daily_DBFG_MATERIAL_NO: TStringField
