...
type
  TInf_PembayaranFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBNO_TRANSAKSI_NOTA: TStringField;
    Daily_DBkd_supplier: TStringField;
    ...
    Daily_DBpotongan: TIntegerField;
    ...
    cxGrid3DBTableView1NO_TRANSAKSI_NOTA: TcxGridDBColumn;
    cxGrid3DBTableView1kd_supplier: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1potongan: TcxGridDBColumn;
...
var
  Inf_PembayaranFrm: TInf_PembayaranFrm;
implementation
...
procedure TInf_PembayaranFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_PembayaranFrm := nil;
end;

procedure TInf_PembayaranFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin

  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_PembayaranFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_PembayaranFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_PembayaranFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_PembayaranFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_PembayaranFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_PembayaranFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_PembayaranFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
