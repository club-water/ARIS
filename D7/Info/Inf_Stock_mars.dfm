object Inf_Stock_marsFrm: TInf_Stock_marsFrm
  Left = 232
  Top = 79
  Width = 1024
  Height = 575
  Caption = 'Inf_Stock_marsFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_Package_in'
              Column = cxGrid3DBTableView1MRS_Package_in
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_Package_out'
              Column = cxGrid3DBTableView1MRS_Package_out
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1MRS_stockPOint_cd: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_stockPOint_cd'
            Width = 91
          end
          ...
          object cxGrid3DBTableView1MRS_tanggal: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_tanggal'
          end
          object cxGrid3DBTableView1MRS_Document_Number: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Document_Number'
            Width = 145
          end
          object cxGrid3DBTableView1MRS_Transaction_Name: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Transaction_Name'
            Width = 142
          end
          object cxGrid3DBTableView1MRS_no_urut: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_no_urut'
            Width = 95
          end
          object cxGrid3DBTableView1MRS_Type: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Type'
            Width = 59
          end
          ...
          object cxGrid3DBTableView1MRS_Package_in: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Package_in'
            Width = 81
          end
          object cxGrid3DBTableView1MRS_Package_out: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Package_out'
            Width = 135
          end
          object cxGrid3DBTableView1MRS_Fraction_Out: TcxGridDBColumn
            Caption = 'MRS_Saldo'
            DataBinding.FieldName = 'MRS_Fraction_Out'
          end
          object cxGrid3DBTableView1MRS_QTY: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_QTY'
            Width = 93
          end
          object cxGrid3DBTableView1MRS_Satuan_1: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Satuan_1'
            Width = 81
          end
          object cxGrid3DBTableView1MRS_Satuan_2: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Satuan_2'
            Width = 98
          end
          object cxGrid3DBTableView1MRS_Konversi: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_Konversi'
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
      'SELECT [MRS_Document_Number],[MRS_Transaction_Name]'
      '      ,[MRS_Type],[MRS_Package_in]'
      '      ,[MRS_Package_out],[MRS_QTY]'
      '      ,[MRS_Fraction_Out],[MRS_stockPOint_cd]'
      '      ,[MRS_STOCKPOINTNAME],[MRS_kode_branch]'
      '      ,[MRS_nama_Branch],[MRS_Material_cd]'
      '      ,[MRS_Material_Nama],[MRS_tanggal]'
      '      ,[MRS_no_urut],[MRS_Satuan_1]'
      '      ,[MRS_Satuan_2],[MRS_Konversi]'
      '  FROM [mars].[dbo].[VMrs_Stock]'
      'where MRS_tanggal>=:0'
      '   and MRS_tanggal<=:1'
      '   and MRS_Document_Number<>'#39'Saldo Awal'#39
      'union all'
      'select '#39'Saldo Awal'#39','#39'-'#39','#39'-'#39',0,'
      
        '0, dbo.F_cari_Mars_Stock(a.stockPOint_cd,a.kode_branch,a.Materia' +
        'l_cd,DATEADD(day,-1,:0)),'
      '0,a.stockPOint_cd,b.STOCKPOINTNAME,'
      'a.kode_branch,b.nama_Branch,a.Material_cd,a.Material_Nama,'
      'DATEADD(day,-1,:0),0,'
      'c.uom_1,c.uom_2,c.Konversi'
      '  FROM mars.dbo.Mars_Stock_saldo a left outer join'
      '  mars.dbo.LIST_STOCKPOINT b on b.SALESPOINTCD=a.stockPOint_cd'
      '      and b.kode_branch=a.kode_branch left outer join'
      
        '  mars.dbo.mst_material c on cast(c.Material_cd as int)=a.Materi' +
        'al_cd')
    Left = 323
    Top = 166
    ParamData = <
    ...
    object Daily_DBMRS_Document_Number: TStringField
      FieldName = 'MRS_Document_Number'
      Size = 150
    end
    object Daily_DBMRS_Transaction_Name: TStringField
      FieldName = 'MRS_Transaction_Name'
      Size = 150
    end
    object Daily_DBMRS_Type: TStringField
      FieldName = 'MRS_Type'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBMRS_Package_in: TFloatField
      DisplayLabel = 'MRS_Qty_in'
      FieldName = 'MRS_Package_in'
      ReadOnly = True
      Required = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBMRS_Package_out: TFloatField
      DisplayLabel = 'MRS_Qty_out'
      FieldName = 'MRS_Package_out'
    end
    object Daily_DBMRS_Fraction_Out: TFloatField
      DisplayLabel = 'MRS_Saldo_Out'
      FieldName = 'MRS_Fraction_Out'
    end
    object Daily_DBMRS_stockPOint_cd: TIntegerField
      FieldName = 'MRS_stockPOint_cd'
    end
    ...
    object Daily_DBMRS_tanggal: TDateTimeField
      FieldName = 'MRS_tanggal'
    end
    object Daily_DBMRS_no_urut: TIntegerField
      FieldName = 'MRS_no_urut'
      Required = True
    end
    object Daily_DBMRS_Satuan_1: TStringField
      FieldName = 'MRS_Satuan_1'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBMRS_Satuan_2: TStringField
      FieldName = 'MRS_Satuan_2'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBMRS_Konversi: TFloatField
      FieldName = 'MRS_Konversi'
      ReadOnly = True
    end
