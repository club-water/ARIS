object Inf_Stock_MarketingFrm: TInf_Stock_MarketingFrm
  Left = 154
  Top = 50
  Width = 909
  Height = 608
  Caption = 'Inf_Stock_MarketingFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1no_pol_kendaraan: TcxGridDBColumn
            DataBinding.FieldName = 'no_pol_kendaraan'
            Width = 126
          end
          object cxGrid3DBTableView1no_ref: TcxGridDBColumn
            DataBinding.FieldName = 'no_ref'
            Width = 108
          end
          object cxGrid3DBTableView1jenis_ref: TcxGridDBColumn
            DataBinding.FieldName = 'jenis_ref'
            Width = 113
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'select R.*,b.NAMA,b.ALAMAT_1,c.nama_item,c.satuan'
      ' from ('
      ...
      '      ,'#39#39
        ...
        '      ,ISNULL((SELECT SUM(masuk-keluar) FROM [Rekap_stock_market' +
        ']  b'
      
        '        WHERE B.depo=A.depo AND B.kode_item=A.kode_item and b.ko' +
        'de_gudang=a.kode_gudang'
      '           AND B.tanggal_transaksi<:0),0) AS masuk,'
      '      0,kode_gudang,'
      '      '#39#39','#39#39','#39#39'    '
      '     '
      '  ,1'
      '  FROM [Rekap_stock_market] A'
      'GROUP BY [depo],kode_item,kode_gudang '
      ' '
      
        ') r left outer join MST_OUTLET b on r.kd_outlet=b.KODE and r.dep' +
        'o=b.depo'
      
        '  left outer join [TB_ERP].[dbo].[MST_ITEM] c on c.kode_item=r.k' +
        'ode_item'
      'order by r.kode_item,r.no_urut,r.tanggal_transaksi')
    ...
    object Daily_DBno_pol_kendaraan: TStringField
      DisplayLabel = 'NO POL KENDARAAN'
      FieldName = 'no_pol_kendaraan'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBno_ref: TStringField
      DisplayLabel = 'NO REFF'
      FieldName = 'no_ref'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBjenis_ref: TStringField
      DisplayLabel = 'JENIS REFF'
      FieldName = 'jenis_ref'
      ReadOnly = True
      Size = 50
    end
