...
type
  TInf_PengeluaranBarangFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBkode_supplier: TStringField;
    Daily_DBnama_supplier: TStringField;
    Daily_DBALAMAT_1: TStringField;
    Daily_DBKODE_PENANGGUNG_JAWAB: TStringField;
    Daily_DBNAMA_PENANGGUNG_JAWAB: TStringField;
    Daily_DBNO_POL: TStringField;
    Daily_DBASSET: TStringField;
    ...
    cxGrid3DBTableView1kode_supplier: TcxGridDBColumn;
    cxGrid3DBTableView1nama_supplier: TcxGridDBColumn;
    cxGrid3DBTableView1ALAMAT_1: TcxGridDBColumn;
    cxGrid3DBTableView1KODE_PENANGGUNG_JAWAB: TcxGridDBColumn;
    cxGrid3DBTableView1NAMA_PENANGGUNG_JAWAB: TcxGridDBColumn;
    cxGrid3DBTableView1NO_POL: TcxGridDBColumn;
    cxGrid3DBTableView1ASSET: TcxGridDBColumn;
...
var
  Inf_PengeluaranBarangFrm: TInf_PengeluaranBarangFrm;
implementation
...
procedure TInf_PengeluaranBarangFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_PengeluaranBarangFrm := nil;
end;

procedure TInf_PengeluaranBarangFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin

  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_PengeluaranBarangFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_PengeluaranBarangFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_PengeluaranBarangFrm.FormShow(Sender: TObject);
begin
...
procedure TInf_PengeluaranBarangFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_PengeluaranBarangFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_PengeluaranBarangFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_PengeluaranBarangFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
