object Inf_Sales_rekap_marsFrm: TInf_Sales_rekap_marsFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Sales_rekap_marsFrm'
  Color = clBtnFace
  ...
  object Filter: TPageControl
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'CNGROSSAMT'
              Column = cxGrid3DBTableView1CNGROSSAMT
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'NDGROSSAMT'
              Column = cxGrid3DBTableView1NDGROSSAMT
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'NETGROSSAMT'
              Column = cxGrid3DBTableView1NETGROSSAMT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'NETRTN'
              Column = cxGrid3DBTableView1NETRTN
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'NETSLS'
              Column = cxGrid3DBTableView1NETSLS
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'NETTOTAL'
              Column = cxGrid3DBTableView1NETTOTAL
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'NETVAT'
              Column = cxGrid3DBTableView1NETVAT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'RTNGROSSAMT'
              Column = cxGrid3DBTableView1RTNGROSSAMT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'RTNVAT'
              Column = cxGrid3DBTableView1RTNVAT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'SLSDISCOUNT'
              Column = cxGrid3DBTableView1SLSDISCOUNT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'SLSGROSSAMT'
              Column = cxGrid3DBTableView1SLSGROSSAMT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
              FieldName = 'SLSVAT'
              Column = cxGrid3DBTableView1SLSVAT
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1TGL: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1SLSGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'SLSGROSSAMT'
            Width = 96
          end
          object cxGrid3DBTableView1SLSDISCOUNT: TcxGridDBColumn
            DataBinding.FieldName = 'SLSDISCOUNT'
            Width = 90
          end
          object cxGrid3DBTableView1SLSVAT: TcxGridDBColumn
            DataBinding.FieldName = 'SLSVAT'
            Width = 77
          end
          object cxGrid3DBTableView1NETSLS: TcxGridDBColumn
            DataBinding.FieldName = 'NETSLS'
            Width = 94
          end
          object cxGrid3DBTableView1RTNGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'RTNGROSSAMT'
            Width = 81
          end
          object cxGrid3DBTableView1RTNVAT: TcxGridDBColumn
            DataBinding.FieldName = 'RTNVAT'
            Width = 70
          end
          object cxGrid3DBTableView1NETRTN: TcxGridDBColumn
            DataBinding.FieldName = 'NETRTN'
            Width = 88
          end
          object cxGrid3DBTableView1CNGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'CNGROSSAMT'
            Width = 99
          end
          object cxGrid3DBTableView1NDGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'NDGROSSAMT'
            Width = 76
          end
          object cxGrid3DBTableView1NETGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'NETGROSSAMT'
            Width = 95
          end
          object cxGrid3DBTableView1NETVAT: TcxGridDBColumn
            DataBinding.FieldName = 'NETVAT'
            Width = 110
          end
          object cxGrid3DBTableView1NETTOTAL: TcxGridDBColumn
    ...
    object TabSheet4: TTabSheet
      ...
      object cxDBPivotGrid1: TcxDBPivotGrid
        ...
        Groups = <>
        TabOrder = 0
        object cxDBPivotGrid1PLANTCD: TcxDBPivotGridField
          AreaIndex = 0
          DataBinding.FieldName = 'PLANTCD'
          Visible = True
        end
        object cxDBPivotGrid1STOCKPOINTNAME: TcxDBPivotGridField
          AreaIndex = 1
          DataBinding.FieldName = 'STOCKPOINTNAME'
          Visible = True
        end
        object cxDBPivotGrid1TGL: TcxDBPivotGridField
          AreaIndex = 2
          DataBinding.FieldName = 'TGL'
          Visible = True
        end
        object cxDBPivotGrid1SLSGROSSAMT: TcxDBPivotGridField
          AreaIndex = 3
          DataBinding.FieldName = 'SLSGROSSAMT'
          Visible = True
        end
        object cxDBPivotGrid1SLSDISCOUNT: TcxDBPivotGridField
          AreaIndex = 4
          DataBinding.FieldName = 'SLSDISCOUNT'
          Visible = True
        end
        object cxDBPivotGrid1SLSVAT: TcxDBPivotGridField
          AreaIndex = 5
          DataBinding.FieldName = 'SLSVAT'
          Visible = True
        end
        object cxDBPivotGrid1NETSLS: TcxDBPivotGridField
          AreaIndex = 6
          DataBinding.FieldName = 'NETSLS'
          Visible = True
        end
        object cxDBPivotGrid1RTNGROSSAMT: TcxDBPivotGridField
          AreaIndex = 7
          DataBinding.FieldName = 'RTNGROSSAMT'
          Visible = True
        end
        object cxDBPivotGrid1RTNVAT: TcxDBPivotGridField
          AreaIndex = 8
          DataBinding.FieldName = 'RTNVAT'
          Visible = True
        end
        object cxDBPivotGrid1NETRTN: TcxDBPivotGridField
          AreaIndex = 9
          DataBinding.FieldName = 'NETRTN'
          Visible = True
        end
        object cxDBPivotGrid1CNGROSSAMT: TcxDBPivotGridField
          AreaIndex = 10
          DataBinding.FieldName = 'CNGROSSAMT'
          Visible = True
        end
        object cxDBPivotGrid1NDGROSSAMT: TcxDBPivotGridField
          AreaIndex = 11
          DataBinding.FieldName = 'NDGROSSAMT'
          Visible = True
        end
        object cxDBPivotGrid1NETGROSSAMT: TcxDBPivotGridField
          AreaIndex = 12
          DataBinding.FieldName = 'NETGROSSAMT'
          Visible = True
        end
        object cxDBPivotGrid1NETVAT: TcxDBPivotGridField
          AreaIndex = 13
          DataBinding.FieldName = 'NETVAT'
          Visible = True
        end
        object cxDBPivotGrid1NETTOTAL: TcxDBPivotGridField
          AreaIndex = 14
          DataBinding.FieldName = 'NETTOTAL'
          Visible = True
        end
        object cxDBPivotGrid1tgl_Periode: TcxDBPivotGridField
          AreaIndex = 15
          DataBinding.FieldName = 'tgl_Periode'
          Visible = True
        end
        object cxDBPivotGrid1tgl_Periode_int: TcxDBPivotGridField
          AreaIndex = 16
          DataBinding.FieldName = 'tgl_Periode_int'
          Visible = True
        end
        object cxDBPivotGrid1SALESPOINTCD: TcxDBPivotGridField
          AreaIndex = 17
          DataBinding.FieldName = 'SALESPOINTCD'
          Visible = True
        end
        object cxDBPivotGrid1kode_branch: TcxDBPivotGridField
          AreaIndex = 18
          DataBinding.FieldName = 'kode_branch'
          Visible = True
        end
        object cxDBPivotGrid1nama_branch: TcxDBPivotGridField
          AreaIndex = 19
          DataBinding.FieldName = 'nama_branch'
          Visible = True
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT a.PLANTCD'
      '      ,cast(a.SALESPOINTCD as int) as SALESPOINTCD'
      '      ,b.STOCKPOINTNAME'
      '      ,a.TGL'
      '      ,a.SLSGROSSAMT'
      '      ,a.SLSDISCOUNT'
      ...
      '      ,b.kode_branch'
      '      ,b.nama_branch'
      '      ,[MARS].[dbo].[F_periode_Indofood] (a.TGL) as tgl_Periode'
      
        '      ,[MARS].[dbo].[F_periode_Indofood_int] (a.TGL) as tgl_Peri' +
        'ode_int'
      '  FROM [MARS].[dbo].[Sales_rf] a left outer join'
      
        '  mars.dbo.LIST_STOCKPOINT b on CAST(a.SALESPOINTCD AS integer)=' +
        'b.SALESPOINTCD and a.PLANTCD=b.kode_branch'
      'where  a.TGL>=:0'
      '  and  a.TGL<=:1')
    Active = True
    Left = 323
    ...
    object Daily_DBTGL: TDateTimeField
      FieldName = 'TGL'
    end
    object Daily_DBSLSGROSSAMT: TFloatField
      FieldName = 'SLSGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSLSDISCOUNT: TFloatField
      FieldName = 'SLSDISCOUNT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBSLSVAT: TFloatField
      FieldName = 'SLSVAT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNETSLS: TFloatField
      FieldName = 'NETSLS'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBRTNGROSSAMT: TFloatField
      FieldName = 'RTNGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBRTNVAT: TFloatField
      FieldName = 'RTNVAT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNETRTN: TFloatField
      FieldName = 'NETRTN'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCNGROSSAMT: TFloatField
      FieldName = 'CNGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNDGROSSAMT: TFloatField
      FieldName = 'NDGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNETGROSSAMT: TFloatField
      FieldName = 'NETGROSSAMT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNETVAT: TFloatField
      FieldName = 'NETVAT'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBNETTOTAL: TFloatField
      DisplayLabel = 'AR'
      FieldName = 'NETTOTAL'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBtgl_Periode: TDateTimeField
      FieldName = 'tgl_Periode'
      ReadOnly = True
    end
    ...
    object Daily_DBSALESPOINTCD: TIntegerField
