object Comp_sales_Detil_marsVSr3VSbwFRM: TComp_sales_Detil_marsVSr3VSbwFRM
  Left = 200
  Top = 61
  Width = 1036
  Height = 637
  Caption = 'Comp_sales_Detil_marsVSr3VSbwFRM'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'BW_NetSalesAmount_dpp'
              Column = cxGrid3DBTableView1BW_NetSalesAmount_dpp
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_NETGROSSAMT'
              Column = cxGrid3DBTableView1MRS_NETGROSSAMT
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
            ...
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'BW_NetSalesAmount_ppn'
              Column = cxGrid3DBTableView1BW_NetSalesAmount_ppn
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'BW_NetSalesAmount_total'
              Column = cxGrid3DBTableView1BW_NetSalesAmount_total
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'MRS_NETGROSSAMT_Dpp'
              Column = cxGrid3DBTableView1MRS_NETGROSSAMT_Dpp
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skCount
              FieldName = 'MRS_nama_Branch'
              Column = cxGrid3DBTableView1MRS_nama_Branch
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1mrs_Invoice_nomer: TcxGridDBColumn
            DataBinding.FieldName = 'mrs_Invoice_nomer'
            Styles.Content = _DataModule.cxStyle9
            Width = 97
          end
          object cxGrid3DBTableView1mrs_Kode_Customer: TcxGridDBColumn
            DataBinding.FieldName = 'mrs_Kode_Customer'
            Styles.Content = _DataModule.cxStyle9
            Width = 102
          end
          object cxGrid3DBTableView1mrs_Nama_Customer: TcxGridDBColumn
            DataBinding.FieldName = 'mrs_Nama_Customer'
            Styles.Content = _DataModule.cxStyle9
            Width = 105
          end
          object cxGrid3DBTableView1MRS_Periode_inf: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1BW_Kode_Branch: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Kode_Branch'
            Width = 111
          end
          object cxGrid3DBTableView1Bw_nama_Branch: TcxGridDBColumn
            DataBinding.FieldName = 'Bw_nama_Branch'
            Width = 92
          end
          object cxGrid3DBTableView1BW_STOCKPOINTKD: TcxGridDBColumn
            DataBinding.FieldName = 'BW_STOCKPOINTKD'
            Width = 113
          end
          ...
          object cxGrid3DBTableView1BW_Cust_Cd: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Cust_Cd'
            Width = 69
          end
          object cxGrid3DBTableView1BW_Cust_Nama: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Cust_Nama'
            Width = 84
          end
          object cxGrid3DBTableView1BW_Invoice: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Invoice'
            Width = 64
          end
          object cxGrid3DBTableView1BW_Periode_inf: TcxGridDBColumn
            DataBinding.FieldName = 'BW_Periode_inf'
          end
          object cxGrid3DBTableView1R3_SALESPOINTCD: TcxGridDBColumn
            DataBinding.FieldName = 'R3_SALESPOINTCD'
            Styles.Content = _DataModule.cxStyle7
          end
          object cxGrid3DBTableView1R3_STOCKPOINTNAME: TcxGridDBColumn
            DataBinding.FieldName = 'R3_STOCKPOINTNAME'
            Styles.Content = _DataModule.cxStyle7
            Width = 125
          end
          ...
          object cxGrid3DBTableView1R3_Customer_cd: TcxGridDBColumn
            DataBinding.FieldName = 'R3_Customer_cd'
            Styles.Content = _DataModule.cxStyle7
            Width = 87
          end
          object cxGrid3DBTableView1R3_No_Faktur: TcxGridDBColumn
            DataBinding.FieldName = 'R3_No_Faktur'
            Styles.Content = _DataModule.cxStyle7
            Width = 89
          end
          object cxGrid3DBTableView1R3_Customer_Name: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1MRS_NETGROSSAMT_Dpp: TcxGridDBColumn
            Caption = 'MRS_NETGROSSAMT_DPP'
            DataBinding.FieldName = 'MRS_NETGROSSAMT_Dpp'
          end
          object cxGrid3DBTableView1MRS_NETGROSSAMT: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_NETGROSSAMT'
            Styles.Content = _DataModule.cxStyle9
            Width = 121
          end
          object cxGrid3DBTableView1BW_NetSalesAmount_dpp: TcxGridDBColumn
            DataBinding.FieldName = 'BW_NetSalesAmount_dpp'
            Width = 108
          end
          object cxGrid3DBTableView1BW_NetSalesAmount_ppn: TcxGridDBColumn
            DataBinding.FieldName = 'BW_NetSalesAmount_ppn'
            Width = 110
          end
          object cxGrid3DBTableView1BW_NetSalesAmount_total: TcxGridDBColumn
            DataBinding.FieldName = 'BW_NetSalesAmount_total'
            Width = 105
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select t.* , case  WHEN abs(selisih_mrs_sapr3_1)+abs(selisih_mrs' +
        '_sapbw_1)+abs(selisih_SAPR3_sapbw_1) > 10 THEN 1 '
      '         ELSE 0 end as Flag_Selisih'
      
        '      ,case when abs(selisih_mrs_sapr3_1)<5 then selisih_mrs_sap' +
        'r3_1 else selisih_mrs_sapr3_1 end as selisih_mrs_sapr3 '
      
        '      ,case when abs(selisih_mrs_sapbw_1)<5 then selisih_mrs_sap' +
        'bw_1 else selisih_mrs_sapbw_1 end as selisih_mrs_sapbw       '
      
        '      ,case when abs(selisih_SAPR3_sapbw_1)<5 then selisih_SAPR3' +
        '_sapbw_1 else selisih_SAPR3_sapbw_1 end as selisih_SAPR3_sapbw '
      '  '
      ''
      
        '  /*    ,case when abs(selisih_mrs_sapr3_1)<5 then 0 else selisi' +
        'h_mrs_sapr3_1 end as selisih_mrs_sapr3 '
      
        '      ,case when abs(selisih_mrs_sapbw_1)<5 then 0 else selisih_' +
        'mrs_sapbw_1 end as selisih_mrs_sapbw       '
      
        '      ,case when abs(selisih_SAPR3_sapbw_1)<5 then 0 else selisi' +
        'h_SAPR3_sapbw_1 end as selisih_SAPR3_sapbw */'
      ''
      
        '      -- ,abs(isnull(MRS_NETGROSSAMT_DPP,0)-isnull(BW_NetSalesAm' +
        'ount,0)) as selisih_mrs_BW_DPP '
      ' from ('
      
        'SELECT ISNULL(a.mrs_kode_branch,ISNULL(c.kode_branch,d.Kode_Bran' +
        'ch)) as ZKD_Branch,  '
      '      a.mrs_kode_branch as MRS_kode_branch'
      '      ,a.mrs_nama_Branch as MRS_nama_Branch'
      '      ,a.mrs_SALESPOINTCD as MRS_SALESPOINTCD '
      '      ,a.mrs_STOCKPOINTNAME as MRS_STOCKPOINTNAME'
      '      --,isnull(c.tgl,a.mrs_Invoice_date) as MRS_TGL'
      '       ,a.mrs_Invoice_date as MRS_TGL'
      '      ,a.mrs_NET*1.1 as MRS_NETGROSSAMT'
      '      ,a.mrs_NET as MRS_NETGROSSAMT_Dpp'
      '      ,a.mrs_Invoice_nomer '
      '      ,a.mrs_Kode_Customer'
      '      ,a.mrs_Nama_Customer'
      
        '      ,dbo.F_periode_Indofood_int (a.mrs_Invoice_date) as MRS_Pe' +
        'riode_inf'
      ...
      '      ,c.TGL as BW_TGL'
      '      ,c.NetSalesAmount as BW_NetSalesAmount_dpp'
      '      ,c.NetSalesAmount*10/100 as BW_NetSalesAmount_ppn'
      
        '      ,c.NetSalesAmount+(c.NetSalesAmount*10/100) as BW_NetSales' +
        'Amount_total'
      ...
      '      ,d.No_Faktur as R3_No_Faktur '
      '      ,dbo.F_periode_Indofood_int (d.Tax_date) as R3_Periode_inf'
      
        '      ,isnull(a.mrs_NET*1.1,0)-isnull(d.DPP+d.PPN,0) as selisih_' +
        'mrs_sapr3_1'
      
        '      ,isnull(a.mrs_NET*1.1,0)-isnull(c.NetSalesAmount+(c.NetSal' +
        'esAmount*10/100),0) as selisih_mrs_sapbw_1'
      
        '      ,isnull(d.DPP+d.PPN,0)-isnull(c.NetSalesAmount+(c.NetSales' +
        'Amount*10/100),0) as selisih_SAPR3_sapbw_1'
      '  FROM [MARS].[dbo].[VSales_mars_oer14] a  Full  join'
      
        '  mars.dbo.Vsales_bw_detil_invoice c on a.mrs_SALESPOINTCD=c.STO' +
        'CKPOINTKD and a.mrs_kode_branch=c.kode_branch  '
      
        '      and  a.mrs_Invoice_nomer=c.Invoice and a.mrs_Kode_Customer' +
        '=c.Cust_Cd and a.Jenis_Retur=c.Jenis_Retur '
      '      and a.mrs_Invoice_date=c.tgl Full  join'
      
        '  mars.dbo.Vsap_Sales_YF126cn D ON D.Stockpoint_cd=isnull(a.mrs_' +
        'SALESPOINTCD,C.STOCKPOINTKD) '
      
        '           and d.No_Faktur=isnull(a.mrs_Invoice_nomer,c.Invoice)' +
        ' and d.Kode_Branch=isnull(a.mrs_kode_branch,c.kode_branch)'
      
        '           and d.Customer_cd=isnull(a.mrs_Kode_Customer,c.Cust_C' +
        'd) and d.Jenis_Retur=isnull(a.Jenis_Retur,c.Jenis_Retur)   '
      '  where isnull(a.mrs_Invoice_date,isnull(c.tgl,d.Tax_date))>=:0'
      '     and isnull(a.mrs_Invoice_date,isnull(c.tgl,d.Tax_date))<=:1'
      ' ) T'
      
        '--order by isnull(t.MRS_TGL,isnull(t.BW_TGL,t.R3_Tax_date)),t.R3' +
        '_SALESPOINTCD')
    Left = 323
    Top = 166
    ParamData = <
    ...
    object Daily_DBMRS_SALESPOINTCD: TIntegerField
    ...
    object Daily_DBMRS_NETGROSSAMT: TFloatField
      FieldName = 'MRS_NETGROSSAMT'
      ReadOnly = True
    end
    object Daily_DBmrs_Invoice_nomer: TStringField
      FieldName = 'mrs_Invoice_nomer'
      Size = 50
    end
    object Daily_DBmrs_Kode_Customer: TStringField
      FieldName = 'mrs_Kode_Customer'
      Size = 50
    end
    object Daily_DBmrs_Nama_Customer: TStringField
      FieldName = 'mrs_Nama_Customer'
      Size = 250
    end
    object Daily_DBMRS_Periode_inf: TIntegerField
    ...
    object Daily_DBBW_Kode_Branch: TStringField
      FieldName = 'BW_Kode_Branch'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBBw_nama_Branch: TStringField
      FieldName = 'Bw_nama_Branch'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBBW_STOCKPOINTKD: TStringField
      FieldName = 'BW_STOCKPOINTKD'
      ReadOnly = True
      Size = 50
    end
    ...
    object Daily_DBBW_Cust_Cd: TStringField
      FieldName = 'BW_Cust_Cd'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBBW_Cust_Nama: TStringField
      FieldName = 'BW_Cust_Nama'
      ReadOnly = True
      Size = 250
    end
    object Daily_DBBW_Invoice: TStringField
      FieldName = 'BW_Invoice'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBBW_Periode_inf: TIntegerField
      FieldName = 'BW_Periode_inf'
      ReadOnly = True
    end
    object Daily_DBBW_NetSalesAmount_dpp: TFloatField
      FieldName = 'BW_NetSalesAmount_dpp'
      ReadOnly = True
    end
    object Daily_DBBW_NetSalesAmount_ppn: TFloatField
      FieldName = 'BW_NetSalesAmount_ppn'
      ReadOnly = True
    end
    object Daily_DBBW_NetSalesAmount_total: TFloatField
      FieldName = 'BW_NetSalesAmount_total'
      ReadOnly = True
    end
    object Daily_DBR3_SALESPOINTCD: TIntegerField
      FieldName = 'R3_SALESPOINTCD'
      ReadOnly = True
    end
    object Daily_DBR3_STOCKPOINTNAME: TStringField
      FieldName = 'R3_STOCKPOINTNAME'
      ReadOnly = True
      Size = 250
    end
    ...
    object Daily_DBR3_Customer_cd: TStringField
      FieldName = 'R3_Customer_cd'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBR3_Customer_Name: TStringField
    ...
    object Daily_DBR3_No_Faktur: TStringField
      FieldName = 'R3_No_Faktur'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBMRS_NETGROSSAMT_Dpp: TFloatField
      FieldName = 'MRS_NETGROSSAMT_Dpp'
      ReadOnly = True
    end
  end
  ...
  object UniQuery1: TUniQuery
    ...
    SQL.Strings = (
      ...
      'select R.* from ('
      'SELECT cast(b.SALESPOINTCD as int) as SALESPOINTCD'
      '      ,b.STOCKPOINTNAME'
      '      ,a.R3_Amount'
      '      ,b.tanggal'
      '      ,CASE WHEN a.R3_Amount>0'
      '       THEN '#39'X'#39' ELSE '#39#39
      '       END as Status_SAP '
      '  FROM MARS.dbo.VDepo_Tanggal b FULL OUTER JOIN'
      '  MARS.dbo.VSales_sapr3 a on b.SALESPOINTCD=a.R3_SALESPOINTCD'
      '     and b.tanggal=a.R3_documentdate'
      '   ) r'
      '  where r.tanggal>=:0'
      '    and r.tanggal<=:1')
    Left = 323
    ...
    object UniQuery1SALESPOINTCD: TIntegerField
    ...
    object UniQuery1R3_Amount: TFloatField
      FieldName = 'R3_Amount'
      ReadOnly = True
    end
    ...
    object UniQuery1Status_SAP: TStringField
      FieldName = 'Status_SAP'
      ReadOnly = True
      Required = True
      Size = 1
    end
