object Inf_Sales_rekap_QTY_marsFrm: TInf_Sales_rekap_QTY_marsFrm
  Left = 171
  Top = 67
  Width = 909
  Height = 575
  Caption = 'Inf_Sales_rekap_QTY_marsFrm'
  Color = clBtnFace
  ...
  object Daily_DB: TUniQuery
    SQL.Strings = (
      ...
      '      ,b.ITEMCD_NAMA'
      '      ,a.QTY'
      '  FROM [MARS].[dbo].[tth_iap] a left outer join '
      '    mars.dbo.LIST_ITEM b on a.ITEMCD=b.ITEMCD left outer join'
      '    mars.dbo.LIST_STOCKPOINT c on a.SALESPOINTCD=c.SALESPOINTCD'
      'where  a.TGL>=:0'
      '  and  a.TGL<=:1')
    Left = 323
    Top = 166
