object Inf_Cost_per_unitFrm: TInf_Cost_per_unitFrm
  Left = 369
  Top = 100
  Width = 798
  Height = 558
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'SELECT   FG_MATERIAL_NO,[NAMA_PLANT]'
      '      ,[FG_MATERIAL_TEXT]'
      '      ,[RAW_MATERIAL_NO]'
      '      ,[RAW_MATERIAL_TEXT]'
      '      ,[PERIODE_INDOFOOD]'
      ...
      '      ,[ACTUAL_USAGE_QTY]'
      '      ,[Jenis]'
      '  FROM [Ho].[dbo].[VCost_Per_Unit_rv1]'
      '  where cast(PERIODE_INDOFOOD as int)>=:0'
      '     and cast(PERIODE_INDOFOOD as int)<=:1')
    FetchRows = 5000
    Left = 323
    Top = 166
    ParamData = <
