object Inf_Rekap_Absensi_FingerFrm: TInf_Rekap_Absensi_FingerFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_Rekap_Absensi_FingerFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1PIN: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1DEPARTEMEN: TcxGridDBColumn
            DataBinding.FieldName = 'DEPARTEMEN'
            Width = 97
          end
          object cxGrid3DBTableView1JABATAN: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1LIBUR: TcxGridDBColumn
            DataBinding.FieldName = 'LIBUR'
            Width = 37
          end
          object cxGrid3DBTableView1SHIFT_OT: TcxGridDBColumn
            DataBinding.FieldName = 'SHIFT_OT'
            Width = 57
          end
          ...
          object cxGrid3DBTableView1NAMA_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'NAMA_KODE'
            Width = 72
          end
          object cxGrid3DBTableView1MASUK: TcxGridDBColumn
            DataBinding.FieldName = 'MASUK'
          end
          object cxGrid3DBTableView1SCAN_MASUK: TcxGridDBColumn
            DataBinding.FieldName = 'SCAN_MASUK'
          end
          object cxGrid3DBTableView1TERLAMBAT: TcxGridDBColumn
            DataBinding.FieldName = 'TERLAMBAT'
          end
          object cxGrid3DBTableView1KELUAR: TcxGridDBColumn
            DataBinding.FieldName = 'KELUAR'
          end
          object cxGrid3DBTableView1SCAN_KELUAR: TcxGridDBColumn
            DataBinding.FieldName = 'SCAN_KELUAR'
          end
          object cxGrid3DBTableView1P_CEPAT: TcxGridDBColumn
            DataBinding.FieldName = 'P_CEPAT'
          end
          object cxGrid3DBTableView1NILAI_ISTIRAHAT: TcxGridDBColumn
            DataBinding.FieldName = 'NILAI_ISTIRAHAT'
          end
          object cxGrid3DBTableView1DURASI: TcxGridDBColumn
            DataBinding.FieldName = 'DURASI'
          end
          object cxGrid3DBTableView1TOTAL_OT: TcxGridDBColumn
            DataBinding.FieldName = 'TOTAL_OT'
          end
          object cxGrid3DBTableView1Absen: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT *'
      '  FROM [TB_HRIS].[dbo].[View_Absensi_finger] A'
      'where  a.TANGGAL>=:0'
      '  and  a.TANGGAL<=:1')
    Active = True
    Left = 323
    ...
    object Daily_DBPIN: TStringField
      FieldName = 'PIN'
      Size = 250
    end
    ...
    object Daily_DBDEPARTEMEN: TStringField
    ...
    object Daily_DBLIBUR: TStringField
      FieldName = 'LIBUR'
      Size = 250
    end
    object Daily_DBSHIFT_OT: TStringField
      FieldName = 'SHIFT_OT'
      Size = 250
    end
    ...
    object Daily_DBNAMA_KODE: TStringField
      FieldName = 'NAMA_KODE'
      Size = 250
    end
    object Daily_DBMASUK: TDateTimeField
      FieldName = 'MASUK'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBSCAN_MASUK: TDateTimeField
      FieldName = 'SCAN_MASUK'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBTERLAMBAT: TDateTimeField
      FieldName = 'TERLAMBAT'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBKELUAR: TDateTimeField
      FieldName = 'KELUAR'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBSCAN_KELUAR: TDateTimeField
      FieldName = 'SCAN_KELUAR'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBP_CEPAT: TDateTimeField
      FieldName = 'P_CEPAT'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBNILAI_ISTIRAHAT: TDateTimeField
      FieldName = 'NILAI_ISTIRAHAT'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBDURASI: TDateTimeField
      FieldName = 'DURASI'
      DisplayFormat = 'hh:mm'
    end
    object Daily_DBTOTAL_OT: TDateTimeField
      FieldName = 'TOTAL_OT'
      DisplayFormat = 'hh:mm'
    end
    ...
    object Daily_DBAbsen: TIntegerField
      FieldName = 'Absen'
      ReadOnly = True
    end
  end
