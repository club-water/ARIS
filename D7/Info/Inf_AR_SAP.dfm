object Inf_AR_SAPFrm: TInf_AR_SAPFrm
  Left = 245
  Top = 122
  Width = 909
  Height = 575
  Caption = 'Inf_AR_SAPFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Kind = skSum
              FieldName = 'OD_1_10'
              Column = cxGrid3DBTableView1OD_1_10
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'OD_11_20'
              Column = cxGrid3DBTableView1OD_11_20
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'od_21_30'
              Column = cxGrid3DBTableView1od_21_30
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
            ...
            item
              ...
              Column = cxGrid3DBTableView1od_atas_90
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'Total_Debet'
              Column = cxGrid3DBTableView1Total_Debet
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1Gl_Account: TcxGridDBColumn
            DataBinding.FieldName = 'Gl_Account'
            Width = 66
          end
          object cxGrid3DBTableView1Currency: TcxGridDBColumn
            DataBinding.FieldName = 'Currency'
            Width = 47
          end
          object cxGrid3DBTableView1Total_Debet: TcxGridDBColumn
            DataBinding.FieldName = 'Total_Debet'
            Width = 111
          end
          ...
          object cxGrid3DBTableView1OD_1_10: TcxGridDBColumn
            DataBinding.FieldName = 'OD_1_10'
            Width = 104
          end
          object cxGrid3DBTableView1OD_11_20: TcxGridDBColumn
            DataBinding.FieldName = 'OD_11_20'
            Width = 111
          end
          object cxGrid3DBTableView1od_21_30: TcxGridDBColumn
            DataBinding.FieldName = 'od_21_30'
            Width = 109
          end
          ...
          object cxGrid3DBTableView1od_atas_90: TcxGridDBColumn
            DataBinding.FieldName = 'od_atas_90'
            Width = 106
          end
          object cxGrid3DBTableView1doc_date: TcxGridDBColumn
            DataBinding.FieldName = 'doc_date'
            Width = 58
          end
          object cxGrid3DBTableView1Text_Invoice_or_cn: TcxGridDBColumn
            DataBinding.FieldName = 'Text_Invoice_or_cn'
            Width = 100
          end
          ...
          object cxGrid3DBTableView1doc_number: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1Assign_number: TcxGridDBColumn
            DataBinding.FieldName = 'Assign_number'
            Width = 77
          end
          object cxGrid3DBTableView1header_Text: TcxGridDBColumn
            DataBinding.FieldName = 'header_Text'
            Width = 96
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT b.STOCKPOINTNAME,a.*,b.nama_Branch'
      '  FROM [MARS].[dbo].[AR_SAP_R3] a  LEFT OUTER JOIN'
      
        '        dbo.LIST_STOCKPOINT AS b ON StockPoint_KD= b.SALESPOINTC' +
        'D'
      '                 and a.kode_branch=b.kode_branch'
      'where  a.DateASOF=:0')
    Left = 323
    Top = 166
    ParamData = <
    ...
    object Daily_DBGl_Account: TStringField
      FieldName = 'Gl_Account'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBCurrency: TStringField
      FieldName = 'Currency'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBTotal_Debet: TFloatField
      FieldName = 'Total_Debet'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBOD_1_10: TFloatField
      FieldName = 'OD_1_10'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBOD_11_20: TFloatField
      FieldName = 'OD_11_20'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBod_21_30: TFloatField
      FieldName = 'od_21_30'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    ...
    object Daily_DBod_atas_90: TFloatField
      FieldName = 'od_atas_90'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBText_Invoice_or_cn: TStringField
      FieldName = 'Text_Invoice_or_cn'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBdoc_date: TDateTimeField
      FieldName = 'doc_date'
      ReadOnly = True
    end
    ...
    object Daily_DBdoc_number: TStringField
      FieldName = 'doc_number'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBdue_Date: TDateTimeField
      FieldName = 'due_Date'
      ReadOnly = True
    end
    object Daily_DBAssign_number: TStringField
      FieldName = 'Assign_number'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBheader_Text: TStringField
