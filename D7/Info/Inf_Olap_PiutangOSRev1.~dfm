object Inf_Olap_PiutangOSRev1_Frm: TInf_Olap_PiutangOSRev1_Frm
  Left = 105
  Top = 105
  Width = 1223
  Height = 608
  Caption = 'Inf_Olap_PiutangOSRev1_Frm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'SALDOAWAL'
              Column = cxGrid3DBTableView1SALDOAWAL
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1CUSTOMER_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'CUSTOMER_KODE'
            Width = 101
          end
          ...
          object cxGrid3DBTableView1PELUNASAN: TcxGridDBColumn
            DataBinding.FieldName = 'PELUNASAN'
            Width = 93
          end
          object cxGrid3DBTableView1NOGIRO: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1SALDOAWAL: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'EXEC'#9'[dbo].[RPT_KARTU_PIUTANG] :0,:1,:2,:3,:4')
    ...
    object Daily_DBPELUNASAN: TStringField
      FieldName = 'PELUNASAN'
      ReadOnly = True
      Size = 32
    end
    object Daily_DBNOGIRO: TStringField
      FieldName = 'NOGIRO'
      ReadOnly = True
      Size = 31
    end
    ...
    object Daily_DBCALC_SALDO: TIntegerField
      DisplayLabel = 'SALDO'
      FieldKind = fkCalculated
      FieldName = 'CALC_SALDO'
      Calculated = True
    end
    object Daily_DBSALDOAWAL: TFloatField
      DisplayLabel = 'SALDO AWAL'
      FieldName = 'SALDOAWAL'
      ReadOnly = True
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBCUSTOMER_KODE: TStringField
      DisplayLabel = 'CUST KODE'
      FieldName = 'CUSTOMER_KODE'
      ReadOnly = True
      Required = True
      Size = 7
    end
