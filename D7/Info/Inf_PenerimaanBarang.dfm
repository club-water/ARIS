object Inf_PenerimaanBarangFrm: TInf_PenerimaanBarangFrm
  Left = 171
  Top = 67
  Width = 909
  Height = 575
  Caption = 'Inf_PenerimaanBarangFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1KODE_ASET: TcxGridDBColumn
            DataBinding.FieldName = 'KODE_ASET'
            Width = 75
          end
          object cxGrid3DBTableView1NO_TRANSAKSI_PO: TcxGridDBColumn
            Caption = 'NO PO'
            DataBinding.FieldName = 'NO_TRANSAKSI_PO'
            Width = 81
          end
          ...
          object cxGrid3DBTableView1KODE_SUPPLIER_detil: TcxGridDBColumn
            DataBinding.FieldName = 'KODE_SUPPLIER_detil'
            Width = 106
          end
          ...
          object cxGrid3DBTableView1JENIS_PPN: TcxGridDBColumn
            DataBinding.FieldName = 'JENIS_PPN'
            Visible = False
          end
          object cxGrid3DBTableView1SATUAN: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    SQL.Strings = (
      'use tb_aris_ptpdn'
      ''
      'SELECT    a.DEPO,a.jenis,a.KODE_GUDANG,e.gudang,a.TGL_TRANSAKSI,'
      ' '
      
        '          b.KODE_ASET,b.NO_TRANSAKSI,B.HARGA,B.DISCOUNT,B.JENIS_' +
        'PPN,B.PPN,B.TOTAL,'
      
        '          b.KODE_ITEM,c.NAMA_ITEM,b.QTY, c.SATUAN,B.KODE_SUPPLIE' +
        'R AS KODE_SUPPLIER_detil,'
      '          d.NAMA as Nama_supplier,b.NO_TRANSAKSI_PO'
      '             '
      'FROM PENERIMAAN_ASET_M AS a left outer join'
      
        '     PENERIMAAN_ASET_D b on a.NO_TRANSAKSI=b.NO_TRANSAKSI left o' +
        'uter join '
      
        '     TB_ARIS.dbo.MST_ITEM c on b.KODE_ITEM=c.KODE_ITEM LEFT OUTE' +
        'R JOIN'
      '     MST_SUPPLIER AS d on d.kode=B.KODE_SUPPLIER LEFT OUTER JOIN'
      
        '     MST_LOKASI_GUDANG as e on a.KODE_GUDANG=e.kode and a.DEPO=e' +
        '.depo'
    ...
    object Daily_DBKODE_ASET: TStringField
    ...
    object Daily_DBJENIS_PPN: TFloatField
      FieldName = 'JENIS_PPN'
      ReadOnly = True
    end
    ...
    object Daily_DBSATUAN: TStringField
      FieldName = 'SATUAN'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBKODE_SUPPLIER_detil: TStringField
      DisplayLabel = 'KODE SUPPLIER'
      FieldName = 'KODE_SUPPLIER_detil'
      ReadOnly = True
      Size = 50
    end
    ...
    object Daily_DBNO_TRANSAKSI_PO: TStringField
      DisplayLabel = 'NO TRANSAKSI PO'
      FieldName = 'NO_TRANSAKSI_PO'
      ReadOnly = True
      Size = 50
    end
  end
