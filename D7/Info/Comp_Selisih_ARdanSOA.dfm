object Comp_Selisih_ARdanSOA_FRM: TComp_Selisih_ARdanSOA_FRM
  Left = 244
  Top = 60
  Width = 798
  Height = 558
  Caption = 'Comp_Selisih_ARdanSOA_FRM'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Kind = skSum
              FieldName = 'SELISIH'
              Column = cxGrid3DBTableView1SELISIH
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skCount
              FieldName = 'MRS_BRANCH_NAMA'
              Column = cxGrid3DBTableView1MRS_BRANCH_NAMA
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1MRS_STOCK_POINT_KD: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_STOCK_POINT_KD'
            Width = 132
          end
          object cxGrid3DBTableView1MRS_STOCK_POINT_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_STOCK_POINT_NAMA'
            Width = 164
          end
          object cxGrid3DBTableView1MRS_TGL: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_TGL'
          end
          object cxGrid3DBTableView1MRS_CUSTOMER_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_CUSTOMER_KODE'
            Width = 132
          end
          object cxGrid3DBTableView1MRS_CUSTOMER_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_CUSTOMER_NAMA'
            Width = 133
          end
          object cxGrid3DBTableView1MRS_INVOICE: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_INVOICE'
            Width = 78
          end
          object cxGrid3DBTableView1MRS_ORDER_DATE: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_ORDER_DATE'
          end
          object cxGrid3DBTableView1MRS_BRANCH_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_BRANCH_NAMA'
            Width = 117
          end
          object cxGrid3DBTableView1MRS_BRANCH_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'MRS_BRANCH_KODE'
            Width = 116
          end
          object cxGrid3DBTableView1BW_STOCK_POINT_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'BW_STOCK_POINT_KODE'
            Styles.Content = _DataModule.cxStyle6
            Width = 140
          end
          object cxGrid3DBTableView1BW_BRANCH_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'BW_BRANCH_KODE'
            Styles.Content = _DataModule.cxStyle6
            Width = 127
          end
          object cxGrid3DBTableView1BW_STOCK_POINT_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'BW_STOCK_POINT_NAMA'
            Styles.Content = _DataModule.cxStyle6
            Width = 141
          end
          object cxGrid3DBTableView1BW_tanggal: TcxGridDBColumn
            DataBinding.FieldName = 'BW_tanggal'
            Styles.Content = _DataModule.cxStyle6
            Width = 95
          end
          object cxGrid3DBTableView1BW_CUSTOMER_KODE: TcxGridDBColumn
            DataBinding.FieldName = 'BW_CUSTOMER_KODE'
            Styles.Content = _DataModule.cxStyle6
            Width = 126
          end
          object cxGrid3DBTableView1BW_CUSTOMER_NAMA: TcxGridDBColumn
            DataBinding.FieldName = 'BW_CUSTOMER_NAMA'
            Styles.Content = _DataModule.cxStyle6
            Width = 171
          end
          object cxGrid3DBTableView1BW_INVOICE_NUMBER: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1SELISIH: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1pertanggal: TcxGridDBColumn
            DataBinding.FieldName = 'pertanggal'
          end
          object cxGrid3DBTableView1sts: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
      'SELECT [MRS_STOCK_POINT_KD]'
      '      ,[MRS_STOCK_POINT_NAMA]'
      '      ,[MRS_TGL]'
      '      ,[MRS_NILAI]'
      '      ,[MRS_CUSTOMER_KODE]'
      '      ,[MRS_CUSTOMER_NAMA]'
      ...
      '      ,[pertanggal]'
        ...
        '      ,mars.dbo.F_cari_pembayaran_ada (BW_STOCK_POINT_KODE,BW_BR' +
        'ANCH_KODE,BW_INVOICE_NUMBER) as sts'
      
        '      ,mars.dbo.F_cari_Invoice_tgl  (BW_STOCK_POINT_KODE,BW_BRAN' +
        'CH_KODE,BW_INVOICE_NUMBER) as BW_tanggal'
      '  FROM [mars].[dbo].[RECON_AR]'
      'where [pertanggal]=:0')
    Active = True
    Left = 347
    Top = 166
    ...
    object Daily_DBMRS_STOCK_POINT_KD: TStringField
      FieldName = 'MRS_STOCK_POINT_KD'
      Size = 50
    end
    object Daily_DBMRS_STOCK_POINT_NAMA: TStringField
      FieldName = 'MRS_STOCK_POINT_NAMA'
      Size = 250
    end
    object Daily_DBMRS_TGL: TDateField
      FieldName = 'MRS_TGL'
    end
    ...
    object Daily_DBMRS_CUSTOMER_KODE: TStringField
      FieldName = 'MRS_CUSTOMER_KODE'
      Size = 50
    end
    object Daily_DBMRS_CUSTOMER_NAMA: TStringField
      FieldName = 'MRS_CUSTOMER_NAMA'
      Size = 250
    end
    object Daily_DBMRS_INVOICE: TStringField
      FieldName = 'MRS_INVOICE'
      Size = 50
    end
    object Daily_DBMRS_ORDER_DATE: TDateField
      FieldName = 'MRS_ORDER_DATE'
    end
    object Daily_DBMRS_BRANCH_NAMA: TStringField
      FieldName = 'MRS_BRANCH_NAMA'
      Size = 250
    end
    object Daily_DBMRS_BRANCH_KODE: TStringField
      FieldName = 'MRS_BRANCH_KODE'
      Size = 50
    end
    object Daily_DBBW_STOCK_POINT_KODE: TStringField
      FieldName = 'BW_STOCK_POINT_KODE'
      Size = 50
    end
    object Daily_DBBW_BRANCH_KODE: TStringField
      FieldName = 'BW_BRANCH_KODE'
      Size = 50
    end
    object Daily_DBBW_STOCK_POINT_NAMA: TStringField
      FieldName = 'BW_STOCK_POINT_NAMA'
      Size = 250
    end
    ...
    object Daily_DBBW_CUSTOMER_KODE: TStringField
      FieldName = 'BW_CUSTOMER_KODE'
      Size = 50
    end
    object Daily_DBBW_CUSTOMER_NAMA: TStringField
      FieldName = 'BW_CUSTOMER_NAMA'
      Size = 250
    end
    object Daily_DBBW_INVOICE_NUMBER: TStringField
      FieldName = 'BW_INVOICE_NUMBER'
      Size = 50
    end
    object Daily_DBBW_DOCUMENT_TANGGAL: TDateField
      FieldName = 'BW_DOCUMENT_TANGGAL'
    end
    object Daily_DBBW_NAMA_BRANCH: TStringField
      FieldName = 'BW_NAMA_BRANCH'
      Size = 250
    end
    object Daily_DBSELISIH: TFloatField
      FieldName = 'SELISIH'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBflag_selisih: TStringField
      FieldName = 'flag_selisih'
      Size = 50
    end
    object Daily_DBpertanggal: TDateField
      FieldName = 'pertanggal'
    end
    object Daily_DBsts: TStringField
      FieldName = 'sts'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBBW_tanggal: TDateField
      FieldName = 'BW_tanggal'
      ReadOnly = True
    end
  end
