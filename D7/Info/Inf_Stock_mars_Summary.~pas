...
type
  TInf_Stock_mars_SummaryFrm = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBuom_1: TStringField;
    Daily_DBuom_2: TStringField;
    ...
    cxGrid3DBTableView1uom_1: TcxGridDBColumn;
    cxGrid3DBTableView1uom_2: TcxGridDBColumn;
...
var
  Inf_Stock_mars_SummaryFrm: TInf_Stock_mars_SummaryFrm;
implementation
...
procedure TInf_Stock_mars_SummaryFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
 ...
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  ...
  Action := caFree;
  Inf_Stock_mars_SummaryFrm := nil;
end;

procedure TInf_Stock_mars_SummaryFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
  cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Stock_mars_SummaryFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Stock_mars_SummaryFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Stock_mars_SummaryFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Stock_mars_SummaryFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Stock_mars_SummaryFrm.LMDButton15Click(Sender: TObject);
begin
...
procedure TInf_Stock_mars_SummaryFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Stock_mars_SummaryFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Stock_mars_SummaryFrm.LMDButton2Click(Sender: TObject);
begin
