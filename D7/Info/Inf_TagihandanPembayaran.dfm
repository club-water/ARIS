object Inf_TagihandanPembayaranFrm: TInf_TagihandanPembayaranFrm
  Left = 245
  Top = 122
  Width = 1057
  Height = 575
  Caption = 'Inf_TagihandanPembayaranFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Column = cxGrid3DBTableView1pembayaran
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1Nama_Kolektor: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1pembayaran: TcxGridDBColumn
            DataBinding.FieldName = 'pembayaran'
            Options.Editing = False
            Width = 104
          end
          object cxGrid3DBTableView1no_kuitansi: TcxGridDBColumn
      ...
      object Panel4: TPanel
        ...
        object cxGrid1: TcxGrid
          ...
          object cxGridDBTableView1: TcxGridDBTableView
            ...
            object cxGridDBTableView1reffno: TcxGridDBColumn
              DataBinding.FieldName = 'reffno'
              Options.Editing = False
            end
            ...
            object cxGridDBTableView1SP: TcxGridDBColumn
              DataBinding.FieldName = 'SP'
              Options.Editing = False
            end
            object cxGridDBTableView1diterima: TcxGridDBColumn
              DataBinding.FieldName = 'diterima'
              Options.Editing = False
            end
            object cxGridDBTableView1dilunasi: TcxGridDBColumn
              DataBinding.FieldName = 'dilunasi'
              Options.Editing = False
            end
            ...
            object cxGridDBTableView1total_pembayaran: TcxGridDBColumn
              DataBinding.FieldName = 'total_pembayaran'
              Options.Editing = False
            end
            object cxGridDBTableView1sisa_AR: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT *,currentdebet-ISNULL(total_pembayaran,0) as sisa_AR'
      '  FROM [MARS].[dbo].[serah_terima_invoice] a')
    MasterSource = UniDataSource2
    MasterFields = 'invoice;sp'
    DetailFields = 'invoice;SP'
    IndexFieldNames = 'invoice'
    Left = 323
    Top = 166
    ParamData = <
      item
  ...
  object ZBrowse: TUniQuery
    ...
    SQL.Strings = (
        ...
        ' a.TGL_TRANSAKSI, a.STATUS, a.NIK, d.NAMA AS Nama_Kolektor, b.sp' +
        ', b.Invoice, '
      
        '                      b.Keterangan AS Keterangan1, b.currentdebe' +
        't, b.pembayaran, a.no_kuitansi, c.order_date, c.reffno'
      'FROM         Daftar_Tagihan_M AS a LEFT OUTER JOIN'
      
        '                      DAFTAR_TAGIHAN_D AS b ON a.NO_TRANSAKSI = ' +
        'b.NO_TRANSAKSI LEFT OUTER JOIN'
      
        '                      TB_HRIS.dbo.M_KARYAWAN AS d ON a.NIK = d.N' +
        'IK LEFT OUTER JOIN'
      
        '                      serah_terima_invoice AS c ON c.invoice = b' +
        '.Invoice AND c.SP = b.sp'
    ...
    object ZBrowseKeterangan1: TStringField
    ...
    object ZBrowseorder_date: TDateTimeField
      FieldName = 'order_date'
      ReadOnly = True
    end
    object ZBrowsereffno: TStringField
      FieldName = 'reffno'
      ReadOnly = True
      Size = 250
    end
