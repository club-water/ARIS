object Comp_TSPYF21_TMPYF34_FRM: TComp_TSPYF21_TMPYF34_FRM
  Left = 244
  Top = 60
  Width = 798
  Height = 558
  Caption = 'Comp_TSPYF21_TMPYF34_FRM'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1yf34_REFRENCE_NO: TcxGridDBColumn
            DataBinding.FieldName = 'yf34_REFRENCE_NO'
            Styles.Content = _DataModule.cxStyle9
            Width = 129
          end
          object cxGrid3DBTableView1yf34_KODE_PLANT_Tmp: TcxGridDBColumn
            DataBinding.FieldName = 'yf34_KODE_PLANT_Tmp'
            Styles.Content = _DataModule.cxStyle9
            Width = 156
          end
          object cxGrid3DBTableView1yf34_post_Date: TcxGridDBColumn
            DataBinding.FieldName = 'yf34_post_Date'
            Styles.Content = _DataModule.cxStyle9
            Width = 126
          end
          object cxGrid3DBTableView1yf_34_Total_Non_PPn: TcxGridDBColumn
            DataBinding.FieldName = 'yf_34_Total_Non_PPn'
            Styles.Content = _DataModule.cxStyle9
            Width = 86
          end
          object cxGrid3DBTableView1yf21_KODE_PLANT_TSP: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_KODE_PLANT_TSP'
          end
          object cxGrid3DBTableView1yf21_BILLING_DOC: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_BILLING_DOC'
            Width = 101
          end
          object cxGrid3DBTableView1yf21_BILLING_DATE: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_BILLING_DATE'
            Width = 125
          end
          object cxGrid3DBTableView1yf21_Total_Non_PPN: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_Total_Non_PPN'
            Width = 109
          end
          object cxGrid3DBTableView1yf21_Tax_amount: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_Tax_amount'
            Width = 112
          end
          object cxGrid3DBTableView1yf21_Total_PPn: TcxGridDBColumn
            DataBinding.FieldName = 'yf21_Total_PPn'
            Width = 103
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
      'select *'
      ' , case  WHEN abs(selisih) <> 0 THEN 1 '
      ...
      '      ,d.*'
        ...
        '      ,isnull(a.yf_34_Total_Non_PPn,0)-isnull(d.yf21_Total_Non_P' +
        'PN,0) as selisih'
      '    FROM MARS.dbo.vtmp_yf34 a  Full  join'
      
        '       mars.dbo.VTSP_YF21 D ON d.yf21_KODE_PLANT_TSP=a.yf34_KODE' +
        '_PLANT_Tmp'
      '       and d.yf21_BILLING_DOC=a.yf34_REFRENCE_NO'
      '       where isnull(d.yf21_BILLING_DATE,a.yf34_post_Date)>=:0'
      '         and isnull(d.yf21_BILLING_DATE,a.yf34_post_Date)<=:1'
      ' ) t')
    Left = 347
    Top = 166
    ParamData = <
    ...
    object Daily_DByf34_REFRENCE_NO: TStringField
      FieldName = 'yf34_REFRENCE_NO'
      Size = 50
    end
    object Daily_DByf34_KODE_PLANT_Tmp: TStringField
      FieldName = 'yf34_KODE_PLANT_Tmp'
      Size = 50
    end
    object Daily_DByf34_post_Date: TDateTimeField
      FieldName = 'yf34_post_Date'
      ReadOnly = True
    end
    object Daily_DByf_34_Total_Non_PPn: TFloatField
      FieldName = 'yf_34_Total_Non_PPn'
      ReadOnly = True
    end
    object Daily_DByf21_KODE_PLANT_TSP: TWideStringField
      FieldName = 'yf21_KODE_PLANT_TSP'
      ReadOnly = True
      FixedChar = True
      Size = 10
    end
    object Daily_DByf21_BILLING_DOC: TStringField
      FieldName = 'yf21_BILLING_DOC'
      ReadOnly = True
      Size = 50
    end
    object Daily_DByf21_BILLING_DATE: TDateTimeField
      FieldName = 'yf21_BILLING_DATE'
      ReadOnly = True
    end
    object Daily_DByf21_Total_Non_PPN: TFloatField
      FieldName = 'yf21_Total_Non_PPN'
      ReadOnly = True
    end
    object Daily_DByf21_Tax_amount: TFloatField
      FieldName = 'yf21_Tax_amount'
      ReadOnly = True
    end
    object Daily_DByf21_Total_PPn: TFloatField
      FieldName = 'yf21_Total_PPn'
      ReadOnly = True
    end
