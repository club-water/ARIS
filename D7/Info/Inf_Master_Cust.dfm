object Inf_Master_CustFrm: TInf_Master_CustFrm
  Left = 171
  Top = 67
  Width = 909
  Height = 575
  Caption = 'Inf_Master_CustFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1short_nama: TcxGridDBColumn
            DataBinding.FieldName = 'short_nama'
            Width = 123
          end
          ...
          object cxGrid3DBTableView1contact_person: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1post_code: TcxGridDBColumn
          ...
          object cxGrid3DBTableView1print_fp: TcxGridDBColumn
            DataBinding.FieldName = 'print_fp'
            Width = 111
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.*,b.STOCKPOINTNAME, cast(a.stockpoint_code as int) as k' +
        'ode_Depo,'
      
        '  case term when '#39'T00'#39' then '#39'Tunai'#39' else '#39'Kredit'#39' end as jenis_c' +
        'ustomer'
      'FROM MARS.dbo.MST_CUSTOMER as a  LEFT OUTER JOIN'
      
        '  mars.dbo.LIST_STOCKPOINT AS b ON a.[stockpoint_code] = b.SALES' +
        'POINTCD')
    ReadOnly = True
    Left = 323
    Top = 166
    ...
    object Daily_DBshort_nama: TStringField
    ...
    object Daily_DBcontact_person: TStringField
    ...
    object Daily_DBphone: TStringField
      FieldName = 'phone'
      Size = 50
    end
    object Daily_DBpost_code: TStringField
      FieldName = 'post_code'
      Size = 50
    end
    ...
    object Daily_DBprint_fp: TStringField
      FieldName = 'print_fp'
      Size = 50
    end
    ...
    object Daily_DBkode_Depo: TIntegerField
      FieldName = 'kode_Depo'
      ReadOnly = True
    end
  end
