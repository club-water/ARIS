object Inf_Espt_SAp_R3Frm: TInf_Espt_SAp_R3Frm
  Left = 375
  Top = 99
  Width = 798
  Height = 558
  Caption = 'Inf_Espt_SAp_R3Frm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'dpp'
              Column = cxGrid3DBTableView1dpp
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'ppn'
              Column = cxGrid3DBTableView1ppn
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
              FieldName = 'PPnBm'
              Column = cxGrid3DBTableView1PPnBm
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1kode_pajak: TcxGridDBColumn
            DataBinding.FieldName = 'kode_pajak'
            Width = 72
          end
          object cxGrid3DBTableView1kode_transaksi: TcxGridDBColumn
            DataBinding.FieldName = 'kode_transaksi'
            Width = 88
          end
          object cxGrid3DBTableView1kode_status: TcxGridDBColumn
            DataBinding.FieldName = 'kode_status'
            Width = 67
          end
          object cxGrid3DBTableView1kode_dokumen: TcxGridDBColumn
            DataBinding.FieldName = 'kode_dokumen'
            Width = 91
          end
          object cxGrid3DBTableView1flag_vat: TcxGridDBColumn
            DataBinding.FieldName = 'flag_vat'
            Width = 61
          end
          object cxGrid3DBTableView1npwp_no_paspor_lawan_transaksi: TcxGridDBColumn
            DataBinding.FieldName = 'npwp_no_paspor_lawan_transaksi'
            Width = 185
          end
          object cxGrid3DBTableView1nama_lawan_transaksi: TcxGridDBColumn
            DataBinding.FieldName = 'nama_lawan_transaksi'
            Width = 346
          end
          object cxGrid3DBTableView1nomor_document: TcxGridDBColumn
            DataBinding.FieldName = 'nomor_document'
            Width = 111
          end
          object cxGrid3DBTableView1jenis_document: TcxGridDBColumn
            DataBinding.FieldName = 'jenis_document'
            Width = 79
          end
          object cxGrid3DBTableView1no_seri_faktur_yg_diganti_or_diretur: TcxGridDBColumn
            DataBinding.FieldName = 'no_seri_faktur_yg_diganti_or_diretur'
            Width = 176
          end
          object cxGrid3DBTableView1jenis_dockument_yg_diganti_or_diretur: TcxGridDBColumn
            DataBinding.FieldName = 'jenis_dockument_yg_diganti_or_diretur'
            Width = 189
          end
          object cxGrid3DBTableView1tanggal_faktur: TcxGridDBColumn
            DataBinding.FieldName = 'tanggal_faktur'
          end
          object cxGrid3DBTableView1tgl_ssp: TcxGridDBColumn
            DataBinding.FieldName = 'tgl_ssp'
          end
          object cxGrid3DBTableView1masa_pajak: TcxGridDBColumn
            DataBinding.FieldName = 'masa_pajak'
            Width = 62
          end
          object cxGrid3DBTableView1tahun_pajak: TcxGridDBColumn
            DataBinding.FieldName = 'tahun_pajak'
            Width = 81
          end
          object cxGrid3DBTableView1pembetulan: TcxGridDBColumn
            DataBinding.FieldName = 'pembetulan'
            Width = 60
          end
          object cxGrid3DBTableView1dpp: TcxGridDBColumn
            DataBinding.FieldName = 'dpp'
          end
          object cxGrid3DBTableView1ppn: TcxGridDBColumn
            DataBinding.FieldName = 'ppn'
          end
          object cxGrid3DBTableView1PPnBm: TcxGridDBColumn
            DataBinding.FieldName = 'PPnBm'
          end
          object cxGrid3DBTableView1Keterangan_1: TcxGridDBColumn
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      'SELECT a.*  '
      '  FROM [MARS].[dbo].[Espt_PPn] a'
      'where  a.tanggal_faktur>=:0'
      '  and  a.tanggal_faktur<=:1')
    Left = 323
    Top = 166
    ParamData = <
      item
    ...
    object Daily_DBkode_pajak: TStringField
      FieldName = 'kode_pajak'
      Size = 50
    end
    object Daily_DBkode_transaksi: TStringField
      FieldName = 'kode_transaksi'
      Size = 50
    end
    object Daily_DBkode_status: TStringField
      FieldName = 'kode_status'
      Size = 50
    end
    object Daily_DBkode_dokumen: TStringField
      FieldName = 'kode_dokumen'
      Size = 50
    end
    object Daily_DBflag_vat: TStringField
      FieldName = 'flag_vat'
      Size = 50
    end
    object Daily_DBnpwp_no_paspor_lawan_transaksi: TStringField
      FieldName = 'npwp_no_paspor_lawan_transaksi'
      Size = 250
    end
    object Daily_DBnama_lawan_transaksi: TStringField
      FieldName = 'nama_lawan_transaksi'
      Size = 250
    end
    object Daily_DBnomor_document: TStringField
      FieldName = 'nomor_document'
      Size = 250
    end
    object Daily_DBjenis_document: TStringField
      FieldName = 'jenis_document'
      Size = 50
    end
    object Daily_DBno_seri_faktur_yg_diganti_or_diretur: TStringField
      FieldName = 'no_seri_faktur_yg_diganti_or_diretur'
      Size = 50
    end
    object Daily_DBjenis_dockument_yg_diganti_or_diretur: TStringField
      FieldName = 'jenis_dockument_yg_diganti_or_diretur'
      Size = 50
    end
    object Daily_DBtanggal_faktur: TDateTimeField
      FieldName = 'tanggal_faktur'
    end
    object Daily_DBtgl_ssp: TDateTimeField
      FieldName = 'tgl_ssp'
    end
    object Daily_DBmasa_pajak: TStringField
      FieldName = 'masa_pajak'
      Size = 50
    end
    object Daily_DBtahun_pajak: TStringField
      FieldName = 'tahun_pajak'
      Size = 50
    end
    object Daily_DBpembetulan: TStringField
      FieldName = 'pembetulan'
      Size = 50
    end
    object Daily_DBdpp: TFloatField
      FieldName = 'dpp'
    end
    object Daily_DBppn: TFloatField
      FieldName = 'ppn'
    end
    object Daily_DBPPnBm: TFloatField
      FieldName = 'PPnBm'
    end
    object Daily_DBKeterangan_1: TStringField
      FieldName = 'Keterangan_1'
      Size = 250
    end
    object Daily_DBNomor_dokumen_3: TStringField
