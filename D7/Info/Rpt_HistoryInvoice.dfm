object Rpt_HistoryInvoiceFrm: TRpt_HistoryInvoiceFrm
  Left = 155
  Top = 37
  Width = 1027
  Height = 647
  Caption = 'Rpt_HistoryInvoiceFrm'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          object cxGridDBTableView1keterangan_bayar: TcxGridDBColumn
            DataBinding.FieldName = 'keterangan_bayar'
            Width = 468
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'select r.NO_TRANSAKSI,'
      '         r.KD_OUTLET,r.debet as saldo,r.no_nota,'
      ...
      'w.NAMA as nama_outlet,w.ALAMAT_1,'
        ...
        ' from ('
      'select a.NO_TRANSAKSI,a.KD_OUTLET, a.debet,a.No_Nota,'
      ...
      '       where jenis_pembayaran<>'#39'TUNAI'#39
  ...
  object ZBrowse: TUniQuery
    ...
    SQL.Strings = (
      'select r.NO_TRANSAKSI,'
        ...
        '         r.KD_OUTLET,ISNULL(r.kredit,0) as saldo,r.keterangan_ba' +
        'yar,R.No_Nota,'
      ...
      'w.NAMA as nama_outlet,w.ALAMAT_1,'
        ...
        'select a.NO_TRANSAKSI,a.KD_OUTLET, a.debet,a.kredit as kredit,A.' +
        'NO_NOTA,'
      
        '      a.tanggal_transaksi,a.jenis_pembayaran,a.tgl_jatuh_tempo,a' +
        '.depo,a.ASAL as keterangan_bayar'
      '  from Rekap_AR a '
    ...
    object ZBrowsesaldo: TIntegerField
      DisplayLabel = 'JUMLAH'
      FieldName = 'saldo'
      ReadOnly = True
    end
    ...
    object ZBrowseketerangan_bayar: TStringField
      DisplayLabel = 'KETERANGAN'
      FieldName = 'keterangan_bayar'
      Size = 50
    end
    object ZBrowseNo_Nota: TStringField
      FieldName = 'No_Nota'
      Size = 50
    end
  end
