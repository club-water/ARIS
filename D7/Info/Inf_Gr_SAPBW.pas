...
type
  TInf_Gr_SAPBWFrm = class(TForm)
    ...
    Daily_DBplantkode: TStringField;
    Daily_DBplantnama: TStringField;
    Daily_DBvendor: TStringField;
    Daily_DBmaterial: TStringField;
    Daily_DBPO_Number: TStringField;
    Daily_DBpr_qty: TFloatField;
    Daily_DBpo_qty: TFloatField;
    Daily_DBpo_price: TFloatField;
    Daily_DBgr_qty: TFloatField;
    Daily_DBgr_price: TFloatField;
    Daily_DBCalendar_Day: TDateTimeField;
    cxGrid3DBTableView1plantkode: TcxGridDBColumn;
    cxGrid3DBTableView1plantnama: TcxGridDBColumn;
    ...
    cxGrid3DBTableView1pr_qty: TcxGridDBColumn;
    cxGrid3DBTableView1po_qty: TcxGridDBColumn;
    cxGrid3DBTableView1po_price: TcxGridDBColumn;
    cxGrid3DBTableView1gr_qty: TcxGridDBColumn;
    cxGrid3DBTableView1gr_price: TcxGridDBColumn;
    cxGrid3DBTableView1Calendar_Day: TcxGridDBColumn;
    Daily_DBCalc_Selisih: TFloatField;
    cxGrid3DBTableView1Calc_Selisih: TcxGridDBColumn;
...
var
  Inf_Gr_SAPBWFrm: TInf_Gr_SAPBWFrm;
implementation
...
procedure TInf_Gr_SAPBWFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
...
procedure TInf_Gr_SAPBWFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
  cxGrid3DBTableView1.DataController.DataSource:=nil;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Gr_SAPBWFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Gr_SAPBWFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Gr_SAPBWFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Gr_SAPBWFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Gr_SAPBWFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Gr_SAPBWFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Gr_SAPBWFrm.Daily_DBCalcFields(DataSet: TDataSet);
var Vgr_qty : integer;
begin
  if Daily_DBgr_qty.AsString='' then
     Vgr_qty:=0
  else Vgr_qty:=Daily_DBgr_qty.asinteger;
  Daily_DBCalc_Selisih.asinteger:=Daily_DBpo_qty.asinteger-vgr_Qty;
end;

procedure TInf_Gr_SAPBWFrm.Button2Click(Sender: TObject);
begin
  cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Gr_SAPBWFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Gr_SAPBWFrm.DataRaw1Click(Sender: TObject);
begin
