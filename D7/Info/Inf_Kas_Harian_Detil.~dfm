object Inf_Kas_Harian_DetilFrm: TInf_Kas_Harian_DetilFrm
  Left = 105
  Top = 105
  Width = 1223
  Height = 608
  Caption = 'Inf_Kas_Harian_DetilFrm'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'NILTUNAI'
              Column = cxGrid3DBTableView1NILTUNAI
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1TglDoc: TcxGridDBColumn
            DataBinding.FieldName = 'TglDoc'
            Width = 82
          end
          object cxGrid3DBTableView1KETBIPDPT: TcxGridDBColumn
            DataBinding.FieldName = 'KETBIPDPT'
            Width = 153
          end
          object cxGrid3DBTableView1NILTUNAI: TcxGridDBColumn
            DataBinding.FieldName = 'NILTUNAI'
            Width = 85
          end
          ...
          object cxGrid3DBTableView1KETACCOUNT: TcxGridDBColumn
            DataBinding.FieldName = 'KETACCOUNT'
            Width = 268
          end
        end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'EXEC'#9'TBREPORTING.[dbo].[RPT_kasharian_detil] :0,:1')
    Active = True
    Left = 491
    Top = 182
    ParamData = <
    ...
    object Daily_DBSUBUNIT_ID: TIntegerField
      FieldName = 'SUBUNIT_ID'
      Required = True
    end
    object Daily_DBTglDoc: TDateTimeField
      FieldName = 'TglDoc'
      ReadOnly = True
    end
    object Daily_DBKETBIPDPT: TStringField
      FieldName = 'KETBIPDPT'
      ReadOnly = True
      Required = True
      Size = 50
    end
    object Daily_DBNILTUNAI: TFloatField
      FieldName = 'NILTUNAI'
      ReadOnly = True
    ...
    object Daily_DBKETACCOUNT: TStringField
      FieldName = 'KETACCOUNT'
      ReadOnly = True
      Required = True
      Size = 100
    end
