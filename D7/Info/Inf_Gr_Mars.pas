...
type
  TInf_Gr_MarsFrm = class(TForm)
    ...
    Daily_DBReceipt_Number: TStringField;
    Daily_DBReceipt_Date: TDateTimeField;
    Daily_DBReference_No: TStringField;
    Daily_DBReference_Date: TDateTimeField;
    Daily_DBVendor: TStringField;
    Daily_DBmaterial_Group: TStringField;
    Daily_DBsite: TStringField;
    Daily_DBPO_Number: TStringField;
    Daily_DBkd_material: TStringField;
    Daily_DBmaterial: TStringField;
    Daily_DBuom: TStringField;
    Daily_DBqty: TFloatField;
    Daily_DBqty_Fraction: TFloatField;
    cxGrid3DBTableView1Receipt_Number: TcxGridDBColumn;
    cxGrid3DBTableView1Receipt_Date: TcxGridDBColumn;
    cxGrid3DBTableView1Reference_No: TcxGridDBColumn;
    cxGrid3DBTableView1Reference_Date: TcxGridDBColumn;
    cxGrid3DBTableView1Vendor: TcxGridDBColumn;
    cxGrid3DBTableView1material_Group: TcxGridDBColumn;
    cxGrid3DBTableView1site: TcxGridDBColumn;
    cxGrid3DBTableView1PO_Number: TcxGridDBColumn;
    cxGrid3DBTableView1kd_material: TcxGridDBColumn;
    cxGrid3DBTableView1material: TcxGridDBColumn;
    cxGrid3DBTableView1uom: TcxGridDBColumn;
    cxGrid3DBTableView1qty: TcxGridDBColumn;
    cxGrid3DBTableView1qty_Fraction: TcxGridDBColumn;
    Daily_DBnama_stockpoint: TStringField;
    cxGrid3DBTableView1nama_stockpoint: TcxGridDBColumn;
    Daily_DBDo_Number: TStringField;
    Daily_DBPo_date: TDateTimeField;
    cxGrid3DBTableView1Po_date: TcxGridDBColumn;
    cxGrid3DBTableView1Do_Number: TcxGridDBColumn;
    Button2: TButton;
...
var
  Inf_Gr_MarsFrm: TInf_Gr_MarsFrm;
implementation
...
procedure TInf_Gr_MarsFrm.FormClose(Sender: TObject; var Action: TCloseAction);
var FileName :String;
begin
...
procedure TInf_Gr_MarsFrm.BitBtn1Click(Sender: TObject);
var AIndex: integer;
    Vmenit,Vdetik : integer;
    FileName :String;
begin
cxGrid3DBTableView1.DataController.DataSource:=NIL;
  FileName:=ExtractFileDir(Application.ExeName)+'\Inf_Gr_MarsFrm.mds';
 if (not fcCube1.DataSet.IsEmpty) and (fcSlice1.HaveLayout) then
  begin
    fcSlice1.SaveToFile(FileName);
  end;
...
procedure TInf_Gr_MarsFrm.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TInf_Gr_MarsFrm.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TInf_Gr_MarsFrm.Button7Click(Sender: TObject);
var i:integer;
    vlist:string;
begin
  fcCube1.Active := false;
...
procedure TInf_Gr_MarsFrm.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TInf_Gr_MarsFrm.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TInf_Gr_MarsFrm.Daily_DBCalcFields(DataSet: TDataSet);
var Vgr_qty : integer;
begin
end;

procedure TInf_Gr_MarsFrm.Button2Click(Sender: TObject);
begin
cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TInf_Gr_MarsFrm.Grid1Click(Sender: TObject);
begin
...
procedure TInf_Gr_MarsFrm.DataRaw1Click(Sender: TObject);
begin
