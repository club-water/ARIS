...
type
  TMJabatanFrm = class(TForm)
    ...
    cxGrid1DBTableView2JABATAN: TcxGridDBColumn;
...
procedure TMJabatanFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMJabatanFrm.FormClose(Sender: TObject;
...
procedure TMJabatanFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMJabatanFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMJabatanFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMJabatanFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMJabatanFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMJabatanFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMJabatanFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
