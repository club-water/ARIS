...
type
  TMAccountFrm = class(TForm)
    ...
    cxGrid1DBTableView2tipe: TcxGridDBColumn;
    cxGrid1DBTableView2cost_center: TcxGridDBColumn;
    cxGrid1DBTableView2proyek: TcxGridDBColumn;
...
procedure TMAccountFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMAccountFrm.FormClose(Sender: TObject;
...
procedure TMAccountFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMAccountFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMAccountFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMAccountFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMAccountFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMAccountFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMAccountFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
