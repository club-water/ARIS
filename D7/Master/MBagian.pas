...
procedure TMBagianFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMBagianFrm.FormClose(Sender: TObject;
...
procedure TMBagianFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMBagianFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMBagianFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMBagianFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMBagianFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMBagianFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMBagianFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
