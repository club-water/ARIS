...
type
  TMKATEGORI_Frm = class(TForm)
    ...
    cxGrid1DBTableView2kategori: TcxGridDBColumn;
    cxGrid1DBTableView2nama_kategori: TcxGridDBColumn;
...
procedure TMKATEGORI_Frm.SetUpButtonOtorisasi;
begin
end;

procedure TMKATEGORI_Frm.FormClose(Sender: TObject;
...
procedure TMKATEGORI_Frm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMKATEGORI_Frm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMKATEGORI_Frm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMKATEGORI_Frm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMKATEGORI_Frm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMKATEGORI_Frm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMKATEGORI_Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
