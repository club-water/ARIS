...
type
  TMBankFrm = class(TForm)
    ...
    cxGrid1DBTableView2NAMA_BANK: TcxGridDBColumn;
    Label3: TLabel;
...
procedure TMBankFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMBankFrm.FormClose(Sender: TObject;
...
procedure TMBankFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMBankFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMBankFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMBankFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMBankFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMBankFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMBankFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
