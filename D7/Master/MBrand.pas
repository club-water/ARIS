...
procedure TMBrand_Frm.SetUpButtonOtorisasi;
begin
end;

procedure TMBrand_Frm.FormClose(Sender: TObject;
...
procedure TMBrand_Frm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMBrand_Frm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMBrand_Frm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMBrand_Frm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMBrand_Frm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMBrand_Frm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMBrand_Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
