...
type
  TMDivisiFrm = class(TForm)
    ...
    cxGrid1DBTableView2DIVISI: TcxGridDBColumn;
...
procedure TMDivisiFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMDivisiFrm.FormClose(Sender: TObject;
...
procedure TMDivisiFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMDivisiFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMDivisiFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMDivisiFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMDivisiFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMDivisiFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMDivisiFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
