...
type
  TMGroup_Frm = class(TForm)
    ...
    cxGrid1DBTableView2KD_GROUP: TcxGridDBColumn;
...
procedure TMGroup_Frm.SetUpButtonOtorisasi;
begin
end;

procedure TMGroup_Frm.FormClose(Sender: TObject;
...
procedure TMGroup_Frm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMGroup_Frm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMGroup_Frm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMGroup_Frm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMGroup_Frm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMGroup_Frm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMGroup_Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
