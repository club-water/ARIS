...
uses
  ...
  wwdbdatetimepicker, Wwdotdot, Wwdbcomb;

type
  TMBiaya_PendapatanFrm = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    ...
    cxGrid1DBTableView2no_account: TcxGridDBColumn;
    cxGrid1DBTableView2tipe_cost_center: TcxGridDBColumn;
    cxGrid1DBTableView2tgl_non_aktif: TcxGridDBColumn;
    cxGrid1DBTableView2is_aktif: TcxGridDBColumn;
    cxGrid1DBTableView2Lnama_Account: TcxGridDBColumn;
    Label2: TLabel;
...
var
  MBiaya_PendapatanFrm: TMBiaya_PendapatanFrm;
...
procedure TMBiaya_PendapatanFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMBiaya_PendapatanFrm.FormClose(Sender: TObject;
...
begin
  ...
  Action := caFree;
  MBiaya_PendapatanFrm := nil;
end;

procedure TMBiaya_PendapatanFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMBiaya_PendapatanFrm.FormShow(Sender: TObject);
begin
  _DataModuleMaster.Maccount.close;
  _DataModuleMaster.Maccount.Open;
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMBiaya_PendapatanFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMBiaya_PendapatanFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMBiaya_PendapatanFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMBiaya_PendapatanFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMBiaya_PendapatanFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QImport3Wizard1.Execute;
end;

procedure TMBiaya_PendapatanFrm.SpeedButton3Click(Sender: TObject);
begin
  WebFrm.Label50Click(Sender);
end;
