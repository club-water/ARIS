...
type
  TMKecamatanFrm = class(TForm)
    ...
    cxGrid1DBTableView2NAMA_KECAMATAN: TcxGridDBColumn;
...
procedure TMKecamatanFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMKecamatanFrm.FormClose(Sender: TObject;
...
procedure TMKecamatanFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMKecamatanFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMKecamatanFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMKecamatanFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMKecamatanFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMKecamatanFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMKecamatanFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
